...
! function(e, u) {
    ...
    function E(e, t, n) {
        t = w(t), -1 < ["scrollLeft", "scrollTop"].indexOf(t) ? e[t] = parseInt(n) : e.style[t] = isNaN(n) || -1 < g.indexOf("" + t) ? n : n + "px"
    }
    ...
    function A(e, t, n) {
        var i;
        return x(n) && 1 === e.nodeType && (i = "data-" + t.replace(/[A-Z]/g, "-$&")
            .toLowerCase(), "string" == typeof(n = e.getAttribute(i)) ? (n = function(t) {
                try {
                    return JSON.parse(t)
                } catch (e) {
                    return t
    ...
    function M(e) {
        return "string" != typeof e ? u : e.replace(/-/g, "")
            .toLowerCase()
    }
    ...
    function Y(e) {
        ...
        this.then_ = [], V(e, this)
    }(t = "undefined" == typeof self ? void 0 === e ? window : e : self)
    .setImmediate || (i = 1, n = !(s = {}), K = (K = Object.getPrototypeOf && Object.getPrototypeOf(t)) && K.setTimeout ? K : t, a = "[object process]" === {}.toString.call(t.process) ? function(e) {
            t.process.nextTick(function() {
                N(e)
            })
        } : t.MessageChannel ? ((r = new MessageChannel)
        ...
        }, K.clearImmediate = P), (K = window)
        .Promise || (l = "pending", c = "sealed", d = "fulfilled", h = "rejected", p = function() {}, f = "undefined" != typeof setImmediate ? setImmediate : setTimeout, m = [], Y.prototype = {
            constructor: Y,
            state_: l,
            then_: null,
            data_: u,
    ...
    var K = "v1.0.9. Built at 19/10/2020 18:36:03",
        ...
        X = function(e, t) {
            return new X.init(e, t)
        };
    X.version = K, X.fn = X.prototype = {
        version: K,
        constructor: X,
        length: 0,
        uid: "",
        ...
        for ("object" != typeof n && "function" != typeof n && (n = {}), i === s && (n = this, i--); i < s; i++)
            if (null != (e = arguments[i]))
                for (t in e) D(e, t) && e[t] !== u && (n[t] = e[t]);
        return n
    };
    ...
    function $(e) {
        ...
        if (t.type = "text/javascript", x(e)) return X(t);
        e = X(e)[0];
    ...
    X.extend({
        ...
        setInterval: function(e, t) {
            ...
            return this.intervalId++, this.intervalQueue.push({
                ...
                i.intervalTickId = requestAnimationFrame(n), X.each(i.intervalQueue, function() {
                    var e = this;
                    (e.interval < 17 || Q() - e.lastTime >= e.interval) && (e.fn(), e.lastTime = Q())
                })
        ...
        index: function(e) {
            var t, n = -1;
            return 0 === this.length ? n : (t = x(e) ? this[0] : e instanceof X && 0 < e.length ? e[0] : "string" == typeof e ? X(e)[0] : u, x(t) || t && t.parentNode && X.each(t.parentNode.children, function(e) {
                this === t && (n = e)
            }), n)
        },
        get: function(e) {
        ...
        eq: function(e) {
            return !x(e) && 0 < this.length ? X.extend(X(this.get(e)), {
                _prevObj: this
            }) : this
        },
        is: function(t) {
            var n = !1;
            return 0 !== this.length && (t instanceof X ? this.same(t) : (":selected" === t ? this.each(function() {
                this.selected && (n = !0)
        ...
        same: function(e) {
            var t = !0;
            return e instanceof X || (e = X(e)), this.length === e.length && (this.each(function() {
                -1 === e.items()
                    .indexOf(this) && (t = !1)
            }), t)
        },
        ...
        filter: function(e) {
            ...
            return "string" == typeof e && (t = e, e = function(e) {
                return J.call(e, t)
            }), X.extend(X.merge(X(), [].filter.call(this, e)), {
                _prevObj: this
            })
        },
        find: function(e) {
            var t, n = [];
            return e instanceof X ? e : (t = 0 === this.length ? this : (this.each(function() {
                void 0 !== this.querySelectorAll && (n = n.concat([].slice.call(this.querySelectorAll(e))))
            }), X.merge(X(), n)), X.extend(t, {
                _prevObj: this
            }))
        },
        contains: function(e) {
        ...
        siblings: function(t) {
            ...
            if (0 !== this.length) return t instanceof X ? t : (this.each(function() {
                var e = this;
                e.parentNode && X.each(e.parentNode.children, function() {
                    e !== this && n.push(this)
                })
        ...
        _siblingAll: function(t, n) {
            var i = [];
            if (0 !== this.length) return n instanceof X ? n : (this.each(function() {
                for (var e = this; e = e && e[t];) i.push(e)
            }), n && (i = i.filter(function(e) {
                return J.call(e, n)
            })), X.extend(X.merge(X(), i), {
                _prevObj: this
            }))
        },
        ...
        closest: function(t) {
            var n = [];
            if (0 !== this.length) return t instanceof X ? t : t ? (this.each(function() {
                for (var e = this; e && e;) {
                    if (J.call(e, t)) return void n.push(e);
                    e = e.parentElement
                }
            }), X.extend(X.merge(X(), n.reverse()), {
                _prevObj: this
            })) : this.parent(t)
        },
        has: function(e) {
        ...
        script: function(e) {
            if (x(e)) return $();
            e = X(e)[0];
            e.tagName && "SCRIPT" === e.tagName ? $(e) : X.each(X(e)
                .find("script"),
                function() {
                    $(this)
                })
        ...
        _prop: function(e, t) {
            return 1 === arguments.length ? 0 === this.length ? u : this[0][e] : (x(t) && (t = ""), this.each(function() {
                this[e] = t, "innerHTML" === e && X.script(this)
            }))
        },
        prop: function(e, t) {
        ...
        html: function(e) {
            var t = [];
            return 0 === arguments.length ? this._prop("innerHTML") : (e instanceof X ? e.each(function() {
                t.push(X(this)
                    .outerHTML())
        ...
        if (_(e))[].forEach.call(e, function(e, t) {
            ...
            for (var i in e) D(e, i) && n.apply(e[i], [i, e[i], t++]);
        return e
    }, X.fn.extend({
        each: function(e) {
    ...
    Z.uid = -1, Z.prototype = {
        ...
        set: function(e, t, n) {
            ...
            if ("string" == typeof t) s[w(t)] = n;
            else
                for (i in t) D(t, i) && (s[w(i)] = t[i]);
            return s
        },
        get: function(e, t) {
            return t === u ? this.cache(e) : e[this.expando] && e[this.expando][w(t)]
        },
        ...
        remove: function(e, t) {
            ...
            if (i !== u) {
                if (t !== u) {
                    n = (t = Array.isArray(t) ? t.map(w) : (t = w(t)) in i ? [t] : t.match(/[^\x20\t\r\n\f]+/g) || [])
                        .length;
                    for (; n--;) delete i[t[n]]
                }
    ...
    X.extend({
        ...
        data: function(e, t) {
            ...
            if (0 !== this.length) {
                ...
                if (this.length && (s = ee.get(i), 1 === i.nodeType))
                    for (r = (a = i.attributes)
                        .length; r--;) a[r] && 0 === (o = a[r].name)
                        .indexOf("data-") && A(i, o = w(o.slice(5)), s[o]);
                return s
            }
        },
        ...
        origin: function(e, t, n) {
            ...
            if (x(e) && x(t)) return X.data(this[0]);
            if (x(t)) {
                var i = X.data(this[0], "origin-" + e);
                return x(i) ? n : i
            }
        ...
        serializeToArray: function(e) {
            ...
            if (t && "FORM" === t.nodeName) {
                for (var n, i = [], s = t.elements.length - 1; 0 <= 0 1="==" s; --s) if ("" !="=" t.elements[s].name) switch (t.elements[s].nodename) { case "input": (t.elements[s].type) "checkbox": "radio": t.elements[s].checked && i.push(t.elements[s].name + "=" + encodeURIComponent(t.elements[s].value));
                                    break;
                                case " file": break; default: textarea": select": "select-one": select-multiple": for (n="t.elements[s].options.length" - 1; <="n;" --n) t.elements[s].options[n].selected button": "reset": "submit": "button": element is not a htmlfromelement") }, serialize: function(e) return x.serializetoarray(e) .join("&") } }), x.fn.extend({ items: function() x.toarray(this) "function" window.customevent (te.prototype="window.Event.prototype," var ne="Event.prototype.stopPropagation," ie="Event.prototype.preventDefault;" event.prototype.stoppropagation="function()" this.ispropagationstopped="!0," ne.apply(this, arguments) event.prototype.preventdefault="function()" this.ispreventeddefault="!0," ie.apply(this, event.prototype.stop="function(e)" e ? this.stopimmediatepropagation() : this.stoppropagation() x.extend({ events: [], eventhooks: {}, eventuid: -1, seteventhandler: t, n="-1;" (0 this.events.length) (t="0;" t this.events.length; t++) (null="==" this.events[t].handler) break element: e.el, event: e.event, handler: e.handler, selector: e.selector, ns: e.ns, id: e.id, options: e.options -1="==" (this.events.push(e), this.events.length 1) (this.events[n]="e," n) geteventhandler: this.events[e] u null (this.events[e]="null," this.events[e].handler) off: x.each(this.events, this.element.removeeventlistener(this.event, this.handler, !0) this.events="[]," this getevents: geteventhooks: this.eventhooks addeventhook: function(e, x(n) ), x.each(s(e), this.eventhooks[w(n "-" this)]="t" removeeventhook: t) x(t) delete this.eventhooks[w(t removeeventhooks: x(e) t.eventhooks[w("before-" this)], t.eventhooks[w("after-" on: l, c, d) this.length) typeof l (d="c," c="l," b(d) || this.each(function() r="this;" e, s, o="d.ns" t[1]; x.eventuid++, a)], i="X.eventHooks[w(" after-"" a)]; ("function"="=" n.call(t, e), l) (; r;) (j.call(t, (c.call(t, e.ispropagationstopped)) e.stopimmediatepropagation(); else c.call(r, e); i.call(t, d.once (s="+X(r)" .origin("event-" e.type (l ":" "") (o "")), isnan(s) x.events.splice(s, 1)) object.defineproperty(e, "name", value: c.name "" "func_event_" "_" x.eventuid ""), r.addeventlistener(a, !y(d) d), s="X.setEventHandler({" el: r, a, o, x.eventuid, d x(r) s) }) one: n, i) b(i) (i="{})," i.once="!0," this.on.apply(this, [e, i]) a) b(s) (a="s," b(a) "all"="==" e.tolowercase() x.each(x.events, e.element="==" (t.removeeventlistener(e.event, e.options), e.handler="null," name (e.selector e.selector (e.ns e.ns null)) e[1], .origin(e); x.events[n].handler (i.removeeventlistener(t, x.events[n].handler, x.events[n].options), x(i) .origin(e, null) trigger: this.fire(e, fire: n; ["focus", "blur"].indexof(e) (this[0][e](), this) ("undefined" customevent customevent(e, bubbles: !0, cancelable: detail: ((n="document.createEvent(" events"))" .detail="t," n.initevent(e, !0)), this.dispatchevent(n) })) "blur focus resize scroll click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup contextmenu touchstart touchend touchmove touchcancel".split(" ") .foreach(function(i) x.fn[i]="function(e," arguments.length this.on(i, this.fire(i) hover: this.mouseenter(e) .mouseleave(t e) x.ready="function(e," document.addeventlistener("domcontentloaded", !1) x.load="function(e)" x(window) .on("load", x.unload="function(e)" .on("unload", unload: this.length this[0].self window x.unload(e) x.beforeunload="function(t)" "string"="=" .on("beforeunload", e.returnvalue="t" beforeunload: x.beforeunload(e) ready: (this.length this[0]="==" document x.ready(e) x.ajax="function(v)" new promise(function(n, function s(e, e.apply(null, e(e) ["get", "json"].indexof(e) xmlhttprequest, "get") .touppercase(), v.async, h="v.url;" (v.data instanceof htmlformelement x(h) t.trim() (h="t)," a.trim() (c="a.toUpperCase()))," v.timeout (l.timeout="v.timeout)," v.withcredentials (l.withcredentials="v.withCredentials)," v.data htmlformelement) f="X.serialize(v.data);" htmlelement v.data.getattribute("type") "file"="==" .tolowercase()) (var p="v.data.getAttribute(" name")," formdata, m="0;" v.data.files.length; m++) f.append(p, v.data.files[m]); b(v.data) x.each(o,="="typeof(n"" "boolean"="=" "number"="=" json.stringify(t); r.push(e &")) formdata (f="new" formdata) .append("_data", json.stringify(v.data)); e(c) "?" y(f) json.stringify(f)), l.open(c, h, u, v.user, v.password), v.headers x.each(v.headers, l.setrequestheader(e, t), d.push(e) d.indexof("content-type") !1 v.contenttype l.setrequestheader("content-type", "application x-www-form-urlencoded"), l.send(f), l.addeventlistener("load", (4="==" l.readystate l.status 300) "xhr"="==" v.returnvalue l.response; (v.parsejson) try catch (e) s(n, [t]), s(v.onsuccess, l]) s(i, [l]), s(v.onfail, l]); s(v.onload, x.each(["readystatechange", "error", "timeout", "progress", "loadstart", "loadend", "abort"], ("readystatechange"="==" "state" this)); l.addeventlistener(t, s(v[t], "post", "put", "patch", "delete", "json"].foreach(function(s) x[s]="function(e," method: "json"="==" "get" i, url: data: parsejson: }; x.ajax(x.extend({}, n)) load: x.load(e) x.get(e, .then(function(e) i.each(function() this.innerhtml="e" style: i(e, ["scrollleft", "scrolltop"].indexof(t) x(e)[t]() getcomputedstyle(e, n)[t] ("string"="=" u; this; getcomputedstyle(n, t); .map(function(e) .trim() }); e.length i(n, e[0], (x.each(e, s[this]="i(n," this, removestyleproperty: (x(e) x.each(t, e.style.removeproperty(this) css: typeof(e="e" "all") this.style(e) "object"="=" x.each(e, e(n, scrolltop: pageyoffset this[0].scrolltop this.scrolltop="e" scrollleft: pagexoffset this[0].scrollleft this.scrollleft="e" addclass: removeclass: toggleclass: containsclass: this.hasclass(e) hasclass: .filter(function(e) !x(e) (this.each(function() x.each(n, !t e.classlist e.classlist.contains(this) clearclasses: this.classname cls: this[0].classname.split(" this[0].classname removeclassby: function(n) this.indexof(n) e.removeclass(this) ["add", "remove", "toggle"].foreach(function(i) x.fn[i "class"]="function(n)" e.classlist; x.each(n.split(" e.classlist[i](this) x.parsehtml="function(e)" []; (e="e.trim()," document.implementation.createhtmldocument("")) .createelement("base")) .href="document.location.href," n.head.appendchild(t),>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\ \1>|)$/i.exec(e)) s.push(document.createElement(n[1]));
            else {
                i.innerHTML = e;
            ...
            _size: function(e, t) {
                if (0 !== this.length) {
                    if (x(t)) {
                        var n = this[0];
                        if ("height" === e) return n === window ? window.innerHeight : n === document ? n.body.clientHeight : parseInt(getComputedStyle(n)
                            .height);
                        if ("width" === e) return n === window ? window.innerWidth : n === document ? n.body.clientWidth : parseInt(getComputedStyle(n)
                            .width)
                    }
                    return this.each(function() {
            ...
            _sizeOut: function(n, i) {
                ...
                if (0 !== this.length) return x(i) || "boolean" == typeof i ? (e = (t = this[0])["width" === n ? "offsetWidth" : "offsetHeight"], t = getComputedStyle(t), t = e + parseInt(t["width" === n ? "margin-left" : "margin-top"]) + parseInt(t["width" === n ? "margin-right" : "margin-bottom"]), !0 === i ? t : e) : this.each(function() {
                    var e, t;
                    this !== window && this !== document && (t = getComputedStyle(this), e = "width" === n ? parseInt(t["border-left-width"]) + parseInt(t["border-right-width"]) : parseInt(t["border-top-width"]) + parseInt(t["border-bottom-width"]), t = "width" === n ? parseInt(t["padding-left"]) + parseInt(t["padding-right"]) : parseInt(t["padding-top"]) + parseInt(t["padding-bottom"]), t = X(this)[n](i)[n]() - e - t, this.style[n] = t + "px")
                })
            },
            ...
            offset: function(a) {
                ...
                return x(a) ? 0 === this.length ? u : {
                    top: (e = this[0].getBoundingClientRect())
                        .top + pageYOffset,
            ...
            left: function(e, t) {
                if (0 !== this.length) return x(e) ? this.position(t)
                    .left : "boolean" == typeof e ? (t = e, this.position(t)
                        .left) : this.each(function() {
                        X(this)
                            .css({
                                left: e
                            })
            ...
            top: function(e, t) {
                if (0 !== this.length) return x(e) ? this.position(t)
                    .top : "boolean" == typeof e ? (t = e, this.position(t)
                        .top) : this.each(function() {
                        X(this)
                            .css({
                                top: e
                            })
            ...
            pos: function() {
                if (0 !== this.length) return {
                    top: parseInt(X(this[0])
                        .style("top")),
                    left: parseInt(X(this[0])
                        .style("left"))
                }
            }
        }), X.fn.extend({
            attr: function(e, t) {
                var n = {};
                return 0 === this.length && 0 === arguments.length ? u : this.length && 0 === arguments.length ? (X.each(this[0].attributes, function() {
            ...
            removeAttr: function(e) {
                ...
                return x(e) ? this.each(function() {
                    var e = this;
                    X.each(this.attributes, function() {
            ...
            id: function(e) {
                return this.length ? X(this[0])
                    .attr("id", e) : u
            }
        }), X.extend({
            meta: function(e) {
                return x(e) ? X("meta") : X("meta[name='$name']".replace("$name", e))
            },
            metaBy: function(e) {
                return x(e) ? X("meta") : X("meta[$name]".replace("$name", e))
            },
            doctype: function() {
                return X("doctype")
            },
    ...
    function se(e) {
        var t;
        return "string" == typeof e ? t = X.isSelector(e) ? X(e) : X.parseHTML(e) : e instanceof HTMLElement ? t = [e] : _(e) && (t = e), t
    }
    X.fn.extend({
        ...
        append: function(e) {
            ...
            return this.each(function(t, n) {
                X.each(i, function() {
                    var e;
                    n !== this && (e = 0 === t ? this : this.cloneNode(!0), X.script(e), e.tagName && "SCRIPT" !== e.tagName && n.append(e))
                })
            })
        },
        appendTo: function(e) {
        ...
        prepend: function(e) {
            ...
            return this.each(function(t, n) {
                X.each(i, function() {
                    var e;
                    n !== this && (e = 0 === t ? this : this.cloneNode(!0), X.script(e), e.tagName && "SCRIPT" !== e.tagName && n.prepend(e))
                })
            })
        },
        ...
        after: function(e) {
            return this.each(function() {
                "string" == typeof e ? this.insertAdjacentHTML("afterend", e) : X(e)
                    .insertAfter(this)
            })
        },
        before: function(e) {
            return this.each(function() {
                "string" == typeof e ? this.insertAdjacentHTML("beforebegin", e) : X(e)
                    .insertBefore(this)
            })
        },
        clone: function(i, s) {
            ...
            return x(i) && (i = !1), x(s) && (s = !1), this.each(function() {
                var e, t = this.cloneNode(i),
                    n = X(t);
                s && X.hasData(this) && (e = X(this)
                    .data(), X.each(e, function(e, t) {
                        n.data(e, t)
                    })), a.push(t)
            }), X.merge(X(), a)
        },
        ...
        remove: function(t) {
            ...
            if (0 !== this.length) {
                for (n = t ? this.filter(function(e) {
                    return J.call(e, t)
                }) : this.items(); null != (e = n[i]); i++) e.parentNode && (s.push(e.parentNode.removeChild(e)), X.removeData(e));
                return X.merge(X(), s)
            }
        },
        wrap: function(e) {
            if (0 !== this.length) {
                ...
                if (n.length) {
                    ...
                    return this.each(function() {
                        var e, t = n.clone(!0, !0);
                        for (t.insertBefore(this), e = t; e.children()
                            .length;) e = e.children()
                            .eq(0);
        ...
        wrapAll: function(e) {
            var t, n;
            if (0 !== this.length && (t = X(se(e)))
                .length) {
                for ((t = t.clone(!0, !0))
                    .insertBefore(this[0]), n = t; n.children()
                    .length;) n = n.children()
                    .eq(0);
                return this.each(function() {
                    n.append(this)
    ...
    }), "object" == typeof window.setupAnimation && X.each(window.setupAnimation, function(e, t) {
        void 0 === X.animation[e] || x(t) || (X.animation[e] = t)
    });
    var ae = ["translateX", "translateY", "translateZ", "rotate", "rotateX", "rotateY", "rotateZ", "scale", "scaleX", "scaleY", "scaleZ", "skew", "skewX", "skewY"],
        oe = ["opacity", "zIndex"],
        re = ["opacity", "volume"],
        le = ["scrollLeft", "scrollTop"],
        ce = ["opacity", "volume"];
    ...
    function ue(a, e, o) {
        X.each(e, function(e, t) {
            var n, i, s;
            n = a, i = e, s = t[0] + t[2] * o, e = t[3], x(t = t[4]) && (t = !1), i = w(i), t && (s = parseInt(s)), !de(n) || void 0 !== n[i] ? n[i] = s : n.style[i] = "transform" === i || -1 < i.toLowerCase()
                .indexOf("color") ? s : s + e
        })
    }
    ...
    function pe(e) {
        return /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e || "#000000")
            .slice(1)
            .map(function(e) {
    ...
    function me(e, t, n) {
        var i, s, a, o, r, l, c;
        ue(e, t.props, n), i = e, s = t.transform, a = n, o = [], r = he(i), X.each(s, function(e, t) {
            var n = t[0],
                i = t[1],
                s = t[2],
                t = t[3];
            (-1 < (e = "" + e)
                .indexOf("rotate") || -1 < e.indexOf("skew")) && "" === t && (t = "deg"), -1 < e.indexOf("scale") && (t = ""), -1 < e.indexOf("translate") && "" === t && (t = "px"), "turn" === t ? o.push(e + "(" + i * a + t + ")") : o.push(e + "(" + (n + s * a) + t + ")")
        }), X.each(r, function(e, t) {
            s[e] === u && o.push(e + "(" + t + ")")
        }), i.style.transform = o.join(" "), l = e, t = t.color, c = n, X.each(t, function(e, t) {
    ...
    function ve(l, e, c) {
        var d, u, h, p, f, m = {
            ...
            v = he(l);
        return x(c) && (c = "normal"), X.each(e, function(e, t) {
            var n, i, s, a = -1 < ae.indexOf("" + e),
                o = -1 < oe.indexOf("" + e),
                r = -1 < ("" + e)
                .toLowerCase()
                .indexOf("color");
            if (Array.isArray(t) && 1 === t.length && (t = t[0]), h = Array.isArray(t) ? (u = r ? pe(fe(t[0])) : T(t[0]), r ? pe(fe(t[1])) : T(t[1])) : (u = a ? v[e] || 0 : r ? (s = e, getComputedStyle(l)[s].replace(/[^\d.,]/g, "")
                .split(",")
                .map(function(e) {
                    return parseInt(e)
            ...
            }(t, Array.isArray(u) ? u[0] : u))), -1 < ce.indexOf("" + e) && u[0] === h[0] && (u[0] = 0 < h[0] ? 0 : 1), "reverse" === c && (f = u, u = h, h = f), f = l instanceof HTMLElement && "" === h[1] && !o && !a ? "px" : h[1], r)
    ...
    ["Quad", "Cubic", "Quart", "Quint", "Expo"].forEach(function(e, t) {
        ...
        .forEach(function(e) {
            var i = we[e];
            Ce["easeIn" + e] = i, Ce["easeOut" + e] = function(t, n) {
                return function(e) {
                    return 1 - i(t, n)(1 - e)
                }
            }, Ce["easeInOut" + e] = function(t, n) {
                return function(e) {
    ...
    var be = {
        ...
        el: null,
        draw: {},
        dur: X.animation.duration,
        ease: X.animation.ease,
        loop: 0,
        pause: 0,
        dir: "normal",
        defer: 0,
    ...
    function ye(k) {
        return new Promise(function(e) {
            ...
            0 === l && (l = 1), "alternate" === f && "number" == typeof d && (d *= 2), C = "string" == typeof c ? (s = /\(([^)]+)\)/.exec(c), t = c.split("(")[0], g = s ? s[1].split(",")
                .map(function(e) {
                    return parseFloat(e)
                }) : [], Ce[t] || Ce.linear) : "function" == typeof c ? c : Ce.linear, X.animation.elements[y] = {
                element: o,
                id: null,
                stop: 0,
                pause: 0,
            ...
            function _() {
                "object" == typeof r && (v = ve(o, r, w)), n = performance.now(), X.animation.elements[y].loop += 1, X.animation.elements[y].id = requestAnimationFrame(T)
            }

            function S() {
                cancelAnimationFrame(X.animation.elements[y].id), delete X.animation.elements[a], "function" == typeof h && h.apply(o), e(i)
            }
            var T = function(e) {
                var t = X.animation.elements[y].stop;
                if (0 < t) return 2 === t && ("function" == typeof r ? r.bind(o)(1, 1) : me(o, v, 1)), void S();
                1 < (t = (e - n) / l) && (t = 1), t < 0 && (t = 0), e = C.apply(null, g)(t), "function" == typeof r ? r.bind(o)(t, e) : me(o, v, e), "function" == typeof u && u.apply(o, [t, e]), t < 1 && (X.animation.elements[y].id = requestAnimationFrame(T)), 1 === parseInt(t) && (d ? ("alternate" === f && (w = "normal" === w ? "reverse" : "normal"), "boolean" == typeof d || d > X.animation.elements[y].loop ? setTimeout(function() {
                    _()
                }, p) : S()) : "alternate" !== f || b ? S() : (w = "normal" === w ? "reverse" : "normal", b = !0, _()))
            };
    ...
    function _e(e, t) {
        x(t) && (t = !0), X.animation.elements[e].stop = !0 === t ? 2 : 1
    }
    X.easing = {}, X.extend(X.easing, Ce), X.extend({
        animate: function(e) {
            var t, n, i, s, a;
            return 1 < arguments.length ? (t = X(e)[0], n = arguments[1], i = arguments[2] || X.animation.duration, s = arguments[3] || X.animation.ease, a = arguments[4], "function" == typeof i && (a = i, s = X.animation.ease, i = X.animation.duration), "function" == typeof s && (a = s, s = X.animation.ease), ye({
                el: t,
                draw: n,
                dur: i,
                ease: s,
        ...
        animate: function(e) {
            var t, n, i, s, a = this,
                o = e;
            return !Array.isArray(e) && (1 < arguments.length || 1 === arguments.length && void 0 === e.draw) ? (t = e, n = arguments[1] || X.animation.duration, i = arguments[2] || X.animation.ease, s = arguments[3], "function" == typeof n && (s = n, n = X.animation.duration, i = X.animation.ease), "function" == typeof i && (s = i, i = X.animation.ease), this.each(function() {
                return X.animate({
                    el: this,
                    draw: t,
                    dur: n,
            ...
            })) : Array.isArray(e) ? (X.each(e, function() {
                var e = this;
                a.each(function() {
                    e.el = this, X.animate(e)
                })
            }), this) : this.each(function() {
                o.el = this, X.animate(o)
            })
        },
        chain: function(t, n) {
            return this.each(function() {
        ...
        hidden: function(e, t, n) {
            return e = X(e)[0], "string" == typeof t && (t = "true" === t.toLowerCase()), "function" == typeof t && (n = t, t = !e.hidden), e.hidden = t, "function" == typeof n && (X.bind(n, e), n.call(e, arguments)), this
        },
        hide: function(e, t) {
            return X(e)
                .origin("display", e.style.display || getComputedStyle(e, null)
                    .display), e.style.display = "none", "function" == typeof t && (X.bind(t, e), t.call(e, arguments)), this
        },
        show: function(e, t) {
            var n = X(e)
                .origin("display", u, "block");
            return e.style.display = n ? "none" === n ? "block" : n : "", 0 === parseInt(e.style.opacity) && (e.style.opacity = "1"), "function" == typeof t && (X.bind(t, e), t.call(e, arguments)), this
        },
        visible: function(e, t, n) {
            return t === u && (t = !0), e.style.visibility = t ? "visible" : "hidden", "function" == typeof n && (X.bind(n, e), n.call(e, arguments)), this
        },
        toggle: function(e, t) {
            var n = "none" !== getComputedStyle(e, null)
                .display ? "hide" : "show";
            return X[n](e, t)
        }
    }), X.fn.extend({
        hide: function() {
            var e;
            return X.each(arguments, function() {
        ...
        fadeIn: function(n, i, s) {
            return this.each(function() {
                ...
                x(n) && x(i) && x(s) ? (s = null, n = X.animation.duration) : "function" == typeof n && (s = n, n = X.animation.duration), "function" == typeof i && (s = i, i = X.animation.ease), X.fx.off && (n = 0);
                t = t.origin("display", u, "block");
                return e.style.opacity = "0", e.style.display = t, X.animate({
                    el: e,
                    draw: {
                        opacity: 1
                    },
                    ...
                    ease: i,
                    onDone: function() {
                        "function" == typeof s && X.proxy(s, this)()
                    }
                })
            })
        },
        fadeOut: function(t, n, i) {
            return this.each(function() {
                var e = X(this);
                if (C(this)) return x(t) && x(n) && x(i) ? (i = null, t = X.animation.duration) : "function" == typeof t && (i = t, t = X.animation.duration), "function" == typeof n && (i = n, n = X.animation.ease), e.origin("display", e.style("display")), X.animate({
                    el: this,
                    draw: {
                        opacity: 0
                    },
                    ...
                    ease: n,
                    onDone: function() {
                        this.style.display = "none", "function" == typeof i && X.proxy(i, this)()
                    }
                })
            })
        },
        slideUp: function(n, i, s) {
            return this.each(function() {
                var e, t = X(this);
                if (0 !== t.height()) return x(n) && x(i) && x(s) ? (s = null, n = X.animation.duration) : "function" == typeof n && (s = n, n = X.animation.duration), "function" == typeof i && (s = i, i = X.animation.ease), e = t.height(), t.origin("height", e), t.origin("display", X(this)
                    .style("display")), t.css({
                    overflow: "hidden"
                }), X.animate({
                    el: this,
                    ...
                    onDone: function() {
                        t.hide()
                            .removeStyleProperty("overflow, height"), "function" == typeof s && X.proxy(s, this)()
                    }
                })
            })
        },
        slideDown: function(s, a, o) {
            return this.each(function() {
                var e, t, n = this,
                    i = X(n);
                return x(s) && x(a) && x(o) ? (o = null, s = X.animation.duration) : "function" == typeof s && (o = s, s = X.animation.duration), "function" == typeof a && (o = a, a = X.animation.ease), i.show()
                    .visible(!1), e = +i.origin("height", u, i.height()), 0 === parseInt(e) && (e = n.scrollHeight), t = i.origin("display", i.style("display"), "block"), i.height(0)
                    .visible(!0), i.css({
                        overflow: "hidden",
                        ...
                        onDone: function() {
                            X(n)
                                .removeStyleProperty("overflow, height, visibility"), "function" == typeof o && X.proxy(o, this)()
                        }
                    })
            })
        },
        moveTo: function(e, t, n, i, s) {
            ...
            return "function" == typeof n && (s = n, n = X.animation.duration, i = X.animation.ease), "function" == typeof i && (s = i, i = X.animation.ease), this.each(function() {
                X.animate({
                    el: this,
                    draw: a,
                    dur: n,
        ...
        centerTo: function(t, n, i, s, a) {
            return "function" == typeof i && (a = i, i = X.animation.duration, s = X.animation.ease), "function" == typeof s && (a = s, s = X.animation.ease), this.each(function() {
                var e = {
        ...
        colorTo: function(e, t, n, i) {
            ...
            return "function" == typeof t && (i = t, t = X.animation.duration, n = X.animation.ease), "function" == typeof n && (i = n, n = X.animation.ease), this.each(function() {
                X.animate({
                    el: this,
                    draw: s,
                    dur: t,
        ...
        var e, i = this;
        if ("string" == typeof t && (t = t.trim()), this.uid = X.uniqueId(), !t) return this;
        if ("function" == typeof t) return X.ready(t);
        if (t instanceof Element) return this.push(t), this;
        if (t instanceof X) return X.each(t, function() {
            i.push(this)
        }), this;
        ...
        if (_(t)) return X.each(t, function() {
            X(this)
                .each(function() {
                    i.push(this)
                })
        ...
        if ("@" === t[0]) X("[data-role]")
            .each(function() {
                -1 < S(X(this)
                        .attr("data-role"), ",")
                    .indexOf(t.slice(1)) && i.push(this)
            });
        else if (1 === (e = X.parseHTML(t))
            .length && 3 === e[0].nodeType) try {
            [].push.apply(this, document.querySelectorAll(t))
        } catch (e) {
            console.error(t + " is not a valid selector")
        } else X.merge(this, e);
        return n !== u && (n instanceof X ? this.each(function() {
                X(n)
                    .append(i)
            }) : n instanceof HTMLElement ? X(n)
            .append(i) : b(n) && X.each(this, function() {
                for (var e in n) D(n, e) && this.setAttribute(e, n[e])
            })), this
    }, X.init.prototype = X.fn;
    var Se = window.$;
    X.Promise = Promise, window.m4q = X, void 0 === window.$ && (window.$ = X), X.global = function() {
        Se = window.$, window.$ = X
    }, X.noConflict = function() {
        return window.$ === X && (window.$ = Se), X
    }
}(window),
function(e) {
    "use strict";
    var t = e.meta("metro4:init")
        .attr("content"),
        n = e.meta("metro4:locale")
        .attr("content"),
        i = e.meta("metro4:week_start")
        .attr("content"),
        s = e.meta("metro4:date_format")
        .attr("content"),
        a = e.meta("metro4:date_format_input")
        .attr("content"),
        o = e.meta("metro4:animation_duration")
        .attr("content"),
        r = e.meta("metro4:callback_timeout")
        .attr("content"),
        l = e.meta("metro4:timeout")
        .attr("content"),
        c = e.meta("metro4:scroll_multiple")
        .attr("content"),
        d = e.meta("metro4:cloak")
        .attr("content"),
        u = e.meta("metro4:cloak_duration")
        .attr("content"),
        h = e.meta("metro4:global_common")
        .attr("content"),
        p = e.meta("metro4:blur_image")
        .attr("content");
...
function(e) {
    ...
    function o(e) {
        return "string" != typeof e ? void 0 : e.replace(/-/g, "")
            .toLowerCase()
    }
    var s = "ontouchstart" in window || 0 < navigator.MaxTouchPoints || 0 < navigator.msMaxTouchPoints,
        h = {
            ...
            template: null,
            about: function() {
                var e = "<h3><span id="about">About</span><a href="#about" class="header-anchor">#</a></h3><hr><div><b>Metro 4</b> - v" + h.version + ". " + h.showCompileTime() + "</div><div><b>M4Q</b> - " + m4q.version + "</div>";
                h.infobox.create(e)
            },
            info: function() {
            ...
            observe: function() {
                new MutationObserver(function(e) {
                        e.map(function(e) {
                            var t, n, i, s, a;
                            if ("attributes" === e.type && "data-role" !== e.attributeName) "data-hotkey" === e.attributeName ? h.initHotkeys([e.target], !0) : (n = (t = u(e.target))
                                .data("metroComponent"), i = e.attributeName, s = t.attr(i), a = e.oldValue, void 0 !== n && (t.fire("attr-change", {
                                    attr: i,
                                    newValue: s,
                                    oldValue: a,
                                    __this: t[0]
                                ...
                                var o, r, l, c = [],
                                    d = e.addedNodes;
                                if (d.length) {
                                    for (o = 0; o < d.length; o++) l = d[o], void 0 !== (r = u(l))
                                        .attr("data-role") && c.push(l), u.each(r.find("[data-role]"), function() {
            ...
            init: function() {
                ...
                window.METRO_BLUR_IMAGE && n.addClass("use-blur-image"), window.METRO_SHOW_ABOUT && h.info(!0), !0 == s ? n.addClass("metro-touch-device") : n.addClass("metro-no-touch-device"), h.sheet = this.utils.newCssSheet(), this.utils.addCssRule(h.sheet, "*, *::before, *::after", "box-sizing: border-box;"), window.METRO_MEDIA = [], u.each(h.media_queries, function(e, t) {
                    ...
                    }), h.observe(), h.initHotkeys(t), h.initWidgets(e, "init"), "fade" !== window.METRO_CLOAK_REMOVE ? (u(".m4-cloak")
                        .removeClass("m4-cloak"), u(window)
                        .fire("metro-initiated")) : u(".m4-cloak")
                    .animate({
                        draw: {
                            opacity: 1
                        },
            ...
            initHotkeys: function(e, i) {
                u.each(e, function() {
                    var e = u(this),
                        t = !!e.attr("data-hotkey") && e.attr("data-hotkey")
                        .toLowerCase(),
            ...
            initWidgets: function(e) {
                ...
                u.each(e, function() {
                    var s = u(this);
                    this.hasAttribute("data-role") && s.attr("data-role")
                        .split(/\s*,\s*/)
                        .map(function(t) {
                            var e = a.utils.$(),
                                n = o(t);
            ...
            requestFullScreen: function(e) {
                e.mozRequestFullScreen ? e.mozRequestFullScreen() : e.webkitRequestFullScreen ? e.webkitRequestFullScreen() : e.msRequestFullscreen ? e.msRequestFullscreen() : e.requestFullscreen()
                    .catch(function(e) {
                        console.warn("Error attempting to enable full-screen mode: " + e.message + " " + e.name)
                    })
            },
            exitFullScreen: function() {
                document.mozCancelFullScreen ? document.mozCancelFullScreen() : document.webkitCancelFullScreen ? document.webkitCancelFullScreen() : document.msExitFullscreen ? document.msExitFullscreen() : document.exitFullscreen()
                    .catch(function(e) {
                ...
                var e = o(e),
                    ...
                    t = u.extend({
                        ...
                        _fireEvent: function(e, t, n, i) {
                            ...
                            return n && (console.warn(n), console.warn("Event: on" + e.camelCase()
                                .capitalize()), console.warn("Data: ", t), console.warn("Element: ", s[0])), !0 !== i && s.fire(o.toLowerCase(), t), l.exec(a["on" + o], r, s[0])
                        },
...
function(p) {
    ...
    Date.prototype.getWeek = function(e) {
        var t, n, i;
        return e = Utils.isValue(e) ? "number" == typeof e ? parseInt(e) : 0 : METRO_WEEK_START, t = 0 <= 0 1 4 7 12 52 60 100 400="=" (t="(n" = new date(this.getfullyear(), 0, 1)) .getday() - e) ? t : + 7, n="Math.floor((this.getTime()" n.gettime() 6e4 * (this.gettimezoneoffset() n.gettimezoneoffset())) 864e5) 1, < (i="Math.floor((n" 1) 7) && date(this.getfullyear() e 53) i="Math.floor((n" 7), }, date.prototype.getyear="function()" { return this.getfullyear() .tostring() .substr(-2) date.prototype.format="function(e," t) void ); function i() var date(n); e.setdate(o (a 6) % 3), } s(e, ("" (math.pow(10, e)) .slice(1) !="=" p.locales p.locales[t] p.locales["en-us"]) .calendar, a="n.getDay()," o="n.getDate()," r="n.getMonth()," l="n.getFullYear()," c="n.getHours()," d="t.days," u="t.months," h="[0," 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334]; e.replace( (%[a-z]) gi, function(e) "%a": d[a].slice(0, d[a], "%b": u[r].slice(0, u[r], "%c": n.toutcstring(), math.floor(l 100), "%d": s(o, 2), dd: "%e": o, "%f": n.toisostring() .slice(0, 10), "%g": .getfullyear(), .getfullyear()) .slice(2), "%h": s(c, "%i": s((c 11) "%j": s(h[r] (1 (l || 0) 0), "%k": "" c, "%l": (c "%m": s(r s(n.getminutes(), "%p": "am" "pm", "%s": math.round(n.gettime() 1e3), s(n.getseconds(), "%u": "%v": function() e.setmonth(0, 1); (4 s(1 math.ceil((t 6048e5), 2) }(), "%w": a, "%x": n.tolocaledatestring(), n.tolocaletimestring(), "%y": l) l, "%z": n.totimestring() .replace( .+gmt([+-]\d+).+ , "$1"), .+\((.+?)\)$ "$1") [e] }) date.prototype.addhours="function(e)" this.settime(this.gettime() this date.prototype.adddays="function(e)" this.setdate(this.getdate() e), date.prototype.addmonths="function(e)" this.setmonth(this.getmonth() date.prototype.addyears="function(e)" this.setfullyear(this.getfullyear() }(metro), "use strict"; number.prototype.format="function(e," t, n, i) 3) "})+" (0 "\\d" "$") ")", ~~e)); e.replace(".", .replace(new regexp(t, "g"), "$&" (n ",")) "function" object.create (object.create="function(e)" t() {} t.prototype="e," }), object.values (object.values="function(t)" object.keys(t) .map(function(e) t[e] function(c, string.prototype.camelcase="function()" e.camelcase(this) string.prototype.dashedname="function()" e.dashedname(this) string.prototype.shuffle="function()" for (var i;) i), e[i]="e[n]," e[n]="t;" }(this.split("")) .join("") string.prototype.capitalize="function()" this.charat(0) .touppercase() this.slice(1) string.prototype.contains="function()" !!~string.prototype.indexof.apply(this, arguments) string.includes (string.prototype.includes="function()" string.prototype.todate="function(e," a) i, s, r, l; "en-us"; if (null="=" date(this); (r="this.replace(/[\/,.:\s]/g," "-"), [^a-za-z0-9%] g, "-") .split("-"), r.replace( "") .trim()) "invalid date"; l.indexof("mm") l.indexof("%m"), s="-1" l.indexof("dd") l.indexof("%d"), l.indexof("yyyy") -1 l.indexof("yy") l.indexof("%y"), l.indexof("hh") l.indexof("%h"), l.indexof("ii") l.indexof("mi") l.indexof("%i"), l.indexof("ss") l.indexof("%s"), !(-1 t[i])) (isnan(parseint(t[i]))) (t[i]="function(e)" -1; (e="e.substr(0," "en-us" s[a] s[a].calendar s[a].calendar.months) t.length; i++) (t[i].tolowercase()="==" e.tolowercase()) 12; break " 1972"), isnan(s) date(s) .getmonth() }(t[i]), t[i]) date" else ((l="parseInt(t[i]))" t[n] null, t[i] t[s] t[o] t[r] date(n, e, r) string.prototype.toarray="function(e," "string", this) .split(e="e" ",") t; switch (n) case "int": "integer": e.trim() parseint(e); break; "number": "float": parsefloat(e); "date": e.todate(i) date(e); default: }(metro, m4q), function(s, o) s.utils="{" isvisible: "none" this.getstyleone(e, "display") "hidden" "visibility") null e.offsetparent isurl: ^(\.\ |\.\.\ |ftp|http|https):\ \ (\w+:{0,1}\w*@)?(\s+)(:[0-9]+)?(\ |\ ([\w#!:.?+="&%@\-\/]))?/.test(e)" istag: ^<\ ?[\w\s="/.':;#-\/\?]+>/gi.test(e)
        },
        isEmbedObject: function(e) {
            var t = !1;
            return o.each([" iframe", "object", "embed", "video"], ("string"="=" typeof e.tolowercase()="==" e.nodetype e.tagname.tolowercase()="==" isvideourl: youtu\.be|youtube|twitch|vimeo gi.test(e) isdate: function(e, !!this.isdateobject(e) (this.isvalue(t) string(e) .todate(t) string(new date(e))) isdateobject: "object"="=" e.getmonth isint: !isnan(e) +e isfloat: ^\d*\.\d+$ .test(e) isfunc: this.istype(e, "function") isobject: "object") istype: (!this.isvalue(e)) !1; (typeof e; ("tag"="==" .tolowercase() this.istag(e)) ("url"="==" this.isurl(e)) ("array"="==" array.isarray(e)) (this.istag(e) window[e]="==" window[e]; e.indexof(".")) [ \s([]+ gm.test(e)) ("number"="=" "number" t.tolowercase()) n.length; s++) $: window.usejquery jquery m4q ismetroobject: t); n.length (console.warn(t not found!"), !1) (console.warn("element contain role '! please add attribute data-role="' + t + '" to element ' isjquery: "undefined" instanceof ism4q: isq: this.isjquery(e) this.ism4q(e) isie11: !!window.msinputmethodcontext !!document.documentmode embedurl: e.indexof("youtu.be") e.split(" ") .pop()), "<div class="embed-container"><iframe src + e ""></iframe>"
        },
        elementId: function(e) {
            return e + "-" + (new Date)
                .getTime() + o.random(1, 1e3)
        },
        ...
        isOutsider: function(e) {
            var t = o(e),
                e = t.clone();
            return e.removeAttr("data-role")
                .css({
                    visibility: "hidden",
                    position: "absolute",
                    display: "block"
                }), t.parent()
                .append(e), t = this.inViewport(e[0]), e.remove(), !t
        },
        inViewport: function(e) {
            e = this.rect(e);
            return 0 <= 0 1 2="==" 3="==" 4 9 16 21 100 e.top && <="e.left" e.bottom || document.documentelement.clientheight) e.right document.documentelement.clientwidth) }, rect: function(e) { return e.getboundingclientrect() getcursorposition: function(e, t) e="this.rect(e);" x: this.pagexy(t) .x - e.left window.pagexoffset, y: .y window.pageyoffset } getcursorpositionx: this.getcursorposition(e, getcursorpositiony: objectlength: object.keys(e) .length percent: t, n) if (0="==" e) 0; * t e; !0="==" n ? math.round(e) : math.round(100 objectshift: var o.each(e, (t="e)" }), delete e[t], objectdelete: void !="=" e[t] arraydeletebymultiplekeys: function(t, e.foreach(function(e) t[e] t.filter(function(e) }) arraydelete: -1 e.indexof(t) e.splice(e.indexof(t), 1) arraydeletebykey: e.splice(t, nvl: null="=" objectclone: for in o.hasprop(e, (n[t]="e[t]);" github: o.json("https: api.github.com repos " + .then(function(e) n.exec(t, [e]) detectie: function() "); parseint(e.substring(t 5, e.indexof(".", t)), 10); e.indexof("trident ")) parseint(e.substring(n 3, n)), 10) detectchrome: chrome .test(navigator.useragent) google inc .test(navigator.vendor) encodeuri: encodeuri(e) .replace( %5b g, "[") %5d "]") pageheight: math.max(e.scrollheight, e.offsetheight, t.clientheight, t.scrollheight, t.offsetheight) cleanprecode: array.prototype.slice.call(document.queryselectorall(e), 0) .foreach(function(e) "") \s+$ ""); ( ^\s gm.test(t)) e.textcontent="t;" else (var n, i, s, a="/^[\t" ]+ gm, o="1e3;" = n[0].length) (o="s," i="n[0]);" 1e3 (e.textcontent="t.replace(new" regexp("^" "gm"), .trim()) coords: top: window.pageyoffset, left: window.pagexoffset positionxy: switch (t) case "client": this.clientxy(e); "screen": this.screenxy(e); "page": this.pagexy(e); default: 0, clientxy: (e.changedtouches e.changedtouches[0] .clientx, .clienty screenxy: .screenx, .screeny pagexy: .pagex, .pagey isrightmouse: "which" e.which "button" e.button hiddenelementsize: .clone(!0); n.removeattr("data-role") .css({ visibility: "hidden", position: "absolute", display: "block" o("body") .append(n), this.isvalue(t) n.remove(), width: e, height: getstyle: window.getcomputedstyle(e, getstyleone: this.getstyle(e) .getpropertyvalue(t) getinlinestyles: s="n.style.length;" s; i++) t[a]="n.style[a]" updateuriparameter: regexp("([?&])" "i"), e.indexof("?") "&" "?"; e.match(i) e.replace(i, "$1" $2") \\$&"); regexp("[?&]" "(="([^&#]*)|&|#|$)" )" .exec(e); e[2] decodeuricomponent(e[2].replace( \+ "" getlocales: object.keys(s.locales) addlocale: s.locales="o.extend({}," s.locales, aspectratioh: "16 9"="==" "21 "4 3"="==" aspectratiow: valueinobject: object.values(e) .indexof(t) keyinobject: inobject: newcsssheet: t.setattribute("media", e), t.appendchild(document.createtextnode("")), document.head.appendchild(t), t.sheet addcssrule: i) "insertrule" e.insertrule(t "{" "}", "addrule" e.addrule(t, media: window.matchmedia(e) .matches mediamodes: window.metro_media mediaexist: window.metro_media.indexof(e) inmedia: window.metro_media.length isvalue: isnull: isnegative: parsefloat(e) ispositive: iszero: parsefloat(e.tofixed(2)) between: parsemoney: number(parsefloat(e.replace( [^0-9-.] ""))) parsecard: e.replace( [^0-9] parsephone: this.parsecard(e) parsenumber: e.replace(new regexp("\\" "g"), .replace(new ".") nearest: "floor" "ceil"](e) bool: (e) !0: "true": 1: "1": "on": "yes": !0; !1 copy: (document.createrange window.getselection) (n="window.getSelection())" .removeallranges(); try t.selectnodecontents(s), n.addrange(t) catch t.selectnode(s), i.createtextrange ((t="i.createTextRange())" .movetoelementtext(s), t.select()); document.execcommand("copy"), window.getselection window.getselection() .empty .empty() .removeallranges .removeallranges() document.selection document.selection.empty() deccount: % e.tostring() .split(".")[1].length window.metro_global_common (window.utils="s.utils)" }(metro, m4q), o) "use strict"; accordiondeferred: showmarker: !0, material: !1, duration: metro_animation_duration, oneframe: showactive: activeframeclass: "", activeheadingclass: activecontentclass: onframeopen: t.noop, onframebeforeopen: t.noop_true, onframeclose: onframebeforeclose: onaccordioncreate: t.noop }; t.accordionsetup="function(e)" window.metroaccordionsetup, t.accordionsetup(window.metroaccordionsetup), t.component("accordion", init: this._super(t, n), this _create: this._createstructure(), this._createevents(), this._fireevent("accordioncreate", element: _createstructure: t.addclass("accordion"), n.showmarker t.addclass("marker-on"), n.material t.addclass("material"), s.length s)[0], this._hideall(), n.showactive (!0="==" n.oneframe this._openframe(i) o.each(s, e._openframe(this) })) _createevents: i.on(t.events.click, ".heading", (e.closest(".accordion")[0] i[0]) !1; t.hasclass("active") a.length s.oneframe n._closeframe(t) n._openframe(t) _openframe: (!1="==" i.exec(n.onframebeforeopen, [e[0]], t[0])) this._closeall(e[0]), e.addclass("active n.activeframeclass), e.children(".heading") .addclass(n.activeheadingclass), e.children(".content") .addclass(n.activecontentclass) .slidedown(n.duration), this._fireevent("frameopen", frame: e[0] _closeframe: e.hasclass("active") i.exec(n.onframebeforeclose, t[0]) (e.removeclass("active .removeclass(n.activeheadingclass), .removeclass(n.activecontentclass) .slideup(n.duration), this._fireevent("frameclose", _closeall: o.each(n, t._closeframe(this) _hideall: o(this) .children(".content") .hide() _openall: o.each(t, changeattribute: {}, destroy: e.off(t.events.click, ".heading"), function(i, s) activitydeferred: type: "ring", style: "light", size: 64, radius: 20, onactivitycreate: i.noop i.activitysetup="function(e)" window.metroactivitysetup, i.activitysetup(window.metroactivitysetup), i.component("activity", (n.html("") .addclass(i.style "-style") .addclass("activity-" i.type), i.type) "metro": (e="0;" 5; e++) s("<div>")
                            .addClass("circle")
                            .appendTo(n)
                    }();
                    break;
                ...
                case "cycle":
                    ...
                    break;
                case "simple":
                    s('<svg class="circular"><circle class="path" cx="' + i.size / 2 + '" cy="' + i.size / 2 + '" r="' + i.radius + '" fill="none" stroke-width="2" stroke-miterlimit="10"/></svg>')
                        .appendTo(n);
                    break;
                case "atom":
                    ! function() {
                        for (e = 0; e < 3; e++) s("<span>")
                            .addClass("electron")
                            .appendTo(n)
                    }();
                    break;
    ...
    var c = {
        bite: function() {
            r("<div>")
                ...
                .append(r("<a href="https://dblclick.net">")
                    .html("dblclick.net"))
                .appendTo("body"), c.options.adblockDeferred ? setTimeout(function() {
                    c.fishing()
        ...
        fishing: function() {
            function e() {
                function e() {
                    clearInterval(o), l.exec(i.onFishingDone), r(window)
                        .fire("fishing-done"), t.remove()
                }
                var t = r(".adsense.google-adsense.dblclick.advert.adblock-bite"),
                    n = t.find("a");
                i.localhost || !r.localhost ? !t.length || !n.length || -1 < t.css("display")
                    .indexOf("none") || -1 < n.css("display")
                    .indexOf("none") ? (l.exec(c.options.onAlert), r(window)
                        .fire("adblock-alert"), !0 !== c.options.fireOnce && 0 != --s || e()) : !1 !== a && 0 === --a && e() : e()
            }
            var i = c.options,
                s = "number" == typeof i.fireOnce ? i.fireOnce : 0,
                a = i.checkStop,
                o = !1;
            l.exec(i.onFishingStart), r(window)
                .fire("fishing-start"), o = setInterval(function() {
                    e()
                }, c.options.checkInterval), e()
        }
    };
    e.Adblock = c, r(function() {
        c.options = r.extend({}, t), r(window)
            .on("metro-initiated", function() {
                c.bite()
            })
    })
}(Metro, m4q),
...
function(a, o) {
    ...
    a.appBarSetup = function(e) {
        ...
        _createStructure: function() {
            ...
            if (t.addClass("app-bar"), 0 === (e = t.find(".hamburger"))
                .length) {
                e = o("<button>")
                    .attr("type", "button")
                    .addClass("hamburger menu-down");
                for (var s = 0; s < 3; s++) o("<span>")
                    .addClass("line")
                    .appendTo(e);
                "rgba(0, 0, 0, 0)" !== i && !0 !== a.colors.isLight(i) || e.addClass("dark")
            }
            t.prepend(e), 0 === (i = t.find(".app-bar-menu"))
                .length ? e.css("display", "none") : r.addCssRule(a.sheet, ".app-bar-menu li", "list-style: none!important;"), "block" === e.css("display") ? (i.hide()
                    .addClass("collapsed"), e.removeClass("hidden")) : e.addClass("hidden"), (!0 === n.expand || r.isValue(n.expandPoint) && r.mediaExist(n.expandPoint)) && (t.addClass("app-bar-expand"), e.addClass("hidden"))
        },
            ...
            t.on(a.events.click, ".hamburger", function() {
                ...
                .on(a.events.resize, function() {
                    !0 !== n.expand && (r.isValue(n.expandPoint) && r.mediaExist(n.expandPoint) ? (t.addClass("app-bar-expand"), e._fireEvent("menu-expand")) : (t.removeClass("app-bar-expand"), e._fireEvent("menu-collapse"))), 0 !== i.length && ("block" !== s.css("display") ? (i.show(function() {
                        o(this)
                            .removeStyleProperty("display")
                    }), s.addClass("hidden")) : (s.removeClass("hidden"), s.hasClass("active") ? i.show()
                        .removeClass("collapsed") : i.hide()
                        .addClass("collapsed")))
                }, {
                    ns: this.id
                })
        ...
        close: function() {
            ...
            e._fireEvent("before-menu-close", {
                ...
                i.addClass("collapsed")
                    .removeClass("opened"), s.removeClass("active"), e._fireEvent("menu-close", {
                        menu: i[0]
                    })
            })
        },
        open: function() {
            ...
            e._fireEvent("before-menu-open", {
                ...
                i.removeClass("collapsed")
                    .addClass("opened"), s.addClass("active"), e._fireEvent("menu-open", {
                        menu: i[0]
                    })
            })
        },
        ...
        destroy: function() {
            var e = this.element;
            return e.off(a.events.click, ".hamburger"), o(window)
                .off(a.events.resize, {
                    ns: this.id
                }), e
        }
...
function(s, t) {
    ...
    s.audioButtonSetup = function(e) {
        ...
        n && ((t = new Audio(n))
            .volume = parseFloat(i), t.addEventListener("loadeddata", function() {
...
function(h, p) {
    ...
    h.audioPlayerSetup = function(e) {
        ...
        _createPlayer: function() {
            var e = this.element,
                ...
                s = e.parent(),
                a = p("<div>")
                .addClass("media-player audio-player " + e[0].className);
        ...
        _setSource: function(e) {
            var t = this.element;
            t.find("source")
                .remove(), t.removeAttr("src"), Array.isArray(e) ? p.each(e, function() {
                    void 0 !== this.src && p("<source>")
                        .attr("src", this.src)
        ...
        _createControls: function() {
            ...
            !0 !== i.showInfo && u.hide(), l.activity({
                    ...
                    onStop: function(e) {
                        0 < s.seekable.length && (s.currentTime = (t.duration * e / 100)
                            .toFixed(0)), s.paused && 0 < s.currentTime && s.play()
                    }
                ...
                }), this.volume = d, !0 !== i.showVolume && c.hide(), !0 === i.showLoop && (e = p("<button>")
                    .attr("type", "button")
                    .addClass("button square loop")
                    .html(i.loopIcon)
                    .appendTo(a)), !0 === i.showPlay && p("</button><button>")
                .attr("type", "button")
                .addClass("button square play")
                .html(i.playIcon)
                .appendTo(a), !0 === i.showStop && p("</button><button>")
                .attr("type", "button")
                .addClass("button square stop")
                .html(i.stopIcon)
                .appendTo(a), !0 === i.showMute && p("</button><button>")
                .attr("type", "button")
                .addClass("button square mute")
                .html(i.muteIcon)
                .appendTo(a), !0 === i.loop && (e.addClass("active"), n.attr("loop", "loop")), this._setVolume(), i.muted && (t.volumeBackup = s.volume, h.getPlugin(t.volume, "slider")
                    .val(0), s.volume = 0), u.html("00:00 / 00:00")
        },
        _createEvents: function() {
            var t = this,
                n = this.element,
            ...
            n.on("loadstart", function() {
                ...
                t._setInfo(s.currentTime, t.duration), h.getPlugin(t.stream, "slider")
                    .val(e), o.exec(i.onTime, [s.currentTime, t.duration, s, a], n[0])
            }), n.on("waiting", function() {
                t.preloader.fadeIn()
            }), n.on("loadeddata", function() {}), n.on("play", function() {
                a.find(".play")
                    .html(i.pauseIcon), o.exec(i.onPlay, [s, a], n[0])
            }), n.on("pause", function() {
                a.find(".play")
                    .html(i.playIcon), o.exec(i.onPause, [s, a], n[0])
            }), n.on("stop", function() {
                h.getPlugin(t.stream, "slider")
                    .val(0), o.exec(i.onStop, [s, a], n[0])
            }), n.on("ended", function() {
                h.getPlugin(t.stream, "slider")
                    .val(0), o.exec(i.onEnd, [s, a], n[0])
        ...
        _toggleMute: function() {
            this.muted = !this.muted, !1 === this.muted ? this.audio.volume = this.volumeBackup : (this.volumeBackup = this.audio.volume, this.audio.volume = 0), h.getPlugin(this.volume, "slider")
                .val(!1 === this.muted ? 100 * this.volumeBackup : 0)
        },
        _setInfo: function(e, t) {
            this.player.find(".info-box")
                .html(o.secondsToFormattedString(Math.round(e)) + " / " + o.secondsToFormattedString(Math.round(t)))
        },
        _setBuffer: function() {
            var e = this.audio.buffered.length ? Math.round(Math.floor(this.audio.buffered.end(0)) / Math.floor(this.audio.duration) * 100) : 0;
            h.getPlugin(this.stream, "slider")
                .buff(e)
        },
        _setVolume: function() {
            var e = this.audio,
                ...
                t = t.find(".mute"),
                e = 100 * e.volume;
            1 < e && e < 30 ? t.html(n.volumeLowIcon) : 30 <= 0 1 60 e && < ? t.html(n.volumemediumicon) : t.html(n.volumehighicon) t.html(n.muteicon) }, play: function(e) { void !="=" this._setsource(e), this.element.attr("src") this.element.find("source") .length || this.audio.play() pause: function() this.audio.pause() resume: this.audio.paused this.play() stop: this.audio.pause(), this.audio.currenttime="0," h.getplugin(this.stream, "slider") .val(0) setvolume: if (void e) return this.audio.volume; (e="100)," this.audio.volume="e," h.getplugin(this.volume, .val(100 * loop: this._toggleloop() mute: this._togglemute() changesource: var this.play(e) changevolume: this.setvolume(e) changeattribute: switch (e) case "data-src": this.changesource(); break; "data-volume": this.changevolume() } destroy: t="this.player;" e.off("all"), t.off("all"), .destroy(), }) }(metro, m4q), function(n, i) "use strict"; s="n.utils," a="{" bottomsheetdeferred: 0, mode: "list", toggle: null, onopen: n.noop, onclose: onbottomsheetcreate: n.noop }; n.bottomsheetsetup="function(e)" a, window.metrobottomsheetsetup, n.bottomsheetsetup(window.metrobottomsheetsetup), n.component("bottom-sheet", init: function(e, t) this._super(t, e, null }), this _create: this._createstructure(), this._createevents(), this._fireevent("bottom-sheet-create", element: _createstructure: e.addclass("bottom-sheet") .addclass(t.mode + "-list"), s.isvalue(t.toggle) i(t.toggle) (this.toggle="i(t.toggle))" _createevents: s.isvalue(this.toggle) this.toggle.on(n.events.click, e.toggle() t.on(n.events.click, "li", e.close() isopen: this.element.hasclass("opened") open: s.isvalue(e) t.removeclass("list-style grid-style") .addclass(e "-style"), this.element.addclass("opened"), this._fireevent("open", close: e.removeclass("opened"), this._fireevent("close", this.isopen() this.close() this.open(e) {}, this.toggle.off(n.events.click), e.off(n.events.click, "li"), n.bottomsheet="{" isbottomsheet: s.ismetroobject(e, "bottom-sheet") (!this.isbottomsheet(e)) !1; n.getplugin(e, .open(t) .close() this.isopen(e) this.close(e) this.open(e, !!this.isbottomsheet(e) .isopen() function(s, a) n="s.utils," i="{" buttongroupdeferred: targets: "button", clsactive: "", requiredbutton: !1, s.groupmode.one, onbuttonclick: s.noop, onbuttongroupcreate: s.noop s.buttongroupsetup="function(e)" i, window.metrobuttongroupsetup, s.buttongroupsetup(window.metrobuttongroupsetup), s.component("button-group", active: id: n.elementid("button-group") this._creategroup(), this._fireevent("button-group-create", _creategroup: t, n.addclass("button-group"), i.mode="==" s.groupmode.one t.length !0="==" i.requiredbutton a(e[0]) .addclass("active"), (e.removeclass("active") .removeclass(i.clsactive), .addclass("active")), n.find(".active") .addclass("js-active") .addclass(i.clsactive) n.on(s.events.click, i.targets, t._fireevent("button-click", button: e.hasclass("active") (i.mode="==" (n.find(i.targets) .removeclass(i.clsactive) .removeclass("active js-active"), e.addclass("active") .addclass("js-active")) e.toggleclass("active") .toggleclass(i.clsactive) .toggleclass("js-active")) e.off(s.events.click, t.targets), w) r="n.utils," calendardeferred: dayborder: excludeday: prevmonthicon: "<span class="default-icon-chevron-left"></=></button></div></div></div></div></div></div></span>",
    ...
    n.calendarSetup = function(e) {
            ...
            _create: function() {
                var e = this.element,
                    t = this.options;
                this.minYear = this.current.year - this.options.yearsBefore, this.maxYear = this.current.year + this.options.yearsAfter, this.offset = (new Date)
                    .getTimezoneOffset() / 60 + 1, e.html("")
                    .addClass("calendar " + (!0 === t.compact ? "compact" : ""))
                    .addClass(t.clsCalendar), !0 === t.dayBorder && e.addClass("day-border"), r.isValue(t.excludeDay) && (this.excludeDay = ("" + t.excludeDay)
                        .toArray(",", "int")), r.isValue(t.preset) && this._dates2array(t.preset, "selected"), r.isValue(t.exclude) && this._dates2array(t.exclude, "exclude"), r.isValue(t.special) && this._dates2array(t.special, "special"), !1 !== t.buttons && !1 === Array.isArray(t.buttons) && (t.buttons = t.buttons.split(",")
                        .map(function(e) {
                            return e.trim()
            ...
            _dates2array: function(e, t) {
                var n = this,
                    i = this.options;
                r.isNull(e) || (e = "string" == typeof e ? e.toArray() : e, w.each(e, function() {
                    var e;
                    if (r.isDateObject(this)) e = this;
                    else {
            ...
            _createEvents: function() {
                ...
                w(window)
                    .on(n.events.resize, function() {
                        ...
                        var e, t = w(this);
                        t.hasClass("prev-month") && (e = new Date(s.current.year, s.current.month - 1, 1))
                            .getFullYear() < s.minYear || t.hasClass("next-month") && (e = new Date(s.current.year, s.current.month + 1, 1))
                            .getFullYear() > s.maxYear || t.hasClass("prev-year") && (e = new Date(s.current.year - 1, s.current.month, 1))
                            .getFullYear() < s.minYear || t.hasClass("next-year") && (e = new Date(s.current.year + 1, s.current.month, 1))
                            .getFullYear() > s.maxYear || (s.current = {
                                year: e.getFullYear(),
                                month: e.getMonth(),
                                day: e.getDate()
                            }, setTimeout(function() {
                                s._drawContent(), (t.hasClass("prev-month") || t.hasClass("next-month")) && s._fireEvent("month-change", {
                                    current: s.current
                                }), (t.hasClass("prev-year") || t.hasClass("next-year")) && s._fireEvent("year-change", {
                                    current: s.current
                                })
                            }, o.ripple ? 300 : 1))
                    }), a.on(n.events.click, ".button.today", function() {
                        s.toDay(), s._fireEvent("today", {
                            today: s.today
                        })
                        ...
                        var t = w(this),
                            n = t.index();
                        !0 === o.multiSelect && (n = !0 === o.outside ? a.find(".days-row .day:nth-child(" + (n + 1) + ")") : a.find(".days-row .day:not(.outside):nth-child(" + (n + 1) + ")"), w.each(n, function() {
                            var e = w(this),
                                t = e.data("day");
                            e.hasClass("disabled") || e.hasClass("excluded") || (s.selected.contains(t) || s.selected.push(t), e.addClass("selected")
                                .addClass(o.clsSelected))
                        ...
                        var t, n = w(this),
                            i = n.text();
                        !0 === o.multiSelect && (t = w(this)
                            .siblings(".day"), w.each(t, function() {
                                var e = w(this),
                                    t = e.data("day");
                                e.hasClass("disabled") || e.hasClass("excluded") || (s.selected.contains(t) || s.selected.push(t), e.addClass("selected")
                                    .addClass(o.clsSelected))
                        ...
                        var t = w(this),
                            n = t.data("day"),
                            i = s.selected.indexOf(n);
                        if (t.hasClass("outside")) return n = new Date(n), s.current = {
                            year: n.getFullYear(),
                            month: n.getMonth(),
                            day: n.getDate()
                        }, s._drawContent(), void s._fireEvent("month-change", {
                            current: s.current
                        });
                        t.hasClass("disabled") || (!0 === o.pickerMode ? (s.selected = [n], s.today = new Date(n), s.current.year = s.today.getFullYear(), s.current.month = s.today.getMonth(), s.current.day = s.today.getDate(), s._drawHeader(), s._drawContent()) : -1 === i ? (!1 === o.multiSelect && (a.find(".days-row .day")
                                .removeClass("selected")
                                .removeClass(o.clsSelected), s.selected = []), s.selected.push(n), t.addClass("selected")
                            .addClass(o.clsSelected)) : (t.removeClass("selected")
                            .removeClass(o.clsSelected), r.arrayDelete(s.selected, n))), s._fireEvent("day-click", {
                            selected: s.selected,
                            day: t
                        }), e.preventDefault(), e.stopPropagation()
                        ...
                        n.find(".active")
                            .removeClass("active"), n.scrollTop(0), a.find(".calendar-months")
                            .addClass("open"), t = n.find(".js-month-" + s.current.month)
                        ...
                        s.current.month = w(this)
                            .index(), s._drawContent(), a.find(".calendar-months")
                            .removeClass("open"), s._fireEvent("month-change", {
                                current: s.current
                            }), e.preventDefault(), e.stopPropagation()
                    }), a.on(n.events.click, ".curr-year", function(e) {
                        var t, n = a.find(".years-list");
                        n.find(".active")
                            .removeClass("active"), n.scrollTop(0), a.find(".calendar-years")
                            .addClass("open"), t = n.find(".js-year-" + s.current.year)
                            .addClass("active"), setTimeout(function() {
                                n.animate({
                                    draw: {
                                        scrollTop: t.position()
                        ...
                        s.current.year = w(this)
                            .text(), s._drawContent(), a.find(".calendar-years")
                            .removeClass("open"), s._fireEvent("year-change", {
                                current: s.current
                            }), e.preventDefault(), e.stopPropagation()
                    })
            },
            ...
            _drawFooter: function() {
                ...
                !1 !== t.buttons && (0 === i.length && (i = w("<div>")
                    .addClass("calendar-footer")
                    .addClass(t.clsCalendarFooter)
                    .appendTo(e)), i.html(""), w.each(t.buttons, function() {
                    var e = w("<button>")
                        .attr("type", "button")
                        .addClass("button " + this + " " + t["cls" + this.capitalize() + "Button"])
                        .html(n[this])
                        .appendTo(i);
            ...
            _drawMonths: function() {
                for (var e = this.element, t = this.options, e = w("<div>")
                    .addClass("calendar-months")
                    .addClass(t.clsCalendarMonths)
                    .appendTo(e), n = w("<ul>")
                    .addClass("months-list")
                    .appendTo(e), i = this.locale.calendar, s = 0; s < 12; s++) w("<li>")
                    .addClass("js-month-" + s)
                    .html(i.months[s])
                    .appendTo(n)
            },
            _drawYears: function() {
                for (var e = this.element, t = this.options, e = w("<div>")
                    ...
                    .addClass(t.clsCalendarYears)
                    .appendTo(e), n = w("<ul>")
                    .addClass("years-list")
                    .appendTo(e), i = this.minYear; i <= this.maxyear; i++) w("<li>")
                    .addClass("js-year-" + i)
                    .html(i)
                    .appendTo(n)
            },
            _drawContent: function() {
                var e, t, n, i = this.element,
                    s = this.options,
                    a = i.find(".calendar-content"),
                    o = this.locale.calendar,
                    r = 0,
                    l = new Date(this.current.year, this.current.month, 1),
                    c = new Date(this.current.year, this.current.month, 0)
                    .getDate();
                0 === a.length && (a = w("<div>")
                        .addClass("calendar-content")
                        .addClass(s.clsCalendarContent)
                        .appendTo(i)), a.html(""), i = w("<div>")
                    .addClass("calendar-toolbar")
                    .appendTo(a), w("<span>")
                    .addClass("prev-month")
                    .html(s.prevMonthIcon)
                    .appendTo(i), w("<span>")
                    .addClass("curr-month")
                    .html(o.months[this.current.month])
                    .appendTo(i), w("<span>")
                    .addClass("next-month")
                    .html(s.nextMonthIcon)
                    .appendTo(i), w("<span>")
                    .addClass("prev-year")
                    .html(s.prevYearIcon)
                    .appendTo(i), w("<span>")
                ...
                var d = w("<div>")
                    ...
                    .appendTo(a),
                    u = "day";
                for (!0 === s.showWeekNumber && (w("<span>")
                    .addClass("week-number")
                    .html("#")
                    .appendTo(d), u += " and-week-number"), e = 0; e < 7; e++) 0 === s.weekStart ? t = e : 7 === (t = e + 1) && (t = 0), w("<span>")
                    .addClass(u)
                    .html(o.days[t + 7])
                    .appendTo(d);
                var h = w("<div>")
                ...
                for (!0 === s.showWeekNumber && w("<div>")
                    .addClass("week-number")
                    .html(new Date(m, n, c - f + 1)
                        .getWeek(s.weekStart))
                    .appendTo(p), e = 0; e < f; e++) {
                    var v, g = c - f + e + 1,
                        C = w("<div>")
                        .addClass(u + " outside")
                        .appendTo(p);
                    (v = new Date(m, n, g))
                    .setHours(0, 0, 0, 0), C.data("day", v.getTime()), !0 === s.outside && (C.html(g), 0 < this.excludeDay.length && -1 < this.excludeDay.indexOf(v.getDay()) && C.addClass("disabled excluded")
                        .addClass(s.clsExcluded), this._fireEvent("day-draw", {
                            date: v,
                            cell: C[0]
                        })), r++
                }
                for (l.setHours(0, 0, 0, 0); l.getMonth() === this.current.month;)(C = w("<div>")
                        .addClass(u)
                        .html(l.getDate())
                        .appendTo(p))
                    .data("day", l.getTime()), this.show.getTime() === l.getTime() && C.addClass("showed"), this.today.getTime() === l.getTime() && C.addClass("today")
                    .addClass(s.clsToday), 0 === this.special.length ? (-1 !== this.selected.indexOf(l.getTime()) && C.addClass("selected")
                        .addClass(s.clsSelected), -1 !== this.exclude.indexOf(l.getTime()) && C.addClass("disabled excluded")
                        .addClass(s.clsExcluded), null !== this.min && l.getTime() < this.min.getTime() && C.addClass("disabled excluded")
                        .addClass(s.clsExcluded), null !== this.max && l.getTime() > this.max.getTime() && C.addClass("disabled excluded")
                        .addClass(s.clsExcluded), 0 < this.excludeDay.length && -1 < this.excludeDay.indexOf(l.getDay()) && C.addClass("disabled excluded")
                        .addClass(s.clsExcluded)) : -1 === this.special.indexOf(l.getTime()) && C.addClass("disabled excluded")
                    .addClass(s.clsExcluded), this._fireEvent("day-draw", {
                        date: l,
                        cell: C[0]
                    }), ++r % 7 == 0 && (p = w("<div>")
                        .addClass("days-row")
                        .appendTo(h), !0 === s.showWeekNumber && w("<div>")
                        .addClass("week-number")
                        .html(new Date(l.getFullYear(), l.getMonth(), l.getDate() + 1)
                            .getWeek(s.weekStart))
                        .appendTo(p)), l.setDate(l.getDate() + 1), l.setHours(0, 0, 0, 0);
                if (f = 0 === s.weekStart ? l.getDay() : 0 === l.getDay() ? 6 : l.getDay() - 1, m = 11 < this.current.month + 1 ? (n = 0, this.current.year + 1) : (n = this.current.month + 1, this.current.year), 0 < f)
                    for (e = 0; e < 7 - f; e++) C = w("<div>")
                        .addClass(u + " outside")
                        .appendTo(p), (v = new Date(m, n, e + 1))
                        .setHours(0, 0, 0, 0), C.data("day", v.getTime()), !0 === s.outside && (C.html(e + 1), 0 < this.excludeDay.length && -1 < this.excludeDay.indexOf(v.getDay()) && C.addClass("disabled excluded")
                            .addClass(s.clsExcluded), this._fireEvent("day-draw", {
                                date: v,
                                cell: C[0]
                            }))
        ...
        .on(n.events.click, function() {
            w(".calendar .calendar-years")
                .each(function() {
                    w(this)
                        .removeClass("open")
                }), w(".calendar .calendar-months")
                .each(function() {
                    w(this)
                        .removeClass("open")
                })
    ...
    l.calendarPickerSetup = function(e) {
            ...
            _createStructure: function() {
                var e, s = this,
                    ...
                    o = this.options,
                    n = c("<div>")
                    .addClass("input " + a[0].className + " calendar-picker"),
                    t = c("<div>")
                    .addClass("button-group"),
                    r = c("<div>")
                    .addClass("drop-shadow"),
                    i = c("body");
                a.attr("type", "text"), a.attr("autocomplete", "off"), a.attr("readonly", !0), e = "" !== ("" + o.value)
                    .trim() ? o.value : a.val()
                    .trim(), d.isValue(e) ? this.value = d.isValue(o.inputFormat) ? e.toDate(o.inputFormat, o.locale) : new Date(e) : o.useNow && (this.value = new Date), d.isValue(this.value) && this.value.setHours(0, 0, 0, 0), a.val(d.isValue(e) || !0 !== o.nullValue ? s.value.format(o.format, o.locale) : ""), n.insertBefore(a), a.appendTo(n), t.appendTo(n), r.appendTo(o.dialogMode ? i : n), l.makePlugin(r, "calendar", {
                        wide: o.calendarWide,
                        ...
                        onDayClick: function(e, t, n) {
                            var i = new Date(e[0]);
                            i.setHours(0, 0, 0, 0), s._removeOverlay(), s.value = i, a.val(i.format(o.format, o.locale)), a.trigger("change"), r.removeClass("open open-up"), r.hide(), s._fireEvent("change", {
                                val: s.value
                            }), s._fireEvent("day-click", {
                                sel: e,
                                day: t,
                                el: n
                            })
                    ...
                    }), this.calendar = r, !0 === o.clearButton && c("<button>")
                    .addClass("button input-clear-button")
                    .attr("tabindex", -1)
                    .attr("type", "button")
                    .html(o.clearButtonIcon)
                    .appendTo(t), c("</button><button>")
                    .addClass("button")
                    .attr("tabindex", -1)
                    .attr("type", "button")
                    .html(o.calendarButtonIcon)
                    .appendTo(t), "" !== o.prepend && c("<div>")
                    .html(o.prepend)
                    .addClass("prepend")
                    .addClass(o.clsPrepend)
                    .appendTo(n), "rtl" === a.attr("dir") && n.addClass("rtl"), -1 < String(o.size)
                    .indexOf("%") ? n.css({
                        width: o.size
                    }) : n.css({
                        width: parseInt(o.size) + "px"
                    }), !(a[0].className = "") === o.copyInlineStyles && c.each(d.getInlineStyles(a), function(e, t) {
                        n.css(e, t)
                    }), n.addClass(o.clsPicker), a.addClass(o.clsInput), !0 === o.dialogOverlay && (this.overlay = s._overlay()), !0 === o.dialogMode ? n.addClass("dialog-mode") : d.media("(max-width: " + o.dialogPoint + "px)") && (n.addClass("dialog-mode"), this.calendar.addClass("dialog-mode")), o.label && (t = c("<label>")
            ...
            _createEvents: function() {
                var n = this,
                    ...
                    e = this.options,
                    i = t.parent(),
                    s = i.find(".input-clear-button"),
                    a = this.calendar,
                    o = l.getPlugin(a[0], "calendar"),
                    r = this.calendar;
                c(window)
                    .on(l.events.resize, function() {
                        !0 !== e.dialogMode && (d.media("(max-width: " + e.dialogPoint + "px)") ? (i.addClass("dialog-mode"), r.appendTo("body")
                            .addClass("dialog-mode")) : (i.removeClass("dialog-mode"), r.appendTo(i)
                            .removeClass("dialog-mode")))
                    }, {
                        ns: this.id
                    }), 0 < s.length && s.on(l.events.click, function(e) {
                        t.val("")
                            .trigger("change")
                            .blur(), n.value = null, e.preventDefault(), e.stopPropagation()
                    }), i.on(l.events.click, "button, input", function(e) {
                        var t = d.isValue(n.value) ? n.value : new Date;
                        t.setHours(0, 0, 0, 0), !1 === a.hasClass("open") && !1 === a.hasClass("open-up") ? (c(".calendar-picker .calendar")
                            .removeClass("open open-up")
                            .hide(), o.setPreset([t]), o.setShow(t), o.setToday(t), i.hasClass("dialog-mode") && n.overlay.appendTo(c("body")), a.addClass("open"), d.inViewport(a[0]) || a.addClass("open-up"), n._fireEvent("calendar-show", {
                                calendar: a
                            })) : (n._removeOverlay(), a.removeClass("open open-up"), n._fireEvent("calendar-hide", {
                            calendar: a
                        })), e.preventDefault(), e.stopPropagation()
            ...
            _overlay: function() {
                var e = this.options,
                    t = c("<div>");
                return t.addClass("overlay for-calendar-picker")
                    .addClass(e.clsOverlay), "transparent" === e.overlayColor ? t.addClass("transparent") : t.css({
                        background: l.colors.toRGBA(e.overlayColor, e.overlayAlpha)
                    }), t
            },
            ...
            val: function(e) {
                ...
                !0 === d.isDate(e, n.inputFormat) && (l.getPlugin(this.calendar[0], "calendar")
                    .clearSelected(), this.value = "string" == typeof e ? n.inputFormat ? e.toDate(n.inputFormat, n.locale) : new Date(e) : e, d.isValue(this.value) && this.value.setHours(0, 0, 0, 0), t.val(this.value.format(n.format, n.locale)), t.trigger("change"))
            },
            disable: function() {
                this.element.data("disabled", !0), this.element.parent()
                    .addClass("disabled")
            },
            enable: function() {
                this.element.data("disabled", !1), this.element.parent()
            ...
            changeAttribute: function(e) {
                var t = this,
                    n = this.element,
                    i = l.getPlugin(this.calendar[0], "calendar");
                switch (e) {
                    case "value":
                        t.val(n.attr("value"));
                        break;
            ...
            destroy: function() {
                ...
                return c(window)
                    .off(l.events.resize, {
                        ns: this.id
                    }), n.off(l.events.click), t.off(l.events.click, "button, input"), e.off(l.events.blur), e.off(l.events.focus), e.off(l.events.change), l.getPlugin(this.calendar, "calendar")
                    .destroy(), e
            }
        }), c(document)
        .on(l.events.click, ".overlay.for-calendar-picker", function() {
            c(this)
                .remove(), c(".calendar-for-picker.open")
                .removeClass("open open-up")
        }), c(document)
        .on(l.events.click, function() {
            c(".calendar-picker .calendar")
                .removeClass("open open-up")
        })
}(Metro, m4q),
function(f, a) {
    ...
    f.carouselSetup = function(e) {
        ...
        _create: function() {
            var e = this.element,
                ...
                n = e.find(".slide"),
                i = e.find(".slides");
            this.dir = this.options.direction, e.addClass("carousel")
                .addClass(t.clsCarousel), e.css({
                    maxWidth: t.width
                }), !0 === t.controlsOutside && e.addClass("controls-outside"), 0 === i.length && (i = a("<div>")
                    .addClass("slides")
                    .appendTo(e), n.appendTo(i)), n.addClass(t.clsSlides), 0 < n.length && (this._createSlides(), this._createControls(), this._createBullets(), this._createEvents(), this._resize(), !0 === t.controlsOnMouse && (e.find("[class*=carousel-switch]")
                    .fadeOut(0), e.find(".carousel-bullets")
                    .fadeOut(0)), !0 === t.autoStart ? this._start() : this._fireEvent("slide-show", {
        ...
        _start: function() {
            ...
            void 0 !== s.data("period") && (i = s.data("period")), this.slides.length <= 0 1 || (!1="==" this.interval && (this.interval="setTimeout(function()" { var e="left" =="=" n.direction ? "next" : "prior"; t._slideto(e, !0) }, i)), this._fireevent("start", element: })) _stop: function() clearinterval(this.interval), _resize: t, e, n="this.element," i="this.options," s="n.outerWidth();" - < ["16 9", "21 "4 3"].indexof(i.height) t="o.aspectRatioH(s," i.height) -1 string(i.height) .indexof("@") (e="i.height.substr(1)" .toarray("|"), a.each(e, window.matchmedia(e[0]) .matches (t="-1" 3"].indexof(e[1]) o.aspectratioh(s, e[1]) parseint(e[1])) n.css({ height: }) _createslides: function(e) if (void !="=" t.data("cover") t.css({ backgroundimage: "url(" + ")" }), e) switch (i.effect) case "switch": "slide": t.css("left", "100%"); break; "slide-v": t.css("top", "fade": "zoom": "swirl": t.css("opacity", "0") } else t.addclass("active-slide"); t.addclass(i.clsslide), n.slides.push(t) this.currentindex="0," this.current="this.slides[this.currentIndex]" _createcontrols: !1 i.controls>")
                ...
                .html("<"), i.controlnext && e.html(i.controlnext), i.controlprev t.html(i.controlprev), e.appendto(n), t.appendto(n)) }, _createbullets: function() { var e, t, n="this.element," i="this.options;" if (!1 !="=" i.bullets) for (e="a(" <div">")
                    .addClass("carousel-bullets")
                    .addClass(i.bulletsSize + "-size")
                    .addClass("bullet-style-" + i.bulletsStyle)
                    .addClass(i.clsBullets), "default" === i.bulletsPosition || "center" === i.bulletsPosition ? e.addClass("flex-justify-center") : "left" === i.bulletsPosition ? e.addClass("flex-justify-start") : e.addClass("flex-justify-end"), t = 0; t < this.slides.length; t++) {
                    var s = a("<span>")
                        .addClass("carousel-bullet")
                        .addClass(i.clsBullet)
                        .data("slide", t);
                    0 === t && s.addClass("bullet-on")
                        .addClass(i.clsBulletOn), s.appendTo(e)
                }
                e.appendTo(n)
            }
        },
        _createEvents: function() {
            ...
            e.on(f.events.click, ".carousel-bullet", function() {
                    ...
                    e.find("[class*=carousel-switch]")
                        .fadeIn(), e.find(".carousel-bullets")
                        .fadeIn()
                }), e.on(f.events.leave, function() {
                    e.find("[class*=carousel-switch]")
                        .fadeOut(), e.find(".carousel-bullets")
                        .fadeOut()
        ...
        _slideToSlide: function(e) {
            var t, n, i, s = this.element,
                a = this.options;
            void 0 !== this.slides[e] && this.currentIndex !== e && (i = e > this.currentIndex ? "next" : "prev", t = this.slides[this.currentIndex], n = this.slides[e], this.currentIndex = e, this._effect(t, n, a.effect, i), s.find(".carousel-bullet")
                .removeClass("bullet-on")
                .removeClass(a.clsBulletOn), s.find(".carousel-bullet:nth-child(" + (this.currentIndex + 1) + ")")
                .addClass("bullet-on")
        ...
        _slideTo: function(e, t) {
            var n, i, s = this.element,
                a = this.options;
            void 0 === e && (e = "next"), n = this.slides[this.currentIndex], "next" === e ? (this.currentIndex++, this.currentIndex >= this.slides.length && (this.currentIndex = 0)) : (this.currentIndex--, this.currentIndex < 0 && (this.currentIndex = this.slides.length - 1)), i = this.slides[this.currentIndex], this._effect(n, i, a.effect, e, t), s.find(".carousel-bullet")
                .removeClass("bullet-on")
                .removeClass(a.clsBulletOn), s.find(".carousel-bullet:nth-child(" + (this.currentIndex + 1) + ")")
                .addClass("bullet-on")
                .addClass(a.clsBulletOn)
        ...
        setEffect: function(e) {
            var t = this.element,
                n = this.options,
                t = t.find(".slide");
            m.includes(e) && (n.effect = e, t.removeStyleProperty("transform")
                .css({
                    top: 0,
                    left: 0
                }))
        ...
        destroy: function() {
            var e = this.element,
                t = this.options;
            return e.off(f.events.click, ".carousel-bullet"), e.off(f.events.click, ".carousel-switch-next"), e.off(f.events.click, ".carousel-switch-prev"), !0 === t.stopOnMouse && !0 === t.autoStart && (e.off(f.events.enter), e.off(f.events.leave)), !0 === t.controlsOnMouse && (e.off(f.events.enter), e.off(f.events.leave)), e.off(f.events.click, ".slide"), a(window)
                .off(f.events.resize, {
                    ns: this.id
                }), e
        }
    ...
    i.charmsSetup = function(e) {
        ...
        _createStructure: function() {
            ...
            e.addClass("charms")
                ...
                .addClass(t.clsCharms), this.origin.background = e.css("background-color"), e.css({
        ...
        isOpen: function(e) {
            if (!1 !== this.check(e)) return t(e)
                .hasClass("open")
        },
        open: function(e) {
            !1 !== this.check(e) && i.getPlugin(e, "charms")
                .open()
        },
        close: function(e) {
            !1 !== this.check(e) && i.getPlugin(e, "charms")
...
function(o, d) {
    ...
    o.chatSetup = function(e) {
        ...
        _createStructure: function() {
            ...
            i.addClass("chat")
                .addClass(s.clsChat), i.css({
                    width: s.width,
                    height: s.height
                }), u.isValue(s.title) && d("<div>")
                .addClass("title")
                .html(s.title)
                .appendTo(i), d("<div>")
                .addClass("messages")
                ...
                .appendTo(i), (t = d("<input type="text">"))
                .appendTo(e), t.input({
                    customButtons: a,
                    clsInput: s.clsInput
                }), s.welcome && this.add({
        ...
        delMessage: function(e) {
            return this.element.find(".messages")
                .find("#" + e)
                .remove(), this
        },
        updMessage: function(e) {
            var t = this.element.find(".messages")
                .find("#" + e.id);
            return 0 === t.length || (t.find(".message-text")
                .html(e.text), t.find(".message-time")
                .html(e.time)), this
        },
        clear: function() {
            this.element.find(".messages")
                .html(""), this.lastMessage = null
        },
    ...
    e.checkboxSetup = function(e) {
        ...
        _createStructure: function() {
            ...
            t.attr("type", "checkbox"), void 0 !== t.attr("readonly") && t.on("click", function(e) {
                ...
                .addClass("checkbox " + t[0].className)
        ...
        changeAttribute: function(e) {
            ...
            switch (e) {
                ...
                case "data-indeterminate":
                    ...
                    break;
                case "data-style":
                    t = parseInt(n.attr("data-style")), o.isInt(t) && (i.style = t, s.removeClass("style1 style2")
                        .addClass("style" + t))
            }
        },
        destroy: function() {
    ...
    o.collapseSetup = function(e) {
        ...
        _create: function() {
            var t = this,
                n = this.element,
                e = this.options,
                i = !1 !== e.toggleElement ? r(e.toggleElement) : 0 < n.siblings(".collapse-toggle")
                .length ? n.siblings(".collapse-toggle") : n.siblings("a:nth-child(1)");
...
function(u, h) {
    ...
    var a = u.utils,
        n = {
            ...
            clsUserColor: "",
            onColor: u.noop,
            onMyObjectCreate: u.noop
        };
    u.colorSelectorSetup = function(e) {
        n = h.extend({}, n, e)
    }, window.metroColorSelectorSetup, u.colorSelectorSetup(window.metroColorSelectorSetup), u.Component("color-selector", {
        init: function(e, t) {
            return this._super(t, e, n, {
                id: a.elementId("color-selector"),
                defaultSwatches: [],
                showValues: [],
                userColors: [],
                hue: 0,
        ...
        _create: function() {
            this.element;
            var e = this.options;
            a.isValue(e.defaultSwatches) && (this.defaultSwatches = e.defaultSwatches.toArray(",")), a.isValue(e.showValues) && (this.showValues = e.showValues.toArray(",")), a.isValue(e.userColors) && (this.userColors = e.userColors.toArray(",")), this._createStructure(), this._createEvents(), this._fireEvent("color-selector-create")
        },
        _createStructure: function() {
            var e, t, n, i, s, a, o, r, l = this,
                c = this.element,
                d = this.options;
            c.addClass("color-selector")
                .addClass(d.clsSelector), c.append(n = h("<div>")
                    .addClass("color-box")), n.append(i = h("<div>")
                    .addClass("row")), i.append(e = h("<div>")
                    .addClass("default-swatches")
                    .addClass(d.clsSwatches)), h.each(this.defaultSwatches, function() {
                    e.append(h("<button>")
                        .attr("data-color", this)
                        .attr("type", "button")
                        .addClass("swatch")
                        .addClass(d.clsSwatch)
                        .css("background-color", this))
                }), n.append(i = h("<div>")
                    .addClass("row")), i.append(t = h("<div>")
                    .addClass("color-map")), t.append(r = h("<button>")
                    .attr("type", "button")
                    .addClass("cursor color-cursor")), t.append(a = h("<canvas>")
                    .addClass("color-canvas")), i.append(t = h("<div>")
                    .addClass("hue-map")), t.append(o = h("<button>")
                    .attr("type", "button")
                    .addClass("cursor hue-cursor")), t.append(s = h("<canvas>")
                    .addClass("hue-canvas")), n.append(i = h("<div>")
                    .addClass("row")), i.append(t = h("<div>")
                    .addClass("color-value-hex")), t.append(h("<input type="radio" name="returnType" value="hex" checked>")
                    .addClass("check-color-value-hex")), t.append(h("<input type="text" data-prepend="HEX:" readonly>")
                    .addClass("input-small color-value-x")), i.append(t = h("<div>")
                    .addClass("color-value-rgb")), t.append(h("<input type="radio" name="returnType" value="rgb">")
                    .addClass("check-color-value-rgb")), t.append(h("<input type="text" data-prepend="R:" readonly>")
                    .addClass("input-small color-value-r")), t.append(h("<input type="text" data-prepend="G:" readonly>")
                    .addClass("input-small color-value-g")), t.append(h("<input type="text" data-prepend="B:" readonly>")
                    .addClass("input-small color-value-b")), i.append(t = h("<div>")
                    .addClass("color-value-hsl")), t.append(h("<input type="radio" name="returnType" value="hsl">")
                    .addClass("check-color-value-hsv")), t.append(h("<input type="text" data-prepend="H:" readonly>")
                    .addClass("input-small color-value-h")), t.append(h("<input type="text" data-prepend="S:" readonly>")
                    .addClass("input-small color-value-s")), t.append(h("<input type="text" data-prepend="L:" readonly>")
                    .addClass("input-small color-value-l")), i.append(t = h("<div>")
                    .addClass("color-value-hsv")), t.append(h("<input type="radio" name="returnType" value="hsv">")
                    .addClass("check-color-value-hsl")), t.append(h("<input type="text" data-prepend="H:" readonly>")
                    .addClass("input-small color-value-h")), t.append(h("<input type="text" data-prepend="S:" readonly>")
                    .addClass("input-small color-value-s")), t.append(h("<input type="text" data-prepend="V:" readonly>")
                    .addClass("input-small color-value-v")), i.append(t = h("<div>")
                    .addClass("color-value-cmyk")), t.append(h("<input type="radio" name="returnType" value="cmyk">")
                    .addClass("check-color-value-cmyk")), t.append(h("<input type="text" data-prepend="C:" readonly>")
                    .addClass("input-small color-value-c")), t.append(h("<input type="text" data-prepend="M:" readonly>")
                    .addClass("input-small color-value-m")), t.append(h("<input type="text" data-prepend="Y:" readonly>")
                    .addClass("input-small color-value-y")), t.append(h("<input type="text" data-prepend="K:" readonly>")
                    .addClass("input-small color-value-k")), n.append(i = h("<div>")
                    .addClass("row user-colors-container")), i.append(h("<div>")
                    .addClass("user-colors-title")
                    .addClass(d.clsUserColorsTitle)
                    .html(d.userColorsTitle)), i.append(h("<div>")
                    .addClass("user-colors")
                    .addClass(d.clsUserColors)), i.append(i = h("<div>")
                    .addClass("user-colors-actions")), i.append(h("<button>")
                    .addClass("button add-button")
                    .addClass(d.clsUserColorButton)
                    .html("<span class="user-swatch"></span><span>" + d.addUserColorTitle + "</span>")), i = n.find("input[type=text]"), u.makePlugin(i, "input", {
                    clearButton: !1,
                    clsPrepend: d.clsLabel,
                    clsComponent: d.clsInput
                }), i.addClass(d.clsValue), (n = n.find("input[type=radio]")
                    .each(function() {
                        h(this)
                            .attr("name", l.id + "-returnType")
                    }))
                .each(function() {
                    h(this)
                        .val() === d.returnValueType && (this.checked = !0)
                }), u.makePlugin(n, "radio", {
                    style: 2
                }), h.each(["hex", "rgb", "hsv", "hsl", "cmyk"], function() {
                    -1 === l.showValues.indexOf(this) && c.find(".color-value-" + this)
                        .hide()
                }), d.showUserColors || c.find(".user-colors-container")
                .hide(), this._fillUserColors(), this.hueCanvas = s, this.hueCursor = o, this.shadeCanvas = a, this.shadeCursor = r, this._createShadeCanvas(), this._createHueCanvas(), this._setColorValues(), this._updateCursorsColor()
        },
        _createShadeCanvas: function(e) {
            var t = this.shadeCanvas[0],
                n = t.getContext("2d");
            n.clearRect(0, 0, t.width, t.height), e = e || "#f00", n.fillStyle = e, n.fillRect(0, 0, t.width, t.height);
        ...
        _createHueCanvas: function() {
            ...
            n.addColorStop(0, "hsl(0,100%,50%)"), n.addColorStop(.17, "hsl(298.8, 100%, 50%)"), n.addColorStop(.33, "hsl(241.2, 100%, 50%)"), n.addColorStop(.5, "hsl(180, 100%, 50%)"), n.addColorStop(.67, "hsl(118.8, 100%, 50%)"), n.addColorStop(.83, "hsl(61.2,100%,50%)"), n.addColorStop(1, "hsl(360,100%,50%)"), t.fillStyle = n, t.fillRect(0, 0, e.width, e.height)
        },
        ...
        _getHueColor: function(e) {
            var t = this.hueCanvas,
                ...
                t = t.height(),
                e = e - n.top;
            t < e && (e = t), e < 0 && (e = 0), 360 === (n = 360 - 360 * (e / t)) && (n = 0), t = "hsl(" + n + ", 100%, 50%)", this.hue = n, this._createShadeCanvas(t), this._updateHueCursor(e), this._updateCursorsColor(), this._setColorValues()
        },
        _getShadeColor: function(e, t) {
            ...
            isNaN(s) && (s = 0), isNaN(n) && (n = 0), this.lightness = (Math.round(100 * s) / 100)
                .toFixed(1), this.saturation = (Math.round(100 * n) / 100)
                .toFixed(1), this._updateColorCursor(e, t), this._updateCursorsColor(), this._setColorValues()
        },
        _updateCursorsColor: function() {
            this.shadeCursor.css({
                backgroundColor: u.colors.toHEX(new u.colorPrimitive.HSL(this.hue, this.saturation, this.lightness))
            }), this.hueCursor.css({
                backgroundColor: u.colors.toHEX(new u.colorPrimitive.HSL(this.hue, 1, .5))
            })
        },
        _updateColorCursor: function(e, t) {
            this.shadeCursor.css({
                top: t,
                left: e
            })
        ...
        _colorToPos: function(e) {
            var t = this.shadeCanvas[0].getBoundingClientRect(),
                ...
                e = t.width * s.s,
                s = t.height * (1 - s.v),
                n = n.height - i.h / 360 * n.height;
            this.hue = i.h, this.saturation = i.s, this.lightness = i.l, this._updateHueCursor(n), this._updateColorCursor(e, s), this._updateCursorsColor(), this._createShadeCanvas("hsl(" + this.hue + ", 100%, 50%)"), this._setColorValues()
        },
        _setColorValues: function() {
            var e = this.element,
                t = this.options,
                n = u.colors.toHSL(new u.colorPrimitive.HSL(this.hue, this.saturation, this.lightness)),
                i = u.colors.toRGB(n),
                s = u.colors.toHSV(n),
                a = u.colors.toCMYK(n),
                o = u.colors.toHEX(n),
                t = h(t.target);
            this.hsl = n, this.hsv = s, this.rgb = i, this.hex = o, this.cmyk = a, e.find(".color-value-hex .color-value-x input")
                .val(o), e.find(".color-value-rgb .color-value-r input")
                .val(i.r), e.find(".color-value-rgb .color-value-g input")
                .val(i.g), e.find(".color-value-rgb .color-value-b input")
                .val(i.b), e.find(".color-value-hsl .color-value-h input")
                .val(n.h.toFixed(0)), e.find(".color-value-hsl .color-value-s input")
                .val(n.s.toFixed(4)), e.find(".color-value-hsl .color-value-l input")
                .val(n.l.toFixed(4)), e.find(".color-value-hsv .color-value-h input")
                .val(s.h.toFixed(0)), e.find(".color-value-hsv .color-value-s input")
                .val(s.s.toFixed(4)), e.find(".color-value-hsv .color-value-v input")
                .val(s.v.toFixed(4)), e.find(".color-value-cmyk .color-value-c input")
                .val(a.c.toFixed(0)), e.find(".color-value-cmyk .color-value-m input")
                .val(a.m.toFixed(0)), e.find(".color-value-cmyk .color-value-y input")
                .val(a.y.toFixed(0)), e.find(".color-value-cmyk .color-value-k input")
                .val(a.k.toFixed(0)), t && t.length && t.css({
                    backgroundColor: o
                }), e.find(".user-colors-actions .user-swatch")
                .css({
                    backgroundColor: o
        ...
        _createEvents: function() {
            var n = this,
                ...
                e = i.find(".hue-map"),
                s = i.find(".color-map");
            e.on(u.events.startAll, function(e) {
                n._getHueColor(a.pageXY(e)
                        .y), n.hueCursor.addClass("dragging"), h(document)
                    .on(u.events.moveAll, function(e) {
                        e.preventDefault(), n._getHueColor(a.pageXY(e)
                            .y)
                    }, {
                        ns: n.id,
                        passive: !1
                    }), h(document)
                    .on(u.events.stopAll, function() {
                        n.hueCursor.removeClass("dragging"), h(document)
                            .off(u.events.moveAll, {
                                ns: n.id
                            }), h(document)
                            .off(u.events.stopAll, {
                                ns: n.id
                            })
                    }, {
                        ns: n.id
                    })
            }), s.on(u.events.startAll, function(e) {
                n._getShadeColor(a.pageXY(e)
                        .x, a.pageXY(e)
                        .y), n.shadeCursor.addClass("dragging"), h(document)
                    .on(u.events.moveAll, function(e) {
                        e.preventDefault(), n._getShadeColor(a.pageXY(e)
                            .x, a.pageXY(e)
                            .y)
                    }, {
                        ns: n.id,
                    ...
                    .on(u.events.stopAll, function() {
                        n.shadeCursor.removeClass("dragging"), h(document)
                            .off(u.events.moveAll, {
                                ns: n.id
                            }), h(document)
                            .off(u.events.stopAll, {
            ...
            }), i.on("click", ".swatch", function(e) {
                n._colorToPos(h(this)
                    .attr("data-color")), e.preventDefault(), e.stopPropagation()
            }), i.on("click", ".add-button", function(e) {
                var t = u.colors.toHEX(new u.colorPrimitive.HSL(n.hue, n.saturation, n.lightness)); - 1 === n.userColors.indexOf(t) && (n.userColors.push(t), i.find(".user-colors")
                    .append(h("</button><button>")
                        .attr("data-color", t)
                        .attr("type", "button")
            ...
            }), i.on("click", "input[type=radio]", function(e) {
                t.returnValueType = h(this)
                    .val(), e.stopPropagation()
            })
        },
        val: function(e) {
            var t, n = this.options;
            if (!a.isValue(e) || !u.colors.isColor(e)) {
            ...
            this._colorToPos(u.colors.toHEX(e))
        },
        user: function(e) {
            this.element;
            if (!a.isValue(e)) return this.userColors;
            !Array.isArray(e) && "string" != typeof e || (this.userColors = "string" == typeof e ? e.toArray(",") : e, this._fillUserColors())
        },
        _fillUserColors: function() {
            var e = this.element.find(".user-colors")
                .clear();
            h.each(this.userColors, function() {
                e.append(h("</button><button>")
                    .attr("data-color", this)
                    .attr("type", "button")
                    .addClass("swatch user-swatch")
                    .css({
        ...
        changeAttribute: function(e, t) {
            var n = this.options;
            "data-return-value-type" === e && (n.returnValueType = t), "data-return-as-string" === e && (n.returnValueType = a.bool(t))
        },
        destroy: function() {
            this.element.remove()
        }
...
function(e, v) {
    ...
    }, C.prototype.toString2 = function() {
        return "hsv(" + [this.h, this.s, this.v].join(",") + ")"
    }, C.prototype.toString = function() {
        return "hsv(" + [this.h, Math.round(100 * this.s) + "%", Math.round(100 * this.v) + "%"].join(",") + ")"
    }, l.prototype.toString2 = function() {
        return "hsl(" + [this.h, this.s, this.l].join(",") + ")"
    }, l.prototype.toString = function() {
        return "hsl(" + [this.h, Math.round(100 * this.s) + "%", Math.round(100 * this.l) + "%"].join(",") + ")"
    }, c.prototype.toString = function() {
    ...
    var m = {
        ...
        random: function(e, t) {
            var n;
            return e = e || i, t = void 0 !== t ? t : 1, n = "#" + ((1 << 24) + (v.random(0, 255) << 16) + (v.random(0, 255) << 8) + v.random(0, 255))
                .toString(16)
                .slice(1), "hex" === e ? n : this.toColor(n, e, t)
        },
        parse: function(e) {
            var t = e.toLowerCase()
                .trim(),
        ...
        rgb2hex: function(e) {
            return this.check(e, "rgb"), "#" + ((1 << 24) + (e.r << 16) + (e.g << 8) + e.b)
                .toString(16)
                .slice(1)
        },
        rgb2hsv: function(e) {
            ...
            var t = new C,
                ...
                l = a,
                e = 0 === a ? 0 : 1 - o / a,
                r = a === o ? 0 : a === n && s <= 0 1 2 51 60 120 240 255 360 i ? (i - s) r * : a="==" n && < s + (s n) (n i) 0; return t.h="r," t.s="e," t.v="l," t }, hsv2rgb: function(e) { var t, n, i; this.check(e, "hsv"); e.s, o="100" e.v, a) 100, % (o r), l="r" a, c="o" a; switch (math.floor(s 60)) case 0: break; 1: 2: 3: 4: 5: } new h(math.round(255 100), math.round(255 100)) hsv2hex: "hsv"), this.rgb2hex(this.hsv2rgb(e)) hex2hsv: "hex"), this.rgb2hsv(this.hex2rgb(e)) rgb2cmyk: "rgb"); p, 255, e="e.b" 255; t.k="Math.min(1" i, e), t.c="1" (1 t.k) t.k), t.m="1" t.y="1" t.c), t.m), t.y), cmyk2rgb: "cmyk"), h(math.floor(255 e.c 100) e.k 100)), math.ceil(255 e.m e.y 100))) hsv2hsl: e.s) ||="l(t," e, 2) hsl2hsv: "hsl"), e.l) i))) 2, c(t, n), e) rgb2websafe: "rgb"), h(51 math.round(e.r 51), math.round(e.g math.round(e.b 51)) rgba2websafe: "rgba"); r(t.r, t.g, t.b, e.a) hex2websafe: this.rgb2hex(this.rgb2websafe(this.hex2rgb(e))) hsv2websafe: this.rgb2hsv(this.rgb2websafe(this.torgb(e))) hsl2websafe: this.hsv2hsl(this.rgb2hsv(this.rgb2websafe(this.torgb(e)))) cmyk2websafe: this.rgb2cmyk(this.rgb2websafe(this.cmyk2rgb(e))) websafe: this.ishex(e) this.hex2websafe(e) this.isrgb(e) this.rgb2websafe(e) this.isrgba(e) this.rgba2websafe(e) this.ishsv(e) this.hsv2websafe(e) this.ishsl(e) this.hsl2websafe(e) this.iscmyk(e) this.cmyk2websafe(e) tocolor: function(e, (t.tolowercase()) "hex": "rgb": "rgba": n); "hsl": "hsla": "hsv": "cmyk": default: tohex: this.parse(e) e; if (!e) throw error("unknown color format!"); "string"="=" typeof this.rgb2hex(this.torgb(e)) torgb: (this.isrgb(e)) (this.isrgba(e)) h(e.r, e.g, e.b); (this.ishsv(e)) this.hsv2rgb(e); (this.ishsl(e)) this.hsv2rgb(this.hsl2hsv(e)); (this.ishsla(e)) (this.ishex(e)) this.hex2rgb(e); (this.iscmyk(e)) this.cmyk2rgb(e); format!") torgba: t) (e.a="t)," r(e.r, e.b, tohsv: this.rgb2hsv(this.torgb(e)) tohsl: this.hsv2hsl(this.rgb2hsv(this.torgb(e))) tohsla: e.a="t," c(e.h, e.l, tocmyk: this.rgb2cmyk(this.torgb(e)) grayscale: .tolowercase(), t.r .7154 t.g .0721 t.b), h(t, t); this.tocolor(t, darken: 10, this.lighten(e, -1 math.abs(t)) lighten: s, o, r, (t="t" 10), .tolowercase(); for (e !="=" d u void 0, 16),>> 16) + a) ? s = 255 : s < 0 && (s = 0), 255 < (o = (r >> 8 & 255) + a) ? o = 255 : o < 0 && (o = 0), 255 < (a = (255 & r) + a) ? a = 255 : a < 0 && (a = 0), n = "#" + (a | o << 8 | s << 16)
                .toString(16), c ? t-- : t++, n.length < 7;);
        ...
        hueShift: function(e, t, n, i) {
            var s, a = this.toHSV(e),
                ...
                n = n || 0,
                i = i || 0;
            for (r += t || 0; 360 <= 0 1 2 180 360 r;) r -="360;" for (; < 0;) +="360;" return a.h="r," a.s && (a.s="1)," a.v (a.v="1)," o !="=" d u || (s="e.a)," this.tocolor(a, o, s) }, createscheme: function(e, t, n, i) { var s, a, g, i), l="this," c="this.toHSV(e)," h="c.v;" if (!1="==" this.ishsv(c)) console.warn("the value is a not supported color format!"), !1; function p(e, n) math.max(t, math.min(e, n)) } f(e, e t ? : n m(e, t) (e switch (t) case "monochromatic": "mono": (1="==" o.algorithm)(a="this.hsv2rgb(c))" .r="f(Math.round(a.r" (255 a.r) * o.tint1), 0, 255), a.g="f(Math.round(a.g" a.g) a.b="f(Math.round(a.b" a.b) r.push(this.rgb2hsv(a)), (a="this.hsv2rgb(c))" o.tint2), r.push(c), o.shade1), o.shade2), r.push(this.rgb2hsv(a)); else (2="==" o.algorithm) (r.push(c), s="1;" s++) o.step, 1), r.push(new c(d, u, h)); (3="==" h)), break; "complementary": "complement": "comp": 180), "double-complementary": "double-complement": "double": o.angle), "analogous": "analog": "triadic": "triad": 3; 120), "tetradic": "tetra": -1 "square": 4; 90), "split-complementary": "split-complement": "split": default: console.warn("unknown scheme name") n; "hex": l.tohex(e) }); "rgb": l.torgb(e) "rgba": l.torgba(e, o.alpha) "hsl": l.tohsl(e) "hsla": l.tohsla(e, "cmyk": l.tocmyk(e) }(r, getscheme: function() this.createscheme.apply(this, arguments) mix: i="string" =="typeof" this.parse(e) e, this.parse(t) r, .tolowercase() "hex"; e.r="Math.round((t.r" i.r) 2), e.g="Math.round((t.g" i.g) e.b="Math.round((t.b" i.b) e.a="Math.round((t.a" i.a) this["to" n.touppercase()](e) }; f.prototype="{" _setvalue: function(e) m.parse(e) e; m.iscolor(e) ), this._value="e," this._type="m.colorType(this._value)" _setoptions: {}, this._options="v.extend({}," e) getoptions: setoptions: this._setoptions(e) setvalue: this._setvalue(e) getvalue: channel: ["red", "green", "blue"].indexof(e) (this.torgb(), this._value[e[0]]="t," n]()), "alpha"="==" this._value.a (this._value.a="t)," ["hue", "saturation", "value"].indexof(e) (this.tohsv(), ["lightness"].indexof(e) (this.tohsl(), ["cyan", "magenta", "yellow", "black"].indexof(e) (this.tocmyk(), this channels: v.each(e, n.channel(e, }), torgb: rgb: new f(m.torgb(this._value)) void torgba: m.isrgba(this._value) !e (this._value="m.toRGBA(this._value," e)), rgba: f(m.torgba(this._value, e)) tohex: hex: f(m.tohex(this._value)) tohsv: hsv: f(m.tohsv(this._value)) tohsl: hsl: f(m.tohsl(this._value)) tohsla: m.ishsla(this._value) hsla: f(m.tohsla(this._value, tocmyk: cmyk: f(m.tocmyk(this._value)) towebsafe: websafe: f(m.websafe(this._value)) tostring: m.colortostring(this._value) "undefined" todarken: e), darken: f(m.darken(this._value, tolighten: lighten: f(m.lighten(this._value, isdark: m.isdark(this._value) islight: m.islight(this._value) tohueshift: n), hueshift: f(m.hueshift(this._value, tograyscale: this._type), grayscale: f(m.grayscale(this._value, this._type)) type: m.colortype(this._value) m.createscheme(this._value, equal: m.equal(this._value, tomix: f(m.mix(this._value, e.colors="m.init()," window.color="e.Color" f, window.colorprimitive="e.colorPrimitive" h, c, l, p !0="==" window.metro_global_common (window.colors="e.colors)" }(metro, m4q), function(a, o) "use strict"; name: "cookies_accepted", template: null, templatesource: acceptbutton: ".cookie-accept-button", cancelbutton: ".cookie-cancel-button", message: "our website uses cookies to monitor traffic on our and ensure that we can provide customers with the best online experience possible.", duration: "30days", clscontainer: "", clsmessage: clsbuttons: clsacceptbutton: "alert", clscancelbutton: onaccept: a.noop, ondecline: a.noop a.cookiedisclaimer="{" init: this.options="o.extend({}," i, this.disclaimer="o(" <div">"), n.getCookie(this.options.name) || (this.options.template ? o.get(this.options.template)
                .then(function(e) {
                    t.create(e)
        ...
        create: function(e) {
            var n = a.cookie,
                i = this.options,
                s = this.disclaimer;
            s.addClass("cookie-disclaimer-block")
                .addClass(i.clsContainer), e ? e instanceof o ? s.append(e) : s.html(e) : (e = o("<div>")
                    .addClass("cookie-disclaimer-actions")
                    .addClass(i.clsButtons)
                    .append(o("<button>")
                        .addClass("button cookie-accept-button")
                        .addClass(i.clsAcceptButton)
                        .html("Accept"))
                    .append(o("</button><button>")
                        .addClass("button cookie-cancel-button")
                        .addClass(i.clsCancelButton)
                        .html("Cancel")), s.html(o("<div>")
                        .addClass(i.clsMessage)
                        .html(i.message))
                    .append(o("<hr>")
                        .addClass("thin"))
                    .append(e)), s.appendTo(o("body")), s.on(a.events.click, i.acceptButton, function() {
                    var t = 0,
                        e = ("" + i.duration)
                        .toArray(" ");
                    o.each(e, function() {
    ...
    e.cookieSetup = function(e) {
        ...
        setCookie: function(e, t, n) {
            var i = encodeURIComponent(e),
                ...
                s = [],
                n = n && "object" != typeof n ? ((t = new Date)
                    .setTime(t.getTime() + parseInt(n)), a.extend({}, o, {
...
function(s, _) {
    ...
    s.countdownSetup = function(e) {
        ...
        _setBreakpoint: function() {
            var e = this.options;
            this.breakpoint = (new Date)
                .getTime(), o.isValue(e.date) && o.isDate(e.date, e.inputFormat) && (this.breakpoint = (o.isValue(e.inputFormat) ? e.date.toDate(e.inputFormat) : new Date(e.date))
                    .getTime()), 0 < parseInt(e.days) && (this.breakpoint += 864e5 * parseInt(e.days)), 0 < parseInt(e.hours) && (this.breakpoint += 36e5 * parseInt(e.hours)), 0 < parseInt(e.minutes) && (this.breakpoint += 6e4 * parseInt(e.minutes)), 0 < parseInt(e.seconds) && (this.breakpoint += 1e3 * parseInt(e.seconds))
        },
        _build: function() {
            var n, i = this,
                s = this.element,
                ...
                e = (new Date)
                .getTime();
            s.attr("id") || s.attr("id", o.elementId("countdown")), o.isValue(s.attr("id")) || s.attr("id", o.elementId("countdown")), s.addClass("countdown")
                .addClass(a.clsCountdown), this._setBreakpoint(), n = Math.round((i.breakpoint - e) / 864e5), _.each(["days", "hours", "minutes", "seconds"], function() {
                    var e = _("<div>")
                        .addClass("part " + this)
                        .addClass(a.clsPart)
                        .attr("data-label", i.locale.calendar.time[this])
                        .appendTo(s);
                    if ("days" === this && e.addClass(a.clsDays), "hours" === this && e.addClass(a.clsHours), "minutes" === this && e.addClass(a.clsMinutes), "seconds" === this && e.addClass(a.clsSeconds), _("<div>")
                        .addClass("digit")
                        .appendTo(e), _("<div>")
                        .addClass("digit")
                        .appendTo(e), "days" === this && 100 <= n) for (var t="0;" < string(math.round(n 100)) .length; t++) _("<div>")
                            .addClass("digit")
                            .appendTo(e)
                }), (e = s.find(".digit"))
                .append(_("<span class="digit-placeholder">")
                    .html("0")), e.append(_("<span class="digit-value">")
                    .html("0")), this._fireEvent("countdown-create", {
                    element: s
        ...
        tick: function() {
            ...
            if (r <= 0="==" 1 -1) return this.stop(), e.addclass(t.clsalarm), void this._fireevent("alarm", { time: n }); r -="86400" * (n="Math.floor(r" 86400)), this.current.d !="=" && (this.current.d="n," this.draw("days", n)), !1="==" this.zerodaysfired (this.zerodaysfired="!0," i.addclass(t.clszero), this._fireevent("zero", part: "days", value: i })), (i="Math.floor(r" 3600)), this.current.h (this.current.h="i," this.draw("hours", i)), this.zerohoursfired (this.zerohoursfired="!0," s.addclass(t.clszero), "hours", s (s="Math.floor(r" 60)), this.current.m (this.current.m="s," this.draw("minutes", s)), this.zerominutesfired (this.zerominutesfired="!0," a.addclass(t.clszero), "minutes", a this.current.s (this.current.s="r," this.draw("seconds", r)), this.zerosecondsfired (this.zerosecondsfired="!0," o.addclass(t.clszero), "seconds", o this._fireevent("tick", days: n, hours: i, minutes: s, seconds: }) }, draw: function(e, t) var a, o, r, l, c, d, u, h, p, f, m, v, g, w, b="this.element," y="this.options;" for (1="==" (t + .length t),="b.find("."" e " .digit:not(-old-digit)")) .length, < o; r++) if (a="n.eq(i" 1) .find(".digit-value"), math.pow(10, r)) % 10, i--, parseint(a.text()) s) switch (("" y.animate) .tolowercase()) case "slide": g="s," w="C" 0, a) .height(), v.siblings("-old-digit") .remove(), (c="v.clone()" .appendto(v.parent())) .css({ top: -1 "px" }), v.addclass("-old-digit") .animate({ opacity: dur: 900, ease: y.animationfunc, ondone: function() _(this) .remove() } c.html(g) y.animationfunc break; "fade": f="s," m="void" (p="a)" .siblings("-old-digit") (m="p.clone()" .appendto(p.parent())) p.addclass("-old-digit") 450, m.html(f) "zoom": c="s," h="u" d="void" u="(l" l.siblings("-old-digit") (d="l.clone()" .appendto(l.parent())) left: l.addclass("-old-digit") fontsize: d.html(c) 1, [0, h] default: a.html(s) start: t="this.element;" t.data("paused") (clearinterval(this.blinkinterval), clearinterval(this.tickinterval), t.data("paused", !1), this._setbreakpoint(), this.tick(), this.blinkinterval="setInterval(function()" e.blink() 500), this.tickinterval="setInterval(function()" e.tick() 1e3)) stop: clearinterval(this.blinkinterval), e.data("paused", !0), e.find(".digit") .html("0"), this.current="{" d: h: m: s: pause: this.element.data("paused", !0) resume: 1e3) reset: t.find(".part") .removeclass(n.clszero), t.find(".digit") toggleplay: !0="==" this.element.attr("data-pause") ? this.pause() : this.start() ispaused: this.element.data("paused") getbreakpoint: function(e) new date(this.breakpoint) this.breakpoint getleft: date) .gettime(), e); math.round(e 864e5), 36e5), 6e4), i18n: i.locale s.locales[e] (i.locale="e," this.locale="s.locales[i.locale]," _.each(["days", "seconds"], this; n.find(e) .attr("data-label", t.locale.calendar.time[this]) })) changeattrlocale: this.i18n(e) changeattribute: (e) "data-pause": this.toggleplay(); "data-locale": this.changeattrlocale() destroy: _(document) .off("visibilitychange", ns: this.id this.element }(metro, m4q), i) "use strict"; startonviewport: !0, counterdeferred: duration: 2e3, from: timeout: delimiter: ",", prefix: "", suffix: onstart: e.noop, onstop: ontick: oncountercreate: e.noop }; e.countersetup="function(e)" e) window.metrocountersetup, e.countersetup(window.metrocountersetup), e.component("counter", init: this._super(t, e, numbers: [], html: i(t) .html(), started: !1, id: a.elementid("counter") this _create: this._createevents(), this._fireevent("counter-create"), this._run() _createevents: i.window() .on("scroll", n.startonviewport a.inviewport(t[0]) !e.started e.start() _run: !(this.started="!1)" t.startonviewport !a.inviewport(e[0]) || startinviewport: a.isvalue(t) (n.from="+t)," a.isvalue(e) (n.value="+e)," (s.from="+t)," (s.value="+e)," this.started="!0," this._fireevent("start"), i.animate({ innerhtml: [s.from, s.value] defer: s.timeout, s.duration, onframe: n._fireevent("tick", +this.innerhtml this.innerhtml="s.prefix" number(this.innerhtml) .format(0, s.delimiter) s.suffix n._fireevent("stop") this.element.html(this.html) "data-value"="==" "data-from"="==" .off("scroll", function(l, c) cubedeferred: rules: null, color: flashcolor: flashinterval: 1e3, offbefore: attenuation: .3, stoponblur: cells: 4, margin: 8, showaxis: axisstyle: "arrow", cellclick: autorestart: 5e3, clscube: clscell: clsside: clssideleft: clssideright: clssidetop: clssideleftcell: clssiderightcell: clssidetopcell: clsaxis: clsaxisx: clsaxisy: clsaxisz: custom: l.noop, oncubecreate: l.noop l.cubesetup="function(e)" window.metrocubesetup, l.cubesetup(window.metrocubesetup), l.cubedefaultrules="[{" on: [16], [4], right: [1] off: [13, 4], [1, 16], 4] [12, 15], [3, 8], [2, 5] [9, 6, 3], [5, [14, 11, 8] [11], [7], [6] 2, 5], 13, 14], [15, 12, 16] [8, 12], 3] [10, 7], [6, 11], 7] }], l.component("cube", d.elementid("cube"), interval: ruleinterval: running: intervals: [] null="==" t.rules this.rules="l.cubeDefaultRules" this._parserules(t.rules), this._createcube(), this._fireevent("cube-create", element: _parserules: (null="=" !1; (d.isobject(e)) !0; try catch console.warn("unknown or empty rules cell flashing!"), _createcube: 2); i.addclass("cube") .addclass(s.clscube), i.attr("id") i.attr("id", e), this._createcssforflashcolor(), this._createcssforcellsize(), c.each(["left", "right", "top"], t,>")
                        .addClass("side " + this + "-side")
                        .addClass(s.clsSide)
                        .appendTo(i);
                    for ("left" === this && n.addClass(s.clsSideLeft), "right" === this && n.addClass(s.clsSideRight), "top" === this && n.addClass(s.clsSideTop), t = 0; t < a; t++)(e = c("<div>")
                            .addClass("cube-cell")
                            .addClass("cell-id-" + (t + 1))
                            .addClass(s.clsCell))
                        .data("id", t + 1)
                        .data("side", this), e.appendTo(n), !0 === s.numbers && e.html(t + 1)
                });
            e = i.find(".cube-cell");
        ...
        _run: function() {
            var e, t = this,
                n = this.element,
                i = this.options;
            clearInterval(this.interval), n.find(".cube-cell")
                .removeClass("light"), i.custom !== l.noop ? d.exec(i.custom, [n]) : (n.find(".cube-cell")
                    .removeClass("light"), t._start(), e = d.isObject(this.rules) ? d.objectLength(this.rules) : 0, this.interval = setInterval(function() {
                        t._start()
                    }, e * i.flashInterval))
        },
        ...
        _createEvents: function() {
            var e = this,
                ...
                n = this.options;
            c(window)
                .on(l.events.blur, function() {
                    !0 === n.stopOnBlur && !0 === e.running && e._stop()
                }, {
                    ns: t.attr("id")
                }), c(window)
                .on(l.events.focus, function() {
                    !0 === n.stopOnBlur && !1 === e.running && e._start()
                }, {
                    ns: t.attr("id")
                }), t.on(l.events.click, ".cube-cell", function() {
                    !0 === n.cellClick && c(this)
                        .toggleClass("light")
                })
        },
        _start: function() {
            var n = this;
            this.element.find(".cube-cell")
                .removeClass("light"), this.running = !0, c.each(this.rules, function(e, t) {
                    n._execRule(e, t)
                })
        },
        _stop: function() {
        ...
        toRule: function(e, t) {
            ...
            if (null != a && void 0 !== a[e]) {
                clearInterval(this.ruleInterval), this.ruleInterval = !1, this.stop(), i.find(".cube-cell")
                    .removeClass("light");
                for (var o = 0; o <= 0 e; o++) this._execrule(o, a[o], t); d.isint(s.autorestart) && < s.autorestart (this.ruleinterval="setTimeout(function()" { n._run() }, s.autorestart)) } _execrule: function(i, s, a) var o="this," r="this.element;" this._tick(i, a), c.each(["left", "right", "top"], function() t="." + this "-side", e="void" !="=" s.on void s.on[this] s.on[this], n="void" s.off s.off[this] s.off[this]; !1 c.each(e, " .cell-id-" this); o._toggle(e, "on", i, }), c.each(n, "off", }) rule: function(e) if (void e) return this.rules; !0="==" this._parserules(e) (this.options.rules="e," this.stop(), this.element.find(".cube-cell") .removeclass("light"), this._run()) axis:="="="" ? "show" : "hide"; this.element.find(".axis")[e]() changerules: this._parserules(n) (this.stop(), e.find(".cube-cell") t.rules="n," changeaxisvisibility: json.parse(e.attr("data-show-axis")) e.find(".axis")[t]() changeaxisstyle: e.find(".axis") .removeclass("arrow line no-style") .addclass(t) changeattribute: switch (e) case "data-rules": this.changerules(); break; "data-show-axis": this.changeaxisvisibility(); "data-axis-style": this.changeaxisstyle() destroy: clearinterval(this.interval), this.interval="null," c(window) .off(l.events.blur, ns: e.attr("id") .off(l.events.focus, e.off(l.events.click, ".cube-cell"), }(metro, m4q), function(r, d) "use strict"; u="r.utils," label: "", datepickerdeferred: 0, gmt: format: "%y-%m-%d", inputformat: null, locale: metro_locale, value: distance: 3, month: !0, day: year: minyear: maxyear: scrollspeed: 4, copyinlinestyles: !1, clspicker: clspart: clsmonth: clsday: clsyear: clslabel: clsbutton: clsokbutton: clscancelbutton: okbuttonicon: "<span class="default-icon-check"></=></div></div></=></span>",
    ...
    r.datePickerSetup = function(e) {
            ...
            _create: function() {
                var e = this.element,
                    t = this.options;
                t.distance < 1 && (t.distance = 1), u.isValue(e.val()) && (t.value = e.val()), u.isValue(t.value) && (u.isValue(t.inputFormat) ? this.value = ("" + t.value)
                    .toDate(t.inputFormat) : u.isDate(t.value) && (this.value = new Date(t.value))), void 0 === r.locales[t.locale] && (t.locale = METRO_LOCALE), this.locale = r.locales[t.locale].calendar, null === t.minYear && (t.minYear = (new Date)
                    .getFullYear() - 100), null === t.maxYear && (t.maxYear = (new Date)
                    .getFullYear() + 100), this._createStructure(), this._createEvents(), this._set(), this._fireEvent("datepicker-create", {
                    element: e
                })
            },
            _createStructure: function() {
                var e, t, n, i, s, a, o = this.element,
                    ...
                    c = d("<div>")
                    .attr("id", l)
                    .addClass("wheel-picker date-picker " + o[0].className)
                    .addClass(r.clsPicker);
                if (c.insertBefore(o), o.appendTo(c), r.label && (a = d("<label>")
                        .addClass("label-for-input")
                        .addClass(r.clsLabel)
                        .html(r.label)
                        .insertBefore(c), o.attr("id") && a.attr("for", o.attr("id")), "rtl" === o.attr("dir") && a.addClass("rtl")), l = d("<div>")
                    .addClass("date-wrapper")
                    .appendTo(c), !0 === r.month && (e = d("<div>")
                        .addClass("month")
                        .addClass(r.clsPart)
                        .addClass(r.clsMonth)
                        .appendTo(l)), !0 === r.day && (t = d("<div>")
                        .addClass("day")
                        .addClass(r.clsPart)
                        .addClass(r.clsDay)
                        .appendTo(l)), !0 === r.year && (n = d("<div>")
                        .addClass("year")
                        .addClass(r.clsPart)
                        .addClass(r.clsYear)
                        .appendTo(l)), a = d("<div>")
                    ...
                    .appendTo(a), !0 === r.month) {
                    for (e = d("<ul>")
                        .addClass("sel-month")
                        .appendTo(l), i = 0; i < r.distance; i++) d("<li>")
                        .html("&nbsp;")
                        .data("value", -1)
                        .appendTo(e);
                    for (i = 0; i < 12; i++) d("</li><li>")
                        .addClass("js-month-" + i + " js-month-real-" + this.locale.months[i].toLowerCase())
                        .html(this.locale.months[i])
                        .data("value", i)
                        .appendTo(e);
                    for (i = 0; i < r.distance; i++) d("</li><li>")
                        .html("&nbsp;")
                        .data("value", -1)
                        .appendTo(e)
                }
                ...
                if (!0 === r.year) {
                    for (n = d("<ul>")
                        ...
                        .data("value", -1)
                        .appendTo(n);
                    for (i = r.minYear, s = 0; i <= r.maxyear; i++, s++) d("<li>")
                        .addClass("js-year-" + s + " js-year-real-" + i)
                        .html(i)
                        .data("value", i)
                        .appendTo(n);
                    for (i = 0; i < r.distance; i++) d("<li>")
                        .html("&nbsp;")
                        .data("value", -1)
                        .appendTo(n)
                }
                if (l.height(40 * (2 * r.distance + 1)), a = d("<div>")
                    .addClass("action-block")
                    .appendTo(a), d("<button>")
                    .attr("type", "button")
                    .addClass("button action-ok")
                    .addClass(r.clsButton)
                    .addClass(r.clsOkButton)
                    .html(r.okButtonIcon)
                    .appendTo(a), d("</button><button>")
                    .attr("type", "button")
                    .addClass("button action-cancel")
                    .addClass(r.clsButton)
                    .addClass(r.clsCancelButton)
                    .html(r.cancelButtonIcon)
                    .appendTo(a), !(o[0].className = "") === r.copyInlineStyles)
            ...
            _createEvents: function() {
                ...
                o.on(r.events.start, ".select-block ul", function(e) {
                    var t, n;
                    e.changedTouches || (t = this, n = u.pageXY(e)
                        .y, d(document)
                        .on(r.events.move, function(e) {
                            t.scrollTop -= a.scrollSpeed * (n > u.pageXY(e)
                                    .y ? -1 : 1), n = u.pageXY(e)
                                .y
                        }, {
                            ns: o.attr("id")
                        }), d(document)
                        .on(r.events.stop, function() {
                            d(document)
                                .off(r.events.move, {
                                    ns: o.attr("id")
                                }), d(document)
                ...
                d.each(["month", "day", "year"], function() {
                    ...
                    i.on("scroll", function() {
                        s.isOpen && (s.listTimer[n] && (clearTimeout(s.listTimer[n]), s.listTimer[n] = null), s.listTimer[n] || (s.listTimer[n] = setTimeout(function() {
                            var e, t;
                            s.listTimer[n] = null, t = Math.round(Math.ceil(i.scrollTop()) / 40), t = (e = i.find(".js-" + n + "-" + t))
                                .position()
                                .top - 40 * a.distance, i.find(".active")
                                .removeClass("active"), i[0].scrollTop = t, e.addClass("active"), u.exec(a.onScroll, [e, i, o], i[0])
                        }, 150)))
                    })
                })
            },
            ...
            _set: function() {
                ...
                !0 === t.month && n.find(".month")
                    .html(i), !0 === t.day && n.find(".day")
                    .html(s), !0 === t.year && n.find(".year")
                    .html(a), e.val(this.value.format(t.format, t.locale))
                    .trigger("change"), this._fireEvent("set", {
                        value: this.value,
                        elementValue: e.val(),
                        picker: n
                    })
            ...
            open: function() {
                var e, t, n = this.options,
                    i = this.picker,
                    s = this.value.getMonth(),
                    a = this.value.getDate() - 1,
                    o = this.value.getFullYear(),
                    r = i.find(".select-wrapper");
                r.parent()
                    .removeClass("for-top for-bottom"), r.show(0), i.find("li")
                    .removeClass("active"), e = u.inViewport(r[0]), t = u.rect(r[0]), !e && 0 < t.top && r.parent()
                    .addClass("for-bottom"), !e && t.top < 0 && r.parent()
                    .addClass("for-top"), !0 === n.month && (r = i.find(".sel-month"))
                    .scrollTop(0)
                    .animate({
                        draw: {
                            scrollTop: r.find("li.js-month-" + s)
                                .addClass("active")
                                .position()
                                .top - 40 * n.distance
                        },
                        dur: 100
                    }), !0 === n.day && (s = i.find(".sel-day"))
                    .scrollTop(0)
                    .animate({
                        draw: {
                            scrollTop: s.find("li.js-day-" + a)
                                .addClass("active")
                                .position()
                                .top - 40 * n.distance
                        },
                        dur: 100
                    }), !0 === n.year && (a = i.find(".sel-year"))
                    .scrollTop(0)
                    .animate({
                        draw: {
                            scrollTop: a.find("li.js-year-real-" + o)
                                .addClass("active")
                                .position()
                                .top - 40 * n.distance
                        },
            ...
            close: function() {
                var e = this.picker;
                e.find(".select-wrapper")
                    .hide(0), this.isOpen = !1, this._fireEvent("close", {
                        value: this.value,
                        picker: e
                    })
            },
            val: function(e) {
                ...
                u.isValue(t.inputFormat) ? this.value = ("" + e)
                    .toDate(t.inputFormat) : this.value = new Date(e), this._set()
            },
            date: function(e) {
            ...
            i18n: function(e) {
                ...
                if (s.locale = e || i.attr("data-locale"), this.locale = r.locales[s.locale].calendar, !0 === s.month) {
                    for (t = i.closest(".date-picker")
                        .find(".sel-month")
                        .html(""), n = 0; n < s.distance; n++) d("<li>")
                        .html("&nbsp;")
                        .data("value", -1)
                        .appendTo(t);
                    for (n = 0; n < 12; n++) d("</li><li>")
                        .addClass("js-month-" + n + " js-month-real-" + this.locale.months[n].toLowerCase())
                        .html(this.locale.months[n])
                        .data("value", n)
                        .appendTo(t);
                    for (n = 0; n < s.distance; n++) d("</li><li>")
                        .html("&nbsp;")
                        .data("value", -1)
                        .appendTo(t)
                }
        ...
        .on(r.events.click, function() {
            d.each(d(".date-picker"), function() {
                d(this)
                    .find("input")
                    .each(function() {
                        r.getPlugin(this, "datepicker")
                            .close()
                    })
            })
        })
    ...
    r.dialogSetup = function(e) {
        ...
        _build: function() {
            var t, n, e = this,
                ...
                s = this.options,
                a = l("body");
            i.addClass("dialog"), !0 === s.shadow && i.addClass("shadow-on"), "" !== s.title && this.setTitle(s.title), "" !== s.content && this.setContent(s.content), (!0 === s.defaultAction || !1 !== s.actions && "object" == typeof s.actions && 0 < c.objectLength(s.actions)) && (0 === (t = i.find(".dialog-actions"))
                .length && (t = l("<div>")
                    .addClass("dialog-actions")
                    .addClass("text-" + s.actionsAlign)
                    .appendTo(i)), !0 === s.defaultAction && 0 === c.objectLength(s.actions) && 0 === i.find(".dialog-actions > *")
                .length && (n = l("<button>")
                    .addClass("button js-dialog-close")
                    .addClass(s.clsDefaultAction)
                    .html(this.locale.buttons.ok))
                .appendTo(t), c.isObject(s.actions) && l.each(c.isObject(s.actions), function() {
                    var e = this;
                    n = l("</button><button>")
                        .addClass("button")
                        .addClass(e.cls)
                        .html(e.caption), void 0 !== e.onclick && n.on(r.events.click, function() {
                            c.exec(e.onclick, [i])
                        }), n.appendTo(t)
            ...
            var o = i.find("closer");
            0 === o.length && (o = l("<span>")
                    .addClass("button square closer js-dialog-close"))
                .appendTo(i), !0 !== s.closeButton && o.hide(), i.css({
                    width: s.width,
                    height: s.height,
                    visibility: "hidden",
                    top: "100%",
                ...
                }), i.addClass(s.clsDialog), i.find(".dialog-title")
                .addClass(s.clsTitle), i.find(".dialog-content")
                .addClass(s.clsContent), i.find(".dialog-actions")
                .addClass(s.clsAction), i.appendTo(a), s.show && this.open(), l(window)
                .on(r.events.resize, function() {
                    e.setPosition()
                }, {
                    ns: this.id
        ...
        setPosition: function() {
            var e, t, n = this.element,
                i = this.options;
            !0 !== i.toTop && !0 !== i.toBottom ? ((e = (l(window)
                .height() - n.outerHeight()) / 2) < 0 && (e = 0), t = "auto") : (!0 === i.toTop && (e = 0, t = "auto"), !0 !== i.toTop && !0 === i.toBottom && (t = 0, e = "auto")), n.css({
                top: e,
                bottom: t,
                left: (l(window)
                    .width() - n.outerWidth()) / 2
            })
        },
        setContent: function(e) {
            ...
            0 === n.length && (n = l("<div>")
                ...
                .appendTo(t), !c.isQ(e) && c.isFunc(e) && (e = c.exec(e)), c.isQ(e) ? e.appendTo(n) : n.html(e)
        },
        setTitle: function(e) {
            var t = this.element,
        ...
        close: function() {
            var e = this,
                t = this.element,
                n = this.options;
            c.bool(n.leaveOverlayOnClose) || l("body")
                .find(".overlay")
                .remove(), this.hide(function() {
        ...
        open: function() {
            var e = this,
                t = this.element,
                n = this.options;
            !0 === n.overlay && 0 === l(".overlay")
                .length && (this.overlay.appendTo(l("body")), !0 === n.overlayClickClose && this.overlay.on(r.events.click, function() {
                    e.close()
                })), this.show(function() {
        ...
        destroy: function() {
            var e = this.element;
            return e.off(r.events.click, ".js-dialog-close"), e.find(".button")
                .off(r.events.click), l(window)
                .off(r.events.resize, {
                    ns: this.id
                }), e
        }
    ...
    e.donutSetup = function(e) {
        ...
        _create: function() {
            var e = this.element,
                ...
                s = t.radius * (1 - t.hole),
                a = "rotate(-90 " + t.radius + "," + t.radius + ")",
                o = i * t.hole * .6;
            e.addClass("donut"), e.css({
                width: t.size,
                height: t.size,
                background: t.background
            }), n += "<svg>", n += "   <circle class="donut-back" r="" +="" i="" "px"="" cx="" t.radius="" cy="" transform="" a="" ""="" fill="none" stroke="" t.stroke="" stroke-width="" s=""/>", n += "   <circle class="donut-fill" r="" +="" i="" "px"="" cx="" t.radius="" cy="" transform="" a="" ""="" fill="none" stroke="" t.fill="" stroke-width="" s=""/>", !0 === t.showText && (n += "   <text 3="" class="donut-title" x="" +="" t.radius="" "px"="" y="" dy="" o="" text-anchor="middle" fill="" (""="" !="=" t.color="" ?="" :="" t.fill)="" ""="" font-size="">0" + t.cap + "</text>"), n += "</svg>", e.html(n), this.val(t.value), this._fireEvent("donut-create", {
                element: e
            })
        },
        _setValue: function(e) {
            var t = this.element,
                ...
                t = n.radius * (1 - (1 - n.hole) / 2),
                a = Math.round(2 * Math.PI * t),
                t = n.showValue ? e : c.percent(n.total, e, !0),
    ...
    u.doubleSliderSetup = function(e) {
        ...
        _createSlider: function() {
            var e, t = this.element,
                ...
                r = h("<button>")
                .attr("type", "button")
                .addClass("marker marker-min")
                .addClass(n.clsMarker)
                .addClass(n.clsMarkerMin),
                l = h("</button><button>")
                .attr("type", "button")
                .addClass("marker marker-max")
                .addClass(n.clsMarker)
                .addClass(n.clsMarkerMax),
                c = h("<div>")
                .addClass("hint hint-min")
                .addClass(n.hintPositionMin + "-side")
                .addClass(n.clsHint)
                .addClass(n.clsHintMin),
                d = h("<div>")
                .addClass("hint hint-max")
                .addClass(n.hintPositionMax + "-side")
                .addClass(n.clsHint)
                .addClass(n.clsHintMax);
            if (0 < n.size && s.outerWidth(n.size), s.insertBefore(t), t.appendTo(s), i.insertBefore(s), s.appendTo(i), a.appendTo(s), o.appendTo(s), r.appendTo(s), l.appendTo(s), c.appendTo(r), d.appendTo(l), !0 === n.hintAlways && h([c, d])
                ...
                .addClass("permanent-hint"), !0 === n.showMinMax && (d = h("<div>")
                    .addClass("slider-min-max")
                    .addClass(n.clsMinMax), h("<span>")
                    .addClass("slider-text-min")
                    .addClass(n.clsMin)
                    .html(n.min)
                    .appendTo(d), h("<span>")
                    .addClass("slider-text-max")
                    .addClass(n.clsMax)
                    .html(n.max)
                    .appendTo(d), n.minMaxPosition === u.position.TOP ? d.insertBefore(s) : d.insertAfter(s)), !(t[0].className = "") === n.copyInlineStyles)
        ...
        _createEvents: function() {
            ...
            e.on(u.events.startAll, function() {
                    var e = h(this)
                        .find(".hint");
                    !0 === n.hint && !0 !== n.hintAlways && e.fadeIn(300), h(document)
                        .on(u.events.moveAll, function(e) {
        ...
        _correct: function(e) {
            var t, n = e,
                ...
                s = this.options.min,
                a = this.options.max;
            return 0 === i || isNaN(i) ? n : ((n = Math.round(e / i) * i) < s && (n = s), a < n && (n = a), n.toFixed((t = i) % 1 == 0 ? 0 : t.toString()
                .split(".")[1].length))
        },
        _move: function(e) {
            var t, n = h(e.target)
        ...
        _value: function() {
            var t, e = this.element,
                ...
                i = +this.valueMin || 0,
                s = +this.valueMax || 0;
            n.roundValue && (i = i.toFixed(l.decCount(n.accuracy)), s = s.toFixed(l.decCount(n.accuracy))), t = [i, s].join(", "), "INPUT" === e[0].tagName && e.val(t), null === n.target || 0 !== (n = h(n.target))
                .length && h.each(n, function() {
                    var e = h(this);
        ...
        disable: function() {
            var e = this.element;
            e.data("disabled", !0), e.parent()
                .addClass("disabled")
        },
        enable: function() {
            var e = this.element;
            e.data("disabled", !1), e.parent()
                .removeClass("disabled")
        },
        toggleState: function() {
            this.elem.disabled ? this.disable() : this.enable()
        ...
        destroy: function() {
            var e = this.element,
                t = this.slider,
                n = t.find(".marker");
            return n.off(u.events.startAll), n.off(u.events.focus), n.off(u.events.blur), n.off(u.events.keydown), n.off(u.events.keyup), t.off(u.events.click), h(window)
                .off(u.events.resize, {
                    ns: this.id
                }), e
        }
...
function(u, h) {
    ...
    u.dragItemsSetup = function(e) {
        ...
        _createStructure: function() {
            var e = this.element,
                t = this.options;
            e.addClass("drag-items-target"), !0 === t.drawDragMarker && e.find(t.dragItem)
                .each(function() {
                    h("<span>")
                        .addClass("drag-item-marker")
                        .appendTo(this)
        ...
        _createEvents: function() {
            ...
            e.on(u.events.startAll, l.drawDragMarker ? l.dragMarker : l.dragItem, function(e) {
                var t, n = h(e.target)
                    .closest(l.dragItem);
                p.isRightMouse(e) || !0 === r.canDrag && (n.addClass("dragged-item")
                    .addClass(l.clsDragItem), t = h("<div>")
                    .addClass("dragged-item-avatar")
                    .addClass(l.clsDragItemAvatar), i = n.offset(), s = n.width(), a = n.height(), d.top = p.pageXY(e)
                    .y - i.top, d.left = p.pageXY(e)
                    .x - i.left, t.css({
                        top: i.top,
                        left: i.left,
                        width: s,
                    ...
                    .appendTo(c), r._fireEvent("drag-start-item", {
                        ...
                        ! function(e, t, n) {
                            ...
                            e = document.elementsFromPoint(i, s)
                                .filter(function(e) {
                                    return h(e)
                                        .hasClass("drag-items-target")
                                });
                            0 !== e.length && (r._fireEvent("target", {
                                    target: e
                                }), t = document.elementsFromPoint(i, s)
                                .filter(function(e) {
                                    var t = h(e);
                                    return h.matches(e, l.dragItem) && !t.hasClass("dragged-item-avatar")
                                })[0], p.isValue(t) ? (s = s - (o = (a = h(t))
                                        .offset())
                                    .top, t = i - o.left, i = a.width(), o = a.height(), s = t < i / 3 && (s < o / 2 || o / 2 < s) ? "left" : 2 * i / 3 < t && (s < o / 2 || o / 2 < s) ? "right" : i / 3 < t && t < 2 * i / 3 && o / 2 < s ? "bottom" : "top", a.hasClass("dragged-item") || ("top" === s || "left" === s ? n.insertBefore(a) : n.insertAfter(a))) : n.appendTo(e))
                        ...
                        r._fireEvent("drag-drop-item", {
                                dragItem: n[0],
                                avatar: t[0]
                            }), n.removeClass("dragged-item")
                            .removeClass(l.clsDragItem), t.remove(), o.off(u.events.moveAll, {
                                ns: r.id
        ...
        on: function() {
            this.canDrag = !0, this.element.find(".drag-item-marker")
                .show()
        },
        off: function() {
            this.canDrag = !1, this.element.find(".drag-item-marker")
                .hide()
        },
        toggle: function() {
        ...
        _createEvents: function() {
            ...
            this.dragElement.on(c.events.startAll, function(e) {
                ...
                !1 !== o.data("canDrag") && !0 === u.exec(r.onCanDrag, [o]) && (!1 === c.isTouchable && 1 !== e.which || (a.drag = !0, a.backup.cursor = o.css("cursor"), a.backup.zIndex = o.css("z-index"), o.addClass("draggable"), t(e), a._fireEvent("drag-start", {
                    ...
                    .on(c.events.moveAll, function(e) {
                    ...
                    .on(c.events.stopAll, function() {
                        o.css({
                                cursor: a.backup.cursor,
                                zIndex: a.backup.zIndex
                            })
                            .removeClass("draggable"), a.drag && (d(document)
                                .off(c.events.moveAll, {
                                    ns: a.id
                                }), d(document)
                                .off(c.events.stopAll, {
                                    ns: a.id
...
function(o, r) {
    ...
    o.dropdownSetup = function(e) {
            ...
            _createStructure: function() {
                var e = this.element,
                    t = this.options;
                t.dropUp && e.addClass("drop-up"), t = null !== t.toggleElement ? r(t.toggleElement) : 0 < e.siblings(".dropdown-toggle")
                    .length ? e.siblings(".dropdown-toggle") : e.prev(), this.displayOrigin = l.getStyleOne(e, "display"), e.hasClass("v-menu") && e.addClass("for-dropdown"), e.css("display", "none"), this._toggle = t
            },
            _createEvents: function() {
                var n = this,
                    i = this.element,
                ...
                e.on(o.events.click, function(e) {
                        var t;
                        a.siblings(a[0].tagName)
                            .removeClass("active-container"), r(".active-container")
                            .removeClass("active-container"), "none" === i.css("display") || i.hasClass("keep-open") ? (r("[data-role=dropdown]")
                                .each(function(e, t) {
                                    i.parents("[data-role=dropdown]")
                                        .is(t) || r(t)
                                        .hasClass("keep-open") || "none" === r(t)
                                        .css("display") || (!l.isValue(s.dropFilter) || 0 < r(t)
                                            .closest(s.dropFilter)
                                            .length) && n._close(t)
                    ...
                    }), !0 === s.noClose && i.addClass("keep-open")
                    .on(o.events.click, function(e) {
                        e.stopPropagation()
                    }), r(i)
                    .find("li.disabled a")
                    .on(o.events.click, function(e) {
            ...
            _close: function(e, t) {
                ...
                var n = o.getPlugin(e, "dropdown"),
                    ...
                    s = n.options,
                    a = "slideUp";
                i.removeClass("active-toggle")
                    .removeClass("active-control"), n.element.parent()
                    .removeClass("active-container"), t && (a = "hide"), e[a](t ? 0 : s.duration, function() {
            ...
            _open: function(e, t) {
                ...
                var n = o.getPlugin(e, "dropdown"),
                    i = n._toggle,
                    s = n.options;
                i.addClass("active-toggle")
                    .addClass("active-control"), e.slideDown(t ? 0 : s.duration, function() {
        ...
        .on(o.events.click, function() {
            r("[data-role*=dropdown]")
                .each(function() {
                    var e = r(this);
                    "none" === e.css("display") || e.hasClass("keep-open") || e.hasClass("stay-open") || e.hasClass("ignore-document-click") || o.getPlugin(e, "dropdown")
                        .close()
                })
        })
}(Metro, m4q),
    ...
    r.fileSetup = function(e) {
        ...
        _createStructure: function() {
            var e, t, n = this.element,
                i = this.options,
                s = c("<label>")
                .addClass(("input" === i.mode ? " file " : "button" === i.mode ? " file-button " : " drop-zone ") + n[0].className)
                ...
                .addClass("files")
                .addClass(i.clsCaption);
            if (s.insertBefore(n), n.appendTo(s), "drop" === i.mode || "dropzone" === i.mode ? (e = c(i.dropIcon)
                .addClass("icon")
                .appendTo(s), a.html(i.dropTitle)
                .insertAfter(e), o.html("0 " + i.filesTitle)
                .insertAfter(a)) : "button" === i.mode ? ((t = c("<span>")
                    .addClass("button")
                    .attr("tabindex", -1)
                    .html(i.buttonTitle))
                .appendTo(s), t.addClass(i.clsButton)) : (a.insertBefore(n), (t = c("<span>")
                    .addClass("button")
                    .attr("tabindex", -1)
                    .html(i.buttonTitle))
                .appendTo(s), t.addClass(i.clsButton), "rtl" === n.attr("dir") && s.addClass("rtl"), "" !== i.prepend && c("<div>")
                .html(i.prepend)
                .addClass("prepend")
                .addClass(i.clsPrepend)
                .appendTo(s)), !(n[0].className = "") === i.copyInlineStyles)
                for (var r = 0, l = n[0].style.length; r < l; r++) s.css(n[0].style[r], n.css(n[0].style[r]));
            i.label && (i = c("<label>")
                .addClass("label-for-input")
                .addClass(i.clsLabel)
                .html(i.label)
                .insertBefore(s), n.attr("id") && i.attr("for", n.attr("id")), "rtl" === n.attr("dir") && i.addClass("rtl")), n.is(":disabled") ? this.disable() : this.enable()
        },
        _createEvents: function() {
            var n = this,
                i = this.element,
        ...
        clear: function() {
            var e = this.element,
                t = this.options;
            "input" === t.mode ? e.siblings(".caption")
                .html("") : (e.siblings(".caption")
                    .html(t.dropTitle), e.siblings(".files")
                    .html("0 " + t.filesTitle)), e.val("")
        },
        disable: function() {
            this.element.data("disabled", !0), this.element.parent()
                .addClass("disabled")
        ...
        toggleDir: function() {
            "rtl" === this.element.attr("dir") ? this.element.parent()
                .addClass("rtl") : this.element.parent()
                .removeClass("rtl")
        },
        changeAttribute: function(e) {
            switch (e) {
...
function(e, t) {
    ...
    e.gradientBoxSetup = function(e) {
        ...
        _setGradient: function() {
            var e = this.element,
                t = [];
            "radial" === this.type && this.shape && t.push(this.shape), "radial" === this.type && this.size && t.push(this.size), this.position && t.push(this.position), t = this.func + "(" + (t.length ? t.join(" ") + ", " : "") + this.colors.join(", ") + ")", e.css({
                background: t
            })
        },
        changeAttribute: function(e, t) {
...
function(i, a) {
    ...
    i.gravatarSetup = function(e) {
        ...
        getImageSrc: function(e, t, n) {
            return void 0 === e || "" === e.trim() ? "" : (t = t || 80, n = i.utils.encodeURI(n) || "404", "//www.gravatar.com/avatar/" + i.md5(e.toLowerCase()
                .trim()) + "?size=" + t + "&d=" + n)
        },
        get: function() {
            var e = this.element,
    ...
    s.hintSetup = function(e) {
        ...
        _createEvents: function() {
            ...
            t.on(s.events.enter, function() {
                ...
                .on(s.events.scroll + " " + s.events.resize, function() {
        ...
        createHint: function() {
            var e = this.elem,
                ...
                .addClass(n.clsHint)
                .html(n.hintText);
            this.hint = n, this.hint_size = i.hiddenElementSize(n), a(".hint:not(.permanent-hint)")
                .remove(), "TD" !== e.tagName && "TH" !== e.tagName || (e = a("<div>")
                    .css("display", "inline-block")
                    .html(t.html()), t.html(e), this.element = e), this.setPosition(), n.appendTo(a("body")), this._fireEvent("hint-show", {
                    hint: n[0]
                })
        },
        setPosition: function() {
            ...
            n.hintPosition === s.position.BOTTOM ? (e.addClass("bottom"), e.css({
                top: i.offset()
                    .top - a(window)
                    .scrollTop() + i.outerHeight() + n.hintOffset,
                left: i.offset()
                    .left + i.outerWidth() / 2 - t.width / 2 - a(window)
                    .scrollLeft()
            })) : n.hintPosition === s.position.RIGHT ? (e.addClass("right"), e.css({
                top: i.offset()
                    .top + i.outerHeight() / 2 - t.height / 2 - a(window)
                    .scrollTop(),
                left: i.offset()
                    .left + i.outerWidth() - a(window)
                    .scrollLeft() + n.hintOffset
            })) : n.hintPosition === s.position.LEFT ? (e.addClass("left"), e.css({
                top: i.offset()
                    .top + i.outerHeight() / 2 - t.height / 2 - a(window)
                    .scrollTop(),
                left: i.offset()
                    .left - t.width - a(window)
                    .scrollLeft() - n.hintOffset
            })) : (e.addClass("top"), e.css({
                top: i.offset()
                    .top - a(window)
                    .scrollTop() - t.height - n.hintOffset,
                left: i.offset()
                    .left - a(window)
                    .scrollLeft() + i.outerWidth() / 2 - t.width / 2
            }))
        },
        removeHint: function() {
            var e = this,
        ...
        destroy: function() {
            var e = this.element;
            this.removeHint(), e.off(s.events.enter + "-hint"), e.off(s.events.leave + "-hint"), a(window)
                .off(s.events.scroll + "-hint")
        }
    })
}(Metro, m4q),
function(i, o) {
    ...
    var r = i.utils,
        l = {
            ...
            getKey: function(e) {
                ...
                return l.getModifier(e)
                    .length ? l.getModifier(e)
                    .join("+") + "+" + t : t
            },
    ...
    function e(s, a) {
        return this.each(function() {
            o(this)
                .on(i.events.keyup + ".hotkey-method-" + s, function(e) {
                    var t = l.getKey(e),
                        n = o(this),
                        i = "" + n.attr("href");
    ...
    o.fn.hotkey = e, window.METRO_JQUERY && window.jquery_present && (jQuery.fn.hotkey = e), o(document)
        .on(i.events.keyup + ".hotkey-data", function(e) {
            var t, n;
            METRO_HOTKEYS_FILTER_INPUT_ACCEPTING_ELEMENTS && /textarea|input|select/i.test(e.target.nodeName) || METRO_HOTKEYS_FILTER_CONTENT_EDITABLE && o(e.target)
                .attr("contenteditable") || METRO_HOTKEYS_FILTER_TEXT_INPUTS && -1 < l.textAcceptingInputTypes.indexOf(e.target.type) || (n = l.getKey(e), r.keyInObject(i.hotkeys, n) && (t = o(i.hotkeys[n][0]), e = i.hotkeys[n][1], n = ("" + t.attr("href"))
                    .trim(), e ? r.exec(e) : t.is("a") && n && 0 < n.length && "#" !== n.trim() ? window.location.href = n : t.click()))
        })
}(Metro, m4q),
function(e, a) {
    "use strict";
    ...
    e.htmlContainerSetup = function(e) {
        ...
        _load: function() {
            var n = this,
                i = this.element,
                s = this.options;
            a[s.method](this.htmlSource, this.data, this.opt)
                .then(function(e) {
                    var t = a(e);
                    switch (0 === t.length && (t = a("<div>")
                        .html(e)), s.insertMode.toLowerCase()) {
                        case "prepend":
                            i.prepend(t);
                            break;
                        case "append":
    ...
    e.imageBoxSetup = function(e) {
        ...
        _drawImage: function() {
            ...
            t.attr("data-original") || t.attr("data-original", n.image), t.css({
                ...
                e = this.height >= this.width, t.removeClass("image-box__portrait image-box__landscape")
                    .addClass("image-box__" + (e ? "portrait" : "landscape"))
            }
        },
        changeAttribute: function(e, t) {
    ...
    t.imageCompareSetup = function(e) {
        ...
        _createStructure: function() {
            var n, i, e, s, a, t = this.element,
                o = this.options;
            switch (l.isValue(t.attr("id")) || t.attr("id", l.elementId("image-compare")), t.addClass("image-compare")
                .css({
                    width: o.width
                }), s = t.width(), o.height) {
                case "16/9":
        ...
        _createEvents: function() {
            ...
            o.on(t.events.startAll, function() {
                    var n = s.width();
                    r(document)
                        .on(t.events.moveAll, function(e) {
                        ...
                        .on(t.events.stopAll, function() {
                            r(document)
                                .off(t.events.moveAll, {
                                    ns: i.id
                                }), r(document)
                                .off(t.events.stopAll, {
                                    ns: i.id
                                })
                        }, {
                            ns: i.id
                ...
                .on(t.events.resize, function() {
                    ...
                    if ("100%" === n.width) {
                        ...
                        s.css({
                            ...
                            }), s.find(".image-container-overlay")
                            .css({
                                width: t / 2
                            }), o.css({
                                top: e / 2 - o.height() / 2,
        ...
        destroy: function() {
            var e = this.element;
            return e.off(t.events.start), r(window)
                .off(t.events.resize, {
                    ns: this.id
                }), e
        }
...
function(t, r) {
    ...
    t.imageGridSetup = function(e) {
        ...
        _createStructure: function() {
            var e = this.element,
                t = this.options;
            e.addClass("image-grid")
                .addClass(t.clsImageGrid), this._createItems()
        },
        _createEvents: function() {
            var e = this;
        ...
        _createItems: function() {
            ...
            a.clear(), e.each(function() {
                var t = r(this),
                    n = this.src,
                    i = r("<div>")
                    .addClass("image-grid__item")
                    .addClass(o.clsImageGridItem)
                    .appendTo(a),
                    e = new Image;
                e.src = n, e.onload = function() {
                    var e = this.height >= this.width;
                    i.addClass(e ? "image-grid__item-portrait" : "image-grid__item-landscape"), t.addClass(o.clsImageGridImage)
                        .appendTo(i), o.useBackground && (i.css({
                                background: "url(" + n + ")",
                                backgroundRepeat: "no-repeat",
                                backgroundSize: o.backgroundSize,
                                backgroundPosition: o.backgroundPosition
                            })
                            .attr("data-original", t.attr("data-original") || n)
                            .attr("data-title", t.attr("alt") || t.attr("data-title") || ""), t.visible(!1)), s._fireEvent("draw-item", {
                            item: i[0],
                            image: t[0]
                        })
                }
...
function(t, h) {
    ...
    t.imageMagnifierSetup = function(e) {
        ...
        _createStructure: function() {
            ...
            switch (p.isValue(n.attr("id")) || n.attr("id", p.elementId("image-magnifier")), n.addClass("image-magnifier")
                .css({
                    width: i.width
                })
            ...
            "glass" === i.magnifierMode ? (r = h("<div>")
                ...
                .addClass(i.clsLens) : ((r = h("<div>")
                    ...
                    .addClass(i.clsLens), p.isValue(i.magnifierZoomElement) && 0 !== h(i.magnifierZoomElement)
                    .length ? this.zoomElement = h(i.magnifierZoomElement) : this.zoomElement = h("<div>")
                    .insertAfter(n), a = r[0].offsetWidth * i.magnifierZoom, o = r[0].offsetHeight * i.magnifierZoom, n = a / i.lensSize, r = o / i.lensSize, this.zoomElement.css({
                        width: a,
                        height: o,
                        backgroundImage: "url(" + s[0].src + ")",
                        backgroundRepeat: "no-repeat",
...
function(o, i) {
    ...
    o.infoBoxSetup = function(e) {
        ...
        _createStructure: function() {
            var e, t = this.element,
                n = this.options;
            !0 === n.overlay && (this.overlay = this._overlay()), t.addClass("info-box")
                .addClass(n.type)
                .addClass(n.clsBox), 0 === (e = t.find("closer"))
                .length && (e = i("<span>")
                    .addClass("button square closer"))
                .appendTo(t), !0 !== n.closeButton && e.hide(), 0 < (e = t.find(".info-box-content"))
                .length && e.addClass(n.clsBoxContent), t.css({
                    width: n.width,
                    height: n.height,
                    visibility: "hidden",
                    top: "100%",
        ...
        setType: function(e) {
            this.element.removeClass("success info alert warning")
                .addClass(e)
        },
        open: function() {
            var e = this,
                t = this.element,
                n = this.options;
            !0 === n.overlay && this.overlay.appendTo(i("body")), this._setPosition(), t.css({
                visibility: "visible"
        ...
        isOpen: function(e) {
            return !!this.isInfoBox(e) && o.getPlugin(e, "infobox")
                .isOpen()
        },
        create: function(e, t, n, i) {
            ...
            return n._runtime = !0, t.infobox(n), (n = o.getPlugin(t, "infobox"))
                .setContent(e), !1 !== i && n.open(), t
        }
    }
}(Metro, m4q),
function(u, a) {
    ...
    u.inputMaskSetup = function(e) {
        ...
        _createEvents: function() {
            ...
            function o(e) {
                for (var t = r.maskArray, n = e; n <= t.length; n++) if (t[n]="==" r.placeholder) return n; e } function t() { clearinterval(r.thresholdtimer), r.thresholdtimer="null" var r="this," l="this.options," c="l.maskEditableStart," n="this.id," d="function(e)" r.elem.setselectionrange(e, e) }; e.on("change", function() ""="==" this.value && (this.value="r.mask," d(c)) }, ns: }), e.on("focus click", this.selectionstart < d(c), d(o(this.selectionstart)) e.on("keydown", function(e) t="this.selectionStart," i="e.code," s="e.key;" ("arrowright"="==" || "end"="==" i) !0;>= r.length && -1 === ["Backspace", "Home", "ArrowLeft", "ArrowUp"].indexOf(i) ? e.preventDefault() : "Home" === i || "ArrowUp" === i ? (e.preventDefault(), d(c)) : "ArrowLeft" === i ? t - 1 < c && e.preventDefault() : "Backspace" === i ? (e.preventDefault(), c <= 1 t - && (a(t 1) this.value.charat(t !="=" r.placeholder (this.value="n.substr(0," + n.substr(t)), d(t 1))) : "space"="==" i ? (e.preventdefault(), 1)) r.pattern.test(s) a(t) t) (l.onchar="==" u.noop s h.exec(l.onchar, [s], this)) n.substr(t 1), d(o(t 1)))) e.preventdefault() }, { ns: n }), e.on("keyup", function() var e="this;" t(), r.thresholdtimer="setInterval(function()" d(o(e.selectionstart)) l.thresholdinterval) }) _showvalue: n, array(this.length); e.value (n="e.value," a.each(this.maskarray, function(e, n[e]="==" || i.pattern.test(n[e]) s[e]="n[e]" this.elem.value="s.join(" "))" destroy: return e.off("change", e.off("focus", e.off("click", e.off("keydown", e.off("keyup", } }(metro, m4q), i) "use strict"; materialinputdeferred: 0, label: "", informer: icon: permanentlabel: !1, clscomponent: clsinput: clslabel: clsinformer: clsicon: clsline: oninputcreate: e.noop }; e.materialinputsetup="function(e)" e) window.metromaterialinputsetup, e.materialinputsetup(window.metromaterialinputsetup), e.component("material-input", init: this._super(t, e, history: [], historyindex: -1 this _create: this._createstructure(), this._createevents(), this._fireevent("input-create", element: _createstructure:>")
                .addClass("input-material " + e[0].className);
            e[0].className = "", e.attr("autocomplete", "nope"), void 0 === e.attr("type") && e.attr("type", "text"), n.insertBefore(e), e.appendTo(n), s.isValue(t.label) && i("<span>")
                .html(t.label)
                .addClass("label")
                .addClass(t.clsLabel)
                .insertAfter(e), s.isValue(t.informer) && i("<span>")
                .html(t.informer)
                .addClass("informer")
                .addClass(t.clsInformer)
                .insertAfter(e), s.isValue(t.icon) && (n.addClass("with-icon"), i("<span>")
                    .html(t.icon)
                    .addClass("icon")
                    .addClass(t.clsIcon)
                    .insertAfter(e)), n.append(i("<hr>")
                    .addClass(t.clsLine)), !0 === t.permanentLabel && n.addClass("permanent-label"), n.addClass(t.clsComponent), e.addClass(t.clsInput), e.is(":disabled") ? this.disable() : this.enable()
        },
        _createEvents: function() {},
        clear: function() {
            this.element.val("")
    ...
    o.inputSetup = function(e) {
            ...
            _createStructure: function() {
                var e, t = this,
                    ...
                    i = this.options,
                    s = l("<div>")
                    .addClass("input " + n[0].className),
                    a = l("<div>")
                    .addClass("button-group");
                if (c.isValue(i.historyPreset) && (l.each(i.historyPreset.toArray(i.historyDivider), function() {
                        t.history.push(this)
                    }), t.historyIndex = t.history.length - 1), void 0 === n.attr("type") && n.attr("type", "text"), s.insertBefore(n), n.appendTo(s), a.appendTo(s), c.isValue(n.val()
                        .trim()) || n.val(i.defaultValue), !0 !== i.clearButton || n[0].readOnly || l("<button>")
                    .addClass("button input-clear-button")
                    .addClass(i.clsClearButton)
                    .attr("tabindex", -1)
                    .attr("type", "button")
                    .html(i.clearButtonIcon)
                    .appendTo(a), "password" === n.attr("type") && !0 === i.revealButton && l("</button><button>")
                    .addClass("button input-reveal-button")
                    .addClass(i.clsRevealButton)
                    .attr("tabindex", -1)
                    .attr("type", "button")
                    .html(i.revealButtonIcon)
                    .appendTo(a), !0 === i.searchButton && l("</button><button>")
                    .addClass("button input-search-button")
                    .addClass(i.clsSearchButton)
                    .attr("tabindex", -1)
                    .attr("type", "submit" === i.searchButtonClick ? "submit" : "button")
                    .html(i.searchButtonIcon)
                    .appendTo(a), c.isValue(i.prepend) && l("<div>")
                    .html(i.prepend)
                    .addClass("prepend")
                    .addClass(i.clsPrepend)
                    .appendTo(s), c.isValue(i.append) && l("<div>")
                    .html(i.append)
                    .addClass("append")
                    .addClass(i.clsAppend)
                    .appendTo(s), "string" == typeof i.customButtons && (i.customButtons = c.isObject(i.customButtons)), "object" == typeof i.customButtons && 0 < c.objectLength(i.customButtons) && l.each(i.customButtons, function() {
                        var n = l("<button>");
                        n.addClass("button input-custom-button")
                            .addClass(i.clsCustomButton)
                            .addClass(this.cls)
                            .attr("tabindex", -1)
                            .attr("type", "button")
                            .html(this.html), this.attr && "object" == typeof this.attr && l.each(this.attr, function(e, t) {
                                n.attr(l.dashedName(e), t)
                            }), n.data("action", this.onclick), n.appendTo(a)
                    }), c.isValue(n.attr("data-exclaim")) && s.attr("data-exclaim", n.attr("data-exclaim")), "rtl" === n.attr("dir") && s.addClass("rtl")
                    .attr("dir", "rtl"), !(n[0].className = "") === i.copyInlineStyles)
                    for (var o = 0, r = n[0].style.length; o < r; o++) s.css(n[0].style[o], n.css(n[0].style[o]));
                s.addClass(i.clsComponent), n.addClass(i.clsInput), "default" !== i.size && s.css({
                    width: i.size
                }), c.isNull(i.autocomplete) || (e = c.isObject(i.autocomplete), this.autocomplete = !1 !== e ? e : i.autocomplete.toArray(i.autocompleteDivider), l("<div>")
                    .addClass("autocomplete-list")
                    .css({
                        maxHeight: i.autocompleteListHeight,
                        display: "none"
                    })
                    .appendTo(s)), i.label && (e = l("<label>")
                    .addClass("label-for-input")
                    .addClass(i.clsLabel)
                    .html(i.label)
                    .insertBefore(s), n.attr("id") && e.attr("for", n.attr("id")), "rtl" === n.attr("dir") && e.addClass("rtl")), n.is(":disabled") ? this.disable() : this.enable()
            },
            _createEvents: function() {
                var n = this,
                    i = this.element,
                    s = this.options,
                    e = i.closest(".input"),
                    a = e.find(".autocomplete-list");
                e.on(o.events.click, ".input-clear-button", function() {
                    var e = i.val();
                    i.val(c.isValue(s.defaultValue) ? s.defaultValue : "")
                        .fire("clear")
                        .fire("change")
                        .fire("keyup")
                        .focus(), 0 < a.length && a.css({
                            display: "none"
                    ...
                    }), !0 === s.preventSubmit && e.preventDefault()), s.history && e.keyCode === o.keyCode.UP_ARROW && (n.historyIndex--, 0 <= 0 n.historyindex ? (i.val(""), i.val(n.history[n.historyindex]), n._fireevent("history-down", { val: i.val(), history: n.history, historyindex: })) : e.preventdefault()), s.history && e.keycode="==" o.keycode.down_arrow (n.historyindex++, < n.history.length n._fireevent("history-up", - 1, e.preventdefault()) }), i.on(o.events.keydown, function(e) o.keycode.enter n._fireevent("enter-click", i.val() }) i.on(o.events.blur, function() e.removeclass("focused") i.on(o.events.focus, e.addclass("focused") i.on(o.events.input, var e, s="this.value.toLowerCase();" !="=" a.length (a.html(""), e="n.autocomplete.filter(function(e)" return -1 e.tolowercase() .indexof(s) a.css({ display: e.length "block" "none" l.each(e, function(e, t) n="t.toLowerCase()" .indexof(s), i="l(" <div">")
                            .addClass("item")
...
function(o, r) {
    ...
    o.keypadSetup = function(e) {
            ...
            _create: function() {
                var e = this.element,
                    t = this.options;
                this.keys = t.keys.toArray(","), this.keys_to_work = this.keys, this._createKeypad(), !0 === t.shuffle && this.shuffle(), this._createKeys(), this._createEvents(), this._fireEvent("keypad-create", {
                    element: e
                })
            },
            _createKeypad: function() {
                var e = this.element,
                    t = this.options,
                    n = e.parent(),
                    i = n.hasClass("input") ? n : r("<div>")
                    .addClass("input")
                    .addClass(e[0].className);
                if (i.addClass("keypad"), "static" !== i.css("position") && "" !== i.css("position") || i.css({
                        position: "relative"
                    }), void 0 === e.attr("type") && e.attr("type", "text"), i.insertBefore(e), e.attr("readonly", !0), e.appendTo(i), (n = r("<div>")
                        .addClass("keys")
                        .addClass(t.clsKeys))
                    .appendTo(i), this._setKeysPosition(), !0 === t.open && n.addClass("open keep-open"), !(e[0].className = "") === t.copyInlineStyles)
                ...
                e.addClass(t.clsInput), i.addClass(t.clsKeypad), e.on(o.events.blur, function() {
                    ...
                    .addClass(t.clsLabel)
                    .html(t.label)
                    .insertBefore(i), e.attr("id") && n.attr("for", e.attr("id")), "rtl" === e.attr("dir") && n.addClass("rtl")), !0 === t.disabled || e.is(":disabled") ? this.disable() : this.enable(), this.keypad = i
            },
            ...
            _createKeys: function() {
                ...
                s.html(""), r.each(this.keys_to_work, function() {
                    ...
                    e = r("<span>")
                        ...
                        .addClass(n.clsKey)
                        .addClass(n.clsServiceKey)
                        .html(this), "&larr;" === this && e.addClass(n.clsBackspace), "&times;" === this && e.addClass(n.clsClear), e.data("key", this), e.css({
                            width: n.keySize,
                            height: n.keySize,
                            lineHeight: n.keySize - 4
                        })
            ...
            _createEvents: function() {
                ...
                t.on(o.events.click, ".key", function(e) {
                    ...
                    if ("&larr;" !== t.data("key") && "&times;" !== t.data("key")) {
                        if (0 < s.keyLength && String(n.value)
                            .length === s.keyLength) return !1;
                    ...
                    } else "&times;" === t.data("key") && (n.value = "", n._fireEvent("clear")), "&larr;" === t.data("key") && (n.value = n.value.substring(0, n.value.length - 1), n._fireEvent("backspace", {
                        val: n.value
                    }));
    ...
    l.lightboxSetup = function(e) {
        ...
        _createStructure: function() {
            ...
            0 === n.length && (n = c("<div>")
                ...
                .html(t.iconNext)
                .appendTo(e), c("<span>")
                .addClass("lightbox__closer")
                .addClass(t.clsClose)
                .html(t.iconClose)
                .appendTo(e), c("<div>")
                .addClass("lightbox__image")
                .addClass(t.clsImageContainer)
                .appendTo(e), this.component = e[0], this.lightbox = e, this.overlay = n
        },
        _createEvents: function() {
            var e = this,
                t = this.element,
        ...
        _goto: function(e) {
            ...
            r.find(".lightbox__image-wrapper")
                .remove(), t = c("<div>")
                .addClass("lightbox__image-wrapper")
                .addClass(s.clsImageWrapper)
                .attr("data-title", a.attr("alt") || a.attr("data-title") || "")
                .appendTo(r), n = c("<div>")
                .appendTo(t), l.makePlugin(n, "activity", {
                    type: "cycle",
                    style: "color"
                }), "IMG" !== (this.current = e)
                .tagName && "DIV" !== e.tagName || (e = a.attr("data-original") || a.attr("src"), o.attr("src", e), o[0].onload = function() {
                    var e = this.height > this.width;
                    o.addClass(e ? "lightbox__image-portrait" : "lightbox__image-landscape")
                        .addClass(s.clsImage), o.attr("alt", a.attr("alt")), o.appendTo(t), n.remove(), i._fireEvent("draw-image", {
                            image: o[0],
                            item: t[0]
                        })
                })
...
function(s, c) {
    ...
    var d = s.utils,
        n = {
            listDeferred: 0,
            templateBeginToken: "<%", templateendtoken: "%>",
    ...
    s.listSetup = function(e) {
        ...
        _createTopBlock: function() {
            var t, n = this,
                ...
                s = c("<div>")
                .addClass("list-top")
                .addClass(i.clsListTop)
                .insertBefore(e),
                e = d.isValue(this.wrapperSearch) ? this.wrapperSearch : c("<div>")
                .addClass("list-search-block")
                .addClass(i.clsSearch)
                .appendTo(s);
            return c("<input>")
                .attr("type", "text")
                .appendTo(e)
                ...
                }), !0 !== i.showSearch && e.hide(), e = d.isValue(this.wrapperRows) ? this.wrapperRows : c("<div>")
                .addClass("list-rows-block")
                .addClass(i.clsItemsCount)
                .appendTo(s), t = c("<select>")
                .appendTo(e), c.each(i.itemsSteps.toArray(), function() {
                    var e = c("<option>")
                        .attr("value", "all" === this ? -1 : this)
                        .text("all" === this ? i.itemsAllTitle : this)
                        .appendTo(t);
                    ...
                    onChange: function(e) {
                        parseInt(e) !== parseInt(i.items) && (i.items = parseInt(e), n.currentPage = 1, n._draw(), n._fireEvent("rows-count-change", {
                            val: e
                        }))
                    }
        ...
        _createBottomBlock: function() {
            var e = this.element,
                ...
                .addClass(t.clsListBottom)
                .insertAfter(e),
                e = c("<div>")
                .addClass("list-info")
                .addClass(t.clsListInfo)
                .appendTo(n);
            return !0 !== t.showListInfo && e.hide(), e = c("<div>")
                .addClass("list-pagination")
                .addClass(t.clsListPagination)
                .appendTo(n), !0 !== t.showPagination && e.hide(), n
        },
        _createStructure: function() {
            var e, t, n = this,
                i = this.element,
            ...
            0 < a.length && (this.wrapperSearch = a), 0 < o.length && (this.wrapperInfo = o), 0 < r.length && (this.wrapperRows = r), 0 < l.length && (this.wrapperPagination = l), i.parent()
                .hasClass("list-component") ? e = i.parent() : (e = c("<div>")
                    .addClass("list-component")
                    .insertBefore(i), i.appendTo(e)), e.addClass(s.clsComponent), this.activity = c("<div>")
        ...
        _createEvents: function() {
            ...
            t.find(".list-search-block input")
                .on(s.events.inputchange, function() {
                    n.filterString = this.value.trim()
                        .toLowerCase(), ":" !== n.filterString[n.filterString.length - 1] && (n.currentPage = 1, n._draw())
                }), d.isValue(this.wrapperSearch) && 0 < (e = this.wrapperSearch.find("input"))
                .length && e.on(s.events.inputchange, function() {
                    n.filterString = this.value.trim()
                        .toLowerCase(), ":" !== n.filterString[n.filterString.length - 1] && (n.currentPage = 1, n._draw())
        ...
        _info: function(e, t, n) {
            ...
            0 !== i.length && (n < t && (t = n), 0 === this.items.length && (e = t = n = 0), s = (s = (s = (s = s.listInfoTitle)
                        .replace("$1", e))
                    .replace("$2", t))
                .replace("$3", n), i.html(s))
        },
        _paging: function(e) {
            var t = this.element,
                n = this.options,
        ...
        _filter: function() {
            ...
            return d.isValue(this.filterString) || 0 < this.filters.length ? (e = this.items.filter(function(e) {
                if (n = "", d.isValue(r.filterClass)) {
                    if (0 < (i = e.getElementsByClassName(r.filterClass))
                        .length)
                        for (t = 0; t < i.length; t++) n += i[t].textContent
                } else n = e.textContent;
                if (s = n.replace(/[\n\r]+|[\s]{2,}/g, " ")
                    .trim()
                    .toLowerCase(), !0 === (a = !d.isValue(o.filterString) || -1 < s.indexOf(o.filterString)) && 0 < o.filters.length)
        ...
        _draw: function(e) {
            var t, n = this.element,
                ...
                o = this._filter();
            for (n.children(i.sortTarget)
                .remove(), t = s; t <= 0 1 a; t++) d.isvalue(o[t]) && c(o[t]) .addclass(i.clslistitem) .appendto(n), this._fireevent("draw-item", { item: o[t] }); this._info(1 + s, a, o.length), this._paging(o.length), this.activity.hide(), this._fireevent("draw"), void !="=" e d.exec(e, [n], n[0]) }, _getitemcontent: function(e) var t, n, i, a="this.options," o="c(e)," r="d.isValue(o.data(" formatmask"))" ? o.data("formatmask") : null; if (d.isvalue(a.sortclass)) (i , < (n="c(e)" .find("." a.sortclass)) .length) for (t="0;" t n.length; i s="0" n.length n[0].getattribute("data-format") "" } else i) .tolowercase() .replace( [\n\r]+|[\s]{2,} g, " ") .trim(), d.isvalue(s)) switch (-1="==" ["number", "int", "integer", "float", "money"].indexof(s) || ","="==" a.thousandseparator "."="==" a.decimalseparator a.thousandseparator, a.decimalseparator)), s) case "date": i.todate(r) new date(i); break; "number": "int": "integer": "float": "money": "card": "phone": return deleteitem: (var n="[]," this.items.length; s++) [t]) n.push(s) t.textcontent.contains(e) n.push(s); this.items="d.arrayDeleteByMultipleKeys(this.items," n), this draw: function() this._draw() sorting: function(e, n) d.isvalue(e) (o.sortclass="e)," d.isvalue(t) -1 ["asc", "desc"].indexof(t) (o.sortdir="t)," this._fireevent("sort-start", items: }), this.items.sort(function(e, t) (s="asc" =="=" o.sortdir 1), -1), a._fireevent("sort-item-switch", a: e, b: result: this._fireevent("sort-stop", !0="==" this._draw(), filter: this.filterstring="e.trim()" .tolowercase(), this.currentpage="1," loaddata: (s.source="e," this._fireevent("data-load", source: s.source c.json(s.source) .then(function(e) t; n._fireevent("data-loaded", s.source, data: n._createitemsfromjson(e), i.html(""), d.isvalue(s.filterstring) (n.filterstring="s.filterString)," d.isvalue(s.filter) (!1="==" n.filterindex="n.addFilter(t))," d.isvalue(s.filters) "string"="=" typeof s.filters c.each(s.filters.toarray(), !1 n.filtersindexes.push(n.addfilter(t)) n.currentpage="1," n.sorting(s.sortclass, s.sortdir, !0) n._fireevent("data-load-error", xhr: }) })) next: this.items.length (this.currentpage++,> this.pagesCount ? this.currentPage = this.pagesCount : this._draw())
        },
        prev: function() {
        ...
        destroy: function() {
            var e, t = this.element,
                n = t.parent();
            return n.find(".list-search-block input")
                .off(s.events.inputchange), d.isValue(this.wrapperSearch) && 0 < (e = this.wrapperSearch.find("input"))
                .length && e.off(s.events.inputchange), n.off(s.events.click, ".pagination .page-link"), d.isValue(this.wrapperPagination) && this.wrapperPagination.off(s.events.click, ".pagination .page-link"), t
        }
    })
}(Metro, m4q),
function(a, o) {
    ...
    a.listViewSetup = function(e) {
        ...
        _createNode: function(n) {
            var e, t = this.options,
                i = o("<li>");
            return void 0 === n.caption && void 0 === n.content || (e = o("<div>")
                .addClass("data"), i.prepend(e), void 0 !== n.caption && e.append(this._createCaption(n.caption)), void 0 !== n.content && e.append(this._createContent(n.content))), void 0 !== n.icon && i.prepend(this._createIcon(n.icon)), 0 < r.objectLength(t.structure) && o.each(t.structure, function(e, t) {
                void 0 !== n[e] && o("<div>")
        ...
        _createView: function() {
            ...
            e.addClass("listview"), e.find("ul")
                .addClass("listview"), o.each(t, function() {
                    var e, t = o(this);
                    void 0 === t.data("caption") && void 0 === t.data("content") || (e = o("<div>")
                            .addClass("data"), t.prepend(e), void 0 !== t.data("caption") && e.append(n._createCaption(t.data("caption"))), void 0 !== t.data("content") && e.append(n._createContent(t.data("content")))), void 0 !== t.data("icon") && t.prepend(n._createIcon(t.data("icon"))), 0 < t.children("ul")
                        .length ? (t.addClass("node-group"), t.append(n._createToggle()), !0 !== t.data("collapsed") && t.addClass("expanded")) : t.addClass("node"), t.hasClass("node") && ((e = o("<input type="checkbox" data-role="checkbox" data-style + i.checkstyle "">"))
                            .data("node", t), t.prepend(e)), 0 < s && o.each(i.structure, function(e) {
                            void 0 !== t.data(e) && o("<div>")
                                .addClass("node-data item-data-" + e)
                                .addClass(t.data(e))
                                .html(t.data(e))
                                .appendTo(t)
        ...
        _createEvents: function() {
            ...
            n.on(a.events.dblclick, ".node", function() {
                ...
                var e = o(this);
                n.find(".node")
                    .removeClass("current"), e.toggleClass("current"), !0 === i.selectCurrent && (n.find(".node")
                        .removeClass("current-select"), e.toggleClass("current-select")), t._fireEvent("node-click", {
                        node: e
                    })
                ...
                var e = o(this)
                    .closest("li");
                n.find(".node-group")
                    .removeClass("current-group"), e.addClass("current-group"), t._fireEvent("group-node-click", {
                        node: e
                    })
        ...
        view: function(e) {
            ...
            t.view = e, o.each(a.listView, function(e, t) {
                    n.removeClass("view-" + t), n.find("ul")
                        .removeClass("view-" + t)
                }), n.addClass("view-" + t.view), n.find("ul")
                .addClass("view-" + t.view)
        },
        toggleNode: function(e) {
            var t, n = this.options;
            (e = o(e))
            .hasClass("node-group") && (e.toggleClass("expanded"), t = !0 !== e.hasClass("expanded") ? "slideUp" : "slideDown", this._fireEvent("collapse-node", {
                node: e
        ...
        add: function(e, t) {
            ...
            if (null === e) n = i;
                ...
                if (!(e = o(e))
                    .hasClass("node-group")) return;
                0 === (n = e.children("ul"))
                    .length && (n = o("<ul>")
                        .addClass("listview")
                        .addClass("view-" + s.view)
                        .appendTo(e), this._createToggle()
                        .appendTo(e), e.addClass("expanded"))
        ...
        addGroup: function(e) {
            var t = this.element,
                n = this.options;
            return delete e.icon, (e = this._createNode(e))
                .addClass("node-group")
                .appendTo(t), e.append(this._createToggle()), e.addClass("expanded"), e.append(o("<ul>")
                    .addClass("listview")
                    .addClass("view-" + n.view)), this._fireEvent("node-insert", {
                    newNode: e,
                    parentNode: null,
                    list: t
                }), e
        ...
        insertBefore: function(e, t) {
            var n;
            if ((e = o(e))
                .length) return (n = this._createNode(t))
                .addClass("node")
                .insertBefore(e), t = n.closest(".node"), e = n.closest("ul"), this._fireEvent("node-insert", {
                    newNode: n,
                    parentNode: t,
                    list: e
                }), n
        ...
        insertAfter: function(e, t) {
            ...
            if ((e = o(e))
                .length) return (n = this._createNode(t))
                .addClass("node")
                .insertAfter(e), t = n.closest(".node"), e = n.closest("ul"), this._fireEvent("node-insert", {
                    newNode: n,
                    parentNode: t,
                    list: e
                }), n
        ...
        del: function(e) {
            var t, n, i = this.element;
            (e = o(e))
            .length && (n = (t = e.closest("ul"))
                .closest("li"), e.remove(), 0 !== t.children()
                .length || t.is(i) || (t.remove(), n.removeClass("expanded"), n.children(".node-toggle")
                    .remove()), this._fireEvent("node-delete", {
                    node: e
                }))
        },
        clean: function(e) {
            (e = o(e))
            .length && (e.children("ul")
                .remove(), e.removeClass("expanded"), e.children(".node-toggle")
                .remove(), this._fireEvent("node-clean", {
                    node: e
                }))
        },
        getSelected: function() {
        ...
        clearSelected: function() {
            this.element.find(":checked")
                .prop("checked", !1), this.element.trigger("change")
        },
        selectAll: function(e) {
            this.element.find(".node > .checkbox input")
                .prop("checked", !1 !== e), this.element.trigger("change")
        },
        selectByAttribute: function(e, t, n) {
            !1 !== n && (n = !0), this.element.find("li[" + e + '="' + t + '"] > .checkbox input')
                .prop("checked", n), this.element.trigger("change")
        },
        changeAttribute: function(e) {
            var t, n = this,
                i = this.element,
    ...
    i.masterSetup = function(e) {
        ...
        _createControls: function() {
            var e, t = this.element,
                n = this.options,
                i = t.find(".page"),
                s = String(n.controlTitle)
                .replace("$1", "1");
            s = String(s)
                .replace("$2", i.length), a.each(["top", "bottom"], function() {
                    e = a("<div>")
                        .addClass("controls controls-" + this)
                        .addClass(n.clsControls)
                        .appendTo(t), a("<span>")
                        .addClass("prev")
                        .addClass(n.clsControlPrev)
                        .html(n.controlPrev)
                        .appendTo(e), a("<span>")
                        .addClass("next")
                        .addClass(n.clsControlNext)
                        .html(n.controlNext)
                        .appendTo(e), a("<span>")
                        .addClass("title")
                        .addClass(n.clsControlTitle)
                        .html(s)
                        .appendTo(e)
        ...
        _setTitle: function() {
            var e = this.element.find(".controls .title"),
                t = (t = this.options.controlTitle.replace("$1", this.currentIndex + 1))
                .replace("$2", String(this.pages.length));
            e.html(t)
        },
        _createPages: function() {
            ...
            0 === e.length && (e = a("<div>")
                .addClass("pages")
                .appendTo(n)), e.addClass(i.clsPages), a.each(s, function() {
                var e = a(this);
                void 0 !== e.data("cover") ? n.css({
                        ...
                        left: "100%"
                    }), e.addClass(i.clsPage)
                    .hide(0), t.pages.push(e)
        ...
        _createEvents: function() {
            ...
            t.on(i.events.click, ".controls .prev", function() {
                ...
                .on(i.events.resize, function() {
                    t.find(".pages")
                        .height(e.pages[e.currentIndex].outerHeight(!0) + 2)
                }, {
                    ns: this.id
                })
        },
        ...
        destroy: function() {
            var e = this.element;
            return e.off(i.events.click, ".controls .prev"), e.off(i.events.click, ".controls .next"), a(window)
                .off(i.events.resize, {
                    ns: this.id
                }), e
        }
...
function(e) {
    ...
    e.md5 = function(e) {
        ...
        function a(e) {
            for (var t = "", n = "", i = 0; i <= 3; i++) t +="(n" = "0" (e>>> 8 * i & 255)
                    .toString(16))
                .substr(n.length - 2, 2);
            return t
        }
...
function(l, c) {
    ...
    l.navViewSetup = function(e) {
        ...
        _calcMenuHeight: function() {
            ...
            0 !== t.length && 0 !== (e = t.children(".navview-menu-container"))
                .length && (c.each(e.prevAll(), function() {
                    n += c(this)
                        .outerHeight(!0)
        ...
        _createStructure: function() {
            var e, t, n = this.element,
                i = this.options;
            n.addClass("navview")
                .addClass(!1 !== i.compact ? "navview-compact-" + i.compact : "")
                .addClass(!1 !== i.expand ? "navview-expand-" + i.expand : ""), e = n.children(".navview-pane"), t = n.children(".navview-content"), n = c(i.toggle), (i = e.children(".navview-menu"))
                .length && (i.prevAll()
                    .reverse()
                    .wrapAll(c("<div>")
                        .addClass("navview-container")), i.wrap(c("<div>")
                        .addClass("navview-menu-container"))), this.pane = 0 < e.length ? e : null, this.content = 0 < t.length ? t : null, this.paneToggle = 0 < n.length ? n : null, this._recalc()
        },
        _createEvents: function() {
            var a = this,
                o = this.element,
            ...
            e.on("mousewheel", function(e) {
                    var t = o.find(".navview-pane")
                        .width(),
                        n = 0 < e.deltaY ? -1 : 1,
                        i = a.menuScrollStep,
                        s = a.menuScrollDistance,
                        e = parseInt(r.css("top"));
                    if (48 < t) return !1; - 1 == n && Math.abs(e) <= 1="=" s && r.css("top", parseint(r.css("top")) + i * n), n e <="-i" n) }), o.on(l.events.click, ".pull-button, .holder", function() { a.pullclick(this) ".navview-menu li", !0="==" s.activestate (o.find(".navview-menu li") .removeclass("active"), c(this) .toggleclass("active")) li> a", function() {
                ...
                .on(l.events.resize, function() {
                    ...
                    a.pane.hasClass("open") || (o.removeClass("expanded"), a.pane.removeClass("open"), c(this)
                        .width() <= 0 l.media_sizes[("" + s.compact) .touppercase()] && o.removeclass("compacted"), i.length (n="i.children(" .navview-menu")," settimeout(function() { e="n.height()," t="i.height()," a.menuscrollstep="n.children(" :not(.item-separator)," :not(.item-header)")[0].clientheight, a.menuscrolldistance="t" < ? d.nearest(e - t, a.menuscrollstep) : }, 0))), a._recalc() ns: this.id }) _togglepanemode: function() var 280; !t !e.hasclass("expanded") || e.hasclass("compacted") !e.hasclass("compacted") e.toggleclass("compacted") e.toggleclass("expanded") pullclick: function(e) return e.hasclass("holder") (t="e.parent()" .find("input"), t.focus() 200)), this.pane.hasclass("open") this.close() this._togglepanemode(), this._recalc(), !0 open: this.pane.addclass("open") close: this.pane.removeclass("open") toggle: e.hasclass("open") e.removeclass("open") e.addclass("open") togglemode: this._togglepanemode() changeattribute: {}, destroy: e.off(l.events.click, ".pull-button, .holder"), ".navview-menu li"), li> a"), null !== this.paneToggle && this.paneToggle.off(l.events.click), c(window)
                .off(l.events.resize, {
                    ns: this.id
                }), e
        }
    ...
    var d = {
        ...
        create: function(e, t, i) {
            ...
            .css({
                    ...
                    .html(t), s.prepend(t)), l("<div>")
                .addClass("notify-message")
                .html(e)
                .appendTo(s), void 0 !== i && (void 0 !== i.cls && s.addClass(i.cls), void 0 !== i.width && s.css({
                    width: i.width
                })), s.on(r.events.click, function() {
                    c.exec((c.isValue(i.onClick) ? i : o)
                        .onClick, null, this), a.kill(l(this)
                        .closest(".notify"), (c.isValue(i.onClose) ? i : o)
                        .onClose)
                }), null === d.container && (d.container = d._createContainer()), s.appendTo(d.container), s.hide(function() {
                    c.exec((c.isValue(i.onAppend) ? i : o)
                        .onAppend, null, s[0]);
                    var e = (c.isValue(i.duration) ? i : o)
                        .duration,
                        t = (c.isValue(i.animation) ? i : o)
                        .animation,
                        n = (c.isValue(i.distance) ? i : o)
                        .distance;
                    "max" !== n && !isNaN(n) || (n = l(window)
                            .height()), s.show()
                        .animate({
                            draw: {
                                marginTop: [n, 4],
                            ...
                            onDone: function() {
                                c.exec(o.onNotifyCreate, null, this), void 0 !== i && !0 === i.keepOpen || setTimeout(function() {
                                    a.kill(s, (c.isValue(i.onClose) ? i : o)
                                        .onClose)
                                }, o.timeout), c.exec((c.isValue(i.onShow) ? i : o)
                                    .onShow, null, s[0])
                            }
                        })
                })
...
function(e, r) {
    ...
    e.pagination = function(e) {
        ...
        if (a.html(""), t = r("<ul>")
            .addClass("pagination")
            .addClass(i.clsPagination)
            .appendTo(a), 0 !== i.length && -1 !== i.rows) {
            ...
            if (t.append(e), t.append(o(1, 1 === i.current ? "active" : "", 1)), 0 === s || i.pages <= 7) for (n="2;" n < i.pages; n++) t.append(o(n, i.current ? "active" : "", n)); else if (i.current s) { i.pages> s && t.append(o("...", "no-link", null))
            ...
            return (1 < i.pages || i.current < i.pages) && t.append(o(i.pages, i.current === i.pages ? "active" : "", i.pages)), a = o(i.nextTitle, "service next-page", "next"), t.append(a), 1 === i.current && e.addClass("disabled"), i.current === i.pages && a.addClass("disabled"), 0 === i.length && (t.addClass("disabled"), t.children()
                .addClass("disabled")), t
        }
    }
}(Metro, m4q),
function(o, r) {
    ...
    o.panelSetup = function(e) {
        ...
        _addCustomButtons: function(e) {
            ...
            if (0 !== s.length) return 0 === (t = s.find(".custom-buttons"))
                .length ? t = r("<div>")
                .addClass("custom-buttons")
                .appendTo(s) : (t.find(".btn-custom")
                    .off(o.events.click), t.html("")), r.each(n, function() {
                    var n = r("<span>");
                    n.addClass("button btn-custom")
                        .addClass(i.clsCustomButton)
                        .addClass(this.cls)
                        .attr("tabindex", -1)
                        .html(this.html), this.attr && "object" == typeof this.attr && r.each(this.attr, function(e, t) {
                            n.attr(r.dashedName(e), t)
                        }), n.data("action", this.onclick), t.prepend(n)
                }), s.on(o.events.click, ".btn-custom", function(e) {
                    var t;
                    l.isRightMouse(e) || (e = (t = r(this))
                        .data("action"), l.exec(e, [t], this))
                }), this;
        ...
        _create: function() {
            var e, t = this.element,
                ...
                a = t[0].className;
            i.attr("id", s)
                .addClass(a), i.insertBefore(t), t.appendTo(i), t[0].className = "", t.addClass("panel-content")
                .addClass(n.clsContent)
                .appendTo(i), "" === n.titleCaption && "" === n.titleIcon && !0 !== n.collapsible || (e = r("<div>")
                    .addClass("panel-title")
                    .addClass(n.clsTitle), "" !== n.titleCaption && r("<span>")
                    .addClass("caption")
                    .addClass(n.clsTitleCaption)
                    .html(n.titleCaption)
                    .appendTo(e), "" !== n.titleIcon && r(n.titleIcon)
                    .addClass("icon")
                    .addClass(n.clsTitleIcon)
                    .appendTo(e), !0 === n.collapsible && (a = r("<span>")
                        .addClass("dropdown-toggle marker-center active-toggle")
                        .addClass(n.clsCollapseToggle)
                ...
                })), "auto" !== n.width && 0 <= 0 2 parseint(n.width) && i.outerwidth(parseint(n.width)), "auto" !="=" n.height <="parseInt(n.height)" (i.outerheight(parseint(n.height)), t.css({ overflow: })), this.panel="i," this._fireevent("panel-create", { element: t, panel: i }) }, custombuttons: function(e) return this._addcustombuttons(e) collapse: function() var e="this.element;" !1 l.ismetroobject(e, "collapse") o.getplugin(e, .collapse() open: this.expand() close: this.collapse() expand: .expand() changeattribute: {}, destroy: t="this.options;" !0="==" t.collapsible .destroy(), t.draggable "draggable") } }(metro, m4q), function(r, l) "use strict"; c="r.utils," n="{" popoverdeferred: 0, popovertext: "", popoverhide: 3e3, popovertimeout: 10, popoveroffset: popovertrigger: r.popoverevents.hover, popoverposition: r.position.top, hideonleave: !1, closebutton: !0, clspopover: clspopovercontent: onpopovershow: r.noop, onpopoverhide: onpopovercreate: r.noop }; r.popoversetup="function(e)" n, e) window.metropopoversetup, r.popoversetup(window.metropopoversetup), r.component("popover", init: function(e, t) this._super(t, e, popover: null, popovered: size: width: height: id: c.elementid("popover") }), this _create: this._createevents(), this._fireevent("popover-create", this.element _createevents: switch (i.popovertrigger) case r.popoverevents.click: break; r.popoverevents.focus: default: n.on(e, null="==" t.popover t.popovered settimeout(function() t.createpopover(), t._fireevent("popover-show", i.popoverhide t.removepopover() i.popoverhide) i.popovertimeout) i.hideonleave n.on(r.events.leave, l(window) .on(r.events.scroll, t.setposition() ns: this.id setposition: n.popoverposition="==" r.position.bottom ? (e.addclass("bottom"), e.css({ top: i.offset() .top - .scrolltop() + i.outerheight() n.popoveroffset, left: .left i.outerwidth() t.width .scrollleft() })) : r.position.right (e.addclass("right"), t.height .scrolltop(), n.popoveroffset r.position.left (e.addclass("left"), (e.addclass("top"), createpopover: s="this.element," a="this.options," o="c.elementId(" popover");" if (!this.popovered) ((e="l(" <div">")
                        .addClass("popover neb")
                        .addClass(a.clsPopover))
                    .attr("id", o), l("<div>")
                    .addClass("popover-content")
                    .addClass(a.clsPopoverContent)
                    .html(a.popoverText)
                    .appendTo(e), 0 === a.popoverHide && !0 === a.closeButton && l("<button>")
                ...
                e.addClass(t), !0 !== a.closeButton && e.on(r.events.click, function() {
                    n.removePopover()
                }), this.popover = e, this.size = c.hiddenElementSize(e), "TD" !== i.tagName && "TH" !== i.tagName || (i = l("<div>")
                    .css("display", "inline-block")
                    .html(s.html()), s.html(i), s = i), this.setPosition(), e.appendTo(l("body")), this.popovered = !0, this._fireEvent("popover-create", {
                    popover: e
                })
            }
        },
        ...
        changeAttribute: function(e) {
            ...
            switch (e) {
                case "data-popover-text":
                    i.popoverText = n.attr("data-popover-text"), t.popover && (t.popover.find(".popover-content")
                        .html(i.popoverText), t.setPosition());
                    break;
        ...
        destroy: function() {
            ...
            return t.off(e), !0 === n.hideOnLeave && t.off(r.events.leave), l(window)
                .off(r.events.scroll, {
                    ns: this.id
                }), t
        }
...
function(e, i) {
    ...
    e.progressSetup = function(e) {
        ...
        _create: function() {
            var e, t = this.element,
                n = this.options;
            switch ("string" == typeof n.type && (n.type = n.type.toLowerCase()), t.html("")
                .addClass("progress"), n.type) {
                case "buffer":
                    i("<div>")
                        .addClass("bar")
                        .appendTo(t), i("<div>")
            ...
            "line" !== n.type && (e = i("<span>")
                    .addClass("value")
                    .addClass(n.clsValue)
                    .appendTo(t), "center" === n.valuePosition && e.addClass("centered"), !1 === n.showValue && e.hide()), !0 === n.small && t.addClass("small"), t.addClass(n.clsBack), t.find(".bar")
                .addClass(n.clsBar), t.find(".buffer")
                .addClass(n.clsBuffer), !0 === n.showLabel && (e = i("<span>")
                    .addClass("progress-label")
                    .addClass(n.clsLabel)
                    .html("" === n.labelTemplate ? n.value + "%" : n.labelTemplate.replace("%VAL%", n.value)), "before" === n.labelPosition ? e.insertBefore(t) : e.insertAfter(t)), this.val(n.value), this.buff(n.buffer), this._fireEvent("progress-create", {
                    element: t
                })
        },
        val: function(e) {
            ...
            "free" === n.valuePosition && i.css(e), !0 !== n.showLabel || (t = t["before" === n.labelPosition ? "prev" : "next"](".progress-label"))
                .length && t.html("" === n.labelTemplate ? n.value + "%" : n.labelTemplate.replace("%VAL%", n.value)), this._fireEvent("value-change", {
                    val: this.value
...
function(d, u) {
    ...
    d.ratingSetup = function(e) {
        ...
        _create: function() {
            var e, t = this.element,
                n = this.options;
            if (isNaN(n.value) ? n.value = 0 : n.value = parseFloat(n.value)
                .toFixed(1), null !== n.values) Array.isArray(n.values) ? this.values = n.values : "string" == typeof n.values && (this.values = n.values.toArray());
            else
                for (e = 1; e <= n.stars; e++) this.values.push(e); this.originvalue="n.value," this.value="0" < n.value ? math[n.roundfunc](n.value) : 0, this._createrating(), this._createevents(), this._fireevent("rating-create", { element: t }) }, _createrating: function() var e, t, n, i, s="this.element," a="this.options," o="h.elementId(" rating")," r="u(" <div">")
                .addClass("rating " + String(s[0].className)
                    .replace("d-block", "d-flex"))
                .addClass(a.clsRating),
                l = d.sheet,
                c = a.static ? Math.floor(this.originValue) : this.value;
            for (s.val(this.value), r.attr("id", o), r.insertBefore(s), s.appendTo(r), t = u("<ul>")
                .addClass("stars")
                .addClass(a.clsStars)
                .appendTo(r), e = 1; e <= a.stars; e++) n="u(" <li">")
                .data("value", this.values[e - 1])
                .appendTo(t), e <= c && n.addclass("on"); if (u("<span>")
                .addClass("result")
                .addClass(a.clsResult)
                .appendTo(r)
                .html(a.message), null !== a.starColor && d.colors.isColor(a.starColor) && h.addCssRule(l, "#" + o + " .stars:hover li", "color: " + a.starColor + ";"), null !== a.staredColor && d.colors.isColor(a.staredColor) && (h.addCssRule(l, "#" + o + " .stars li.on", "color: " + a.staredColor + ";"), h.addCssRule(l, "#" + o + " .stars li.half::after", "color: " + a.staredColor + ";")), null !== a.title && (o = u("<span>")
                    .addClass("title")
                    .addClass(a.clsTitle)
                    .html(a.title), r.prepend(o)), !0 === a.static && (r.addClass("static"), !0 !== a.half || 0 < (i = Math.round(this.originValue % 1 * 10)) && i <= 9 10 && r.find(".stars li.on") .last() .next("li") .addclass("half half-" + * i)), !(s[0].classname )="==" a.copyinlinestyles) for (e="0;" e < s[0].style.length; e++) r.css(s[0].style[e], s.css(s[0].style[e])); a.label (i="u(" <label">")
                .addClass("label-for-input")
                .addClass(a.clsLabel)
                .html(a.label)
                .insertBefore(r), s.attr("id") && i.attr("for", s.attr("id")), "rtl" === s.attr("dir") && i.addClass("rtl")), s.is(":disabled") ? this.disable() : this.enable(), this.rating = r
        },
        _createEvents: function() {
            var n = this,
                i = this.element,
            ...
            this.rating.on(d.events.click, ".stars li", function() {
                var e, t;
                !0 !== s.static && (t = (e = u(this))
                    .data("value"), e.addClass("scale"), setTimeout(function() {
                        e.removeClass("scale")
                    }, 300), i.val(t)
                    .trigger("change"), e.addClass("on"), e.prevAll()
                    .addClass("on"), e.nextAll()
                    .removeClass("on"), n._fireEvent("star-click", {
                        value: t,
                        star: e[0]
                    }))
            })
        ...
        val: function(e) {
            var t = this,
                ...
                s = this.rating;
            if (void 0 === e) return this.value;
            this.value = 0 < e ? Math[i.roundFunc](e) : 0, n.val(this.value)
                .trigger("change");
            s = s.find(".stars li")
                .removeClass("on");
            return u.each(s, function() {
                var e = u(this);
                e.data("value") <= 0 t.value && e.addclass("on") }), this }, msg: function(e) { var t="this.rating;" if (void !="=" e) return t.find(".result") .html(e), static: n="this.rating;" !0="==" (t.static="e)" ? n.addclass("static") : n.removeclass("static") changeattributevalue:="="="" e t.val() t.attr("data-value"); this.val(t) changeattributemessage: function() this.msg(e) changeattributestatic: json.parse(e.attr("data-static")); this.static(e) disable: this.element.data("disabled", !0), this.element.parent() .addclass("disabled") enable: !1), .removeclass("disabled") togglestate: this.elem.disabled this.disable() this.enable() changeattribute: switch (e) case "value": "data-value": this.changeattributevalue(e); break; "disabled": this.togglestate(); "data-message": this.changeattributemessage(); "data-static": this.changeattributestatic() } destroy: this.rating.off(d.events.click, ".stars li"), }) }(metro, m4q), function(l, c) "use strict"; d="l.utils," resizabledeferred: 0, canresize: !0, resizeelement: ".resize-element", minwidth: minheight: maxwidth: maxheight: preserveratio: !1, onresizestart: l.noop, onresizestop: onresize: onresizablecreate: l.noop }; l.resizablesetup="function(e)" n, window.metroresizablesetup, l.resizablesetup(window.metroresizablesetup), l.component("resizable", init: function(e, t) this._super(t, e, resizer: null, id: d.elementid("resizable") _create: this._createstructure(), this._createevents(), this._fireevent("resizable-create") _createstructure: e.data("canresize", e.addclass("resizable-element"), d.isvalue(t.resizeelement) < e.find(t.resizeelement) .length this.resizer="e.find(t.resizeElement)">")
                .addClass("resize-element")
                .appendTo(e), e.data("canResize", t.canResize)
        },
        _createEvents: function() {
            var a = this,
                o = this.element,
            ...
            this.resizer.on(l.events.start, function(e) {
                ...
                !1 !== o.data("canResize") && (t = d.pageXY(e), n = parseInt(o.outerWidth()), i = parseInt(o.outerHeight()), s = {
                    ...
                    .on(l.events.stop, function() {
                        o.removeClass("stop-pointer"), c(document)
                            .off(l.events.move, {
                                ns: a.id
                            }), c(document)
                            .off(l.events.stop, {
...
function(c, d) {
    ...
    function i(e, t, n, i) {
        ...
        0 !== o.length && (u.isValue(t) || (t = "#fff"), u.isValue(n) || (n = .4), "static" === o.css("position") && o.css("position", "relative"), o.css({
            ...
            .remove(), e = Math.max(o.outerWidth(), o.outerHeight()), a = d("<span class="ripple"></span>")
            .css({
                width: e,
                height: e
            }), o.prepend(a), r = i ? (s = i.pageX - o.offset()
                .left - a.width() / 2, i.pageY - o.offset()
                .top - a.height() / 2) : (s = r.width / 2 - a.width() / 2, r.height / 2 - a.height() / 2), a.css({
    ...
    m.selectSetup = function(e) {
            ...
            _addTag: function(e, t) {
                var n, i = this.element,
                    ...
                    t = v("<div>")
                    .addClass("tag")
                    .addClass(s.shortTag ? "short-tag" : "")
                    .addClass(s.clsSelectedItem)
                    .html("<span class="title">" + e + "</span>")
                    .data("option", t);
                return v("<span>")
                    .addClass("remover")
                    .addClass(s.clsSelectedItemRemover)
                    .html("&times;")
                    .appendTo(t), i.hasClass("input-large") ? n = "large" : i.hasClass("input-small") && (n = "small"), t.addClass(n), t
            },
            _addOption: function(e, t, n, i, s) {
                var a = v(e),
                    o = this.element,
                    r = this.options,
                    l = g.isValue(a.attr("data-template")) ? a.attr("data-template")
                    .replace("$1", e.text) : e.text,
                    c = v("<li>")
                    ...
                    d = v("<a>")
                    .html(l);
                c.addClass(e.className), c.data("group", s), a.is(":disabled") && c.addClass("disabled"), a.is(":selected") && (r.showGroupName && s && (l += "&nbsp;<span class="selected-item__group-name">" + s + "</span>"), i ? (c.addClass("d-none"), n.append(this._addTag(l, c))) : (o.val(e.value), n.html(l), o.fire("change", {
                        val: e.value
                    }), c.addClass("active"))), c.append(d)
                    .appendTo(t)
            },
            _addOptionGroup: function(e, t, n, i) {
                ...
                v("<li>")
                    ...
                    .addClass(a.clsOptionGroup)
                    .appendTo(t), v.each(o.children(), function() {
            ...
            _createOptions: function() {
                var e = this,
                    ...
                    .find("ul")
                    .empty(),
                    s = 0 < t.find("option[selected]")
                    .length,
                    a = t[0].multiple,
                    o = t.siblings(".select-input");
                t.siblings(".select-input")
                    .empty(), !0 === n.addEmptyValue && t.prepend(v("<option " + (s ? "" : "selected") value n.emptyvalue class="d-none"></option>")), v.each(t.children(), function() {
            ...
            _createSelect: function() {
                var t, n, i, s, a = this,
                    ...
                    o = this.options,
                    r = v("<label>")
                    .addClass("select " + e[0].className)
                    .addClass(o.clsSelect),
                    l = e[0].multiple,
                    c = g.elementId("select"),
                    d = v("<div>")
                    .addClass("button-group"),
                    u = g.elementId("select-focus-trigger"),
                    h = v("<input type="checkbox">")
                    .addClass("select-focus-trigger")
                    .attr("id", u);
                if (this.placeholder = v("<span>")
                    .addClass("placeholder")
                    .html(o.placeholder), r.attr("id", c)
                    .attr("for", u), r.addClass("input-" + o.size), (s = v("<span>")
                        .addClass("dropdown-toggle"))
                    .appendTo(r), l && r.addClass("multiple"), r.insertBefore(e), e.appendTo(r), d.appendTo(r), h.appendTo(r), h = v("<div>")
                    .addClass("select-input")
                    .addClass(o.clsSelectInput)
                    .attr("name", "__" + c + "__"), t = v("<div>")
                    .addClass("drop-container")
                    .addClass(o.clsDropContainer), c = v("<div>")
                    .appendTo(t), n = v("<ul>")
                    .addClass("option-list")
                    .addClass(o.clsDropList)
                    .css({
                        "max-height": o.dropHeight
                    }), i = v("<input type="text" data-role="input">")
                    .attr("placeholder", o.filterPlaceholder)
                    .appendTo(c), r.append(h), r.append(t), t.append(c), !0 !== o.filter && c.hide(), t.append(n), this._createOptions(), this._setPlaceholder(), m.makePlugin(t, "dropdown", {
                        dropFilter: ".select",
                        duration: o.duration,
                        toggleElement: [r],
                        ...
                        onDrop: function() {
                            ...
                            s.addClass("active-toggle"), e = v(".select .drop-container"), v.each(e, function() {
                                ...
                                .trigger(m.events.keyup), void 0 !== (e = 0 < n.find("li.active")
                                    .length ? v(n.find("li.active")[0]) : void 0) && (n[0].scrollTop = e.position()
                                    .top - (n.height() - e.height()) / 2), a._fireEvent("drop", {
                                    list: n[0]
                                })
                        },
                        onUp: function() {
                    ...
                    }), this.list = n, !0 !== o.clearButton || e[0].readOnly ? d.addClass("d-none") : v("<button>")
                    .addClass("button input-clear-button")
                    .addClass(o.clsClearButton)
                    .attr("tabindex", -1)
                    .attr("type", "button")
                    .html(o.clearButtonIcon)
                    .appendTo(d), "" === o.prepend || l || v("<div>")
                    .html(o.prepend)
                    .addClass("prepend")
                    .addClass(o.clsPrepend)
                    .appendTo(r), "" === o.append || l || v("<div>")
                    .html(o.append)
                    .addClass("append")
                    .addClass(o.clsAppend)
                    .appendTo(r), !0 === o.copyInlineStyles)
                    for (var p = 0, f = e[0].style.length; p < f; p++) r.css(e[0].style[p], e.css(e[0].style[p]));
                "rtl" === e.attr("dir") && r.addClass("rtl")
                    .attr("dir", "rtl"), o.label && (o = v("<label>")
                        .addClass("label-for-input")
                        .addClass(o.clsLabel)
                        .html(o.label)
                        .insertBefore(r), e.attr("id") && o.attr("for", e.attr("id")), "rtl" === e.attr("dir") && o.addClass("rtl")), e.is(":disabled") ? this.disable() : this.enable()
            },
            _createEvents: function() {
                var o = this,
                    r = this.element,
                ...
                i.on("focus", function() {
                    ...
                    r.val(l.emptyValue), r[0].multiple && (u.find("li")
                        .removeClass("d-none"), d.clear()), o._setPlaceholder(), e.preventDefault(), e.stopPropagation()
                }), r.on(m.events.change, function() {
                    o._setPlaceholder()
                }), e.on(m.events.click, function() {
                    v(".focused")
                        .removeClass("focused"), e.addClass("focused")
                }), d.on(m.events.click, function() {
                    v(".focused")
                        .removeClass("focused"), e.addClass("focused")
                }), u.on(m.events.click, "li", function(e) {
                    if (v(this)
                        .hasClass("group-title")) return e.preventDefault(), void e.stopPropagation();
                    var t = v(this),
                        n = t.data("value"),
                        i = t.data("group"),
                        s = t.children("a")
                        ...
                        a = t.data("option"),
                        e = r.find("option");
                    l.showGroupName && i && (s += "&nbsp;<span class="selected-item__group-name">" + i + "</span>"), r[0].multiple ? (t.addClass("d-none"), d.append(o._addTag(s, t))) : (u.find("li.active")
                        .removeClass("active")
                        .removeClass(l.clsOptionActive), t.addClass("active")
                        .addClass(l.clsOptionActive), d.html(s), m.getPlugin(c, "dropdown")
                        .close()), v.each(e, function() {
                    ...
                    for (var e = this.value.toUpperCase(), t = u.find("li"), n = 0; n < t.length; n++) v(t[n])
                        .hasClass("group-title") || (-1 < t[n].getElementsByTagName("a")[0].innerHTML.toUpperCase()
                            .indexOf(e) ? t[n].style.display = "" : t[n].style.display = "none")
            ...
            disable: function() {
                this.element.data("disabled", !0), this.element.closest(".select")
                    .addClass("disabled")
            },
            enable: function() {
                this.element.data("disabled", !1), this.element.closest(".select")
                    .removeClass("disabled")
            },
            toggleState: function() {
                this.elem.disabled ? this.disable() : this.enable()
            ...
            reset: function(e) {
                ...
                v.each(n, function() {
                    ...
                    .remove(), t.find(".select-input")
                    .html(""), this._createOptions(), t = this.getSelected(), this._fireEvent("change", {
                        selected: t
                    })
            },
            getSelected: function() {
            ...
            val: function(e) {
                ...
                v.each(d, function() {
                    ...
                    .removeClass(l.clsOptionActive), c.html(""), !1 === Array.isArray(e) && (e = [e]), v.each(e, function() {
                        for (n = 0; n < d.length; n++)
                            if (t = d[n], i = g.isValue(t.getAttribute("data-template")) ? t.getAttribute("data-template")
                                .replace("$1", t.text) : t.text, "" + t.value == "" + this) {
                                t.selected = !0;
                                break
                            } for (n = 0; n < u.length; n++)
                            if (s = v(u[n]), a = s.data("group"), "" + s.attr("data-value") == "" + this) {
                                l.showGroupName && a && (i += "&nbsp;<span class="selected-item__group-name">" + a + "</span>"), p ? (s.addClass("d-none"), c.append(o._addTag(i, s))) : (s.addClass("active")
                                    .addClass(l.clsOptionActive), c.html(i));
                                break
                            }
            ...
            data: function(e, t, n) {
                var i, s = this.element,
                    n = n || ",",
                    a = "string" == typeof t ? t.toArray(n)
                    .map(function(e) {
                        return +e
                    }) : Array.isArray(t) ? t.slice()
                    .map(function(e) {
                        return +e
                    }) : [];
                s.empty(), "string" == typeof e ? s.html(e) : g.isObject(e) && v.each(e, function(e, t) {
                    g.isObject(t) ? (i = v("<optgroup label>")
                        .attr("label", e)
                        .appendTo(s), v.each(t, function(e, t) {
                            t = v("<option>")
                                .attr("value", e)
                                .text(t)
                                .appendTo(i); - 1 < a.indexOf(+e) && t.prop("selected", !0)
                        })) : (t = v("</option><option>")
                        .attr("value", e)
                        .text(t)
                        .appendTo(s), -1 < a.indexOf(+e) && t.prop("selected", !0))
                }), this._createOptions()
            },
            changeAttribute: function(e) {
                "disabled" === e && this.toggleState()
            ...
            destroy: function() {
                ...
                return t.off(m.events.click), t.off(m.events.click, ".input-clear-button"), i.off(m.events.click), s.off(m.events.blur), s.off(m.events.focus), a.off(m.events.click, "li"), s.off(m.events.keyup), n.off(m.events.click), o.off(m.events.click), n.data("dropdown")
                    .destroy(), e
            }
        }), v(document)
        .on(m.events.click, function() {
            v(".select")
                .removeClass("focused")
        }, {
...
function(a, o) {
    ...
    a.sidebarSetup = function(e) {
        ...
        _create: function() {
            var e = this.element;
            this._createStructure(), this._createEvents(), o(window)
                .resize(), this._checkStatic(), this._fireEvent("sidebar-create", {
                    element: e
                })
        },
        _createStructure: function() {
            ...
            e.addClass("sidebar")
                .addClass("on-" + t.position), !1 === t.menuScrollbar && s.addClass("hide-scroll"), 290 !== t.size && (r.addCssRule(i, ".sidebar", "width: " + t.size + "px;"), "left" === t.position ? r.addCssRule(i, ".sidebar.on-left", "left: " + -t.size + "px;") : r.addCssRule(i, ".sidebar.on-right", "right: " + -t.size + "px;")), !0 === t.shadow && e.addClass("sidebar-shadow"), null !== t.toggle && 0 < o(t.toggle)
                .length && (this.toggle_element = o(t.toggle)), 0 < n.length && void 0 !== n.data("image") && n.css({
        ...
        _createEvents: function() {
            ...
            null !== i ? i.on(a.events.click, function(e) {
                ...
                .on("click", n.toggle, function(e) {
                    t.toggle(), e.stopPropagation()
                }), null !== n.static && -1 < ["fs", "sm", "md", "lg", "xl", "xxl"].indexOf(n.static) && o(window)
                .on(a.events.resize, function() {
                    t._checkStatic()
                }, {
                    ns: this.id
        ...
        _checkStatic: function() {
            var e = this.element,
                t = this.options;
            r.mediaExist(t.static) && !e.hasClass("static") && (e.addClass("static"), e.data("opened", !1)
                .removeClass("open"), null !== t.shift && o.each(t.shift.split(","), function() {
                    o(this)
                        .animate({
                            draw: {
                                left: 0
        ...
        open: function() {
            var e = this.element,
                t = this.options;
            e.hasClass("static") || (e.data("opened", !0)
                .addClass("open"), null !== t.shift && o(t.shift)
                .animate({
                    draw: {
                        left: e.outerWidth()
                    },
        ...
        close: function() {
            var e = this.element,
                t = this.options;
            e.hasClass("static") || (e.data("opened", !1)
                .removeClass("open"), null !== t.shift && o(t.shift)
                .animate({
                    draw: {
                        left: 0
                    },
        ...
        destroy: function() {
            ...
            return null !== n && n.off(a.events.click), null !== t.static && -1 < ["fs", "sm", "md", "lg", "xl", "xxl"].indexOf(t.static) && o(window)
                .off(a.events.resize, {
                    ns: this.id
        ...
        open: function(e) {
            this.isSidebar(e) && a.getPlugin(e, "sidebar")
                .open()
        },
        close: function(e) {
            this.isSidebar(e) && a.getPlugin(e, "sidebar")
        ...
        isOpen: function(e) {
            if (this.isSidebar(e)) return a.getPlugin(e, "sidebar")
                .isOpen()
        }
    }
}(Metro, m4q),
    ...
    u.sliderSetup = function(e) {
        ...
        _createSlider: function() {
            ...
            if (0 < n.size && (!0 === n.vertical ? a.outerHeight(n.size) : a.outerWidth(n.size)), !0 === n.vertical && a.addClass("vertical-slider"), 0 === i.length ? s.prepend(a) : a.insertAfter(i), !0 === n.hintAlways && d.css({
                ...
                .addClass("permanent-hint"), t.appendTo(a), o.appendTo(a), r.appendTo(a), l.appendTo(a), c.appendTo(a), d.appendTo(c), !0 === n.showMinMax && (c = h("<div>")
                    .addClass("slider-min-max")
                    .addClass(n.clsMinMax), h("<span>")
                    .addClass("slider-text-min")
                    .addClass(n.clsMin)
                    ...
                    .addClass(n.clsMax)
                    .html(n.max)
                    .appendTo(c), n.minMaxPosition === u.position.TOP ? c.insertBefore(a) : c.insertAfter(a)), !(t[0].className = "") === n.copyInlineStyles)
        ...
        _createEvents: function() {
            ...
            t.on(u.events.startAll, function() {
                    !0 === s.hint && !0 !== s.hintAlways && n.fadeIn(300), h(document)
                        .on(u.events.moveAll, function(e) {
        ...
        _convert: function(e, t) {
            var n = this.slider,
                i = this.options,
                s = (!0 === i.vertical ? n.outerHeight() : n.outerWidth()) - n.find(".marker")
                .outerWidth();
            switch (t) {
                case "pix2prc":
                    return 100 * e / s;
        ...
        _hint: function() {
            var e = this.options,
                ...
                n = +this.value || 0,
                i = +this.percent || 0;
            e.roundValue && (n = (o.isValue(n) ? +n : 0)
                .toFixed(o.decCount(e.accuracy)), i = (o.isValue(i) ? +i : 0)
                .toFixed(o.decCount(e.accuracy))), t.text(e.hintMask.replace("$1", n)
                .replace("$2", i))
        },
        _value: function() {
            var e = this.element,
                ...
                i = this.percent,
                s = this.buffer;
            t.roundValue && (n = (o.isValue(n) ? +n : 0)
                    .toFixed(o.decCount(t.accuracy)), i = (o.isValue(i) ? +i : 0)
                    .toFixed(o.decCount(t.accuracy)), s = (o.isValue(s) ? +s : 0)
                    .toFixed(o.decCount(t.accuracy))), "INPUT" === e[0].tagName && e.val(n), null === t.target || 0 !== (t = h(t.target))
                .length && h.each(t, function() {
                    var e = h(this);
...
function(n, o) {
    ...
    n.sorterSetup = function(e) {
        ...
        _createStructure: function() {
            var e = this.element,
                t = this.options;
            null === t.sortTarget && (t.sortTarget = e.children()[0].tagName), this.initial = e.find(t.sortTarget)
                .get(), !0 === t.sortStart && this.sort(t.sortDir)
        },
        _getItemContent: function(e) {
            var t, n, i, s, a = this.options;
            if (r.isValue(a.sortSource)) {
                if (t = "", 0 < (n = e.getElementsByClassName(a.sortSource))
                    .length)
            ...
            if (t = ("" + t)
                .toLowerCase()
                .replace(/[\n\r]+|[\s]{2,}/g, " ")
                .trim(), r.isValue(s)) switch (-1 === ["number", "int", "float", "money"].indexOf(s) || "," === a.thousandSeparator && "." === a.decimalSeparator || (t = r.parseNumber(t, a.thousandSeparator, a.decimalSeparator)), s) {
                case "date":
        ...
        sort: function(e) {
            var t, s = this,
                ...
                i = this.options,
                a = r.elementId("temp");
            void 0 !== e && (i.sortDir = e), 0 !== (e = n.find(i.sortTarget)
                    .get())
                .length && (t = o("<div>")
                    .attr("id", a)
                    .insertBefore(o(n.find(i.sortTarget)[0])), this._fireEvent("sort-start", {
                        items: e
                    }), e.sort(function(e, t) {
                    ...
                    }), "desc" === i.sortDir && e.reverse(), n.find(i.sortTarget)
                    .remove(), o.each(e, function() {
                        var e = o(this);
                        e.insertAfter(t), t = e
                    }), o("#" + a)
                    .remove(), this._fireEvent("sort-stop", {
                        items: e
                    }))
        },
        reset: function() {
            ...
            0 !== s.length && (t = o("<div>")
                .attr("id", i)
                .insertBefore(o(e.find(n.sortTarget)[0])), e.find(n.sortTarget)
                .remove(), o.each(s, function() {
                    var e = o(this);
                    e.insertAfter(t), t = e
                }), o("#" + i)
                .remove())
        ...
        changeAttribute: function(e) {
            ...
            switch (e) {
                case "data-sort-dir":
                    "" !== (n = s.attr("data-sort-dir")
                        .trim()) && (a.sortDir = n, i.sort());
                    break;
                case "data-sort-content":
                    "" !== (t = s.attr("data-sort-content")
                        .trim()) && (a.sortContent = t, i.sort())
            }
        },
        destroy: function() {
            return this.element
        ...
        sort: function(e, t) {
            ...
            void 0 === t && (t = "asc"), n.getPlugin(e, "sorter")
                .sort(t)
        },
        reset: function(e) {
            if (!this.isSorter(e)) return !1;
            n.getPlugin(e, "sorter")
                .reset()
        }
    }
}(Metro, m4q),
    ...
    i.spinnerSetup = function(e) {
            ...
            _createStructure: function() {
                var e = this.element,
                    ...
                    a = e.val()
                    .trim();
                o.isValue(a) || e.val(0), e[0].className = "", n.insertBefore(e), e.appendTo(n)
                    .addClass(t.clsSpinnerInput), e.addClass("original-input"), i.appendTo(n), s.appendTo(n), !0 === t.hideCursor && n.addClass("hide-cursor"), t.label && (n = c("<label>")
                        .addClass("label-for-input")
                        .addClass(t.clsLabel)
                        .html(t.label)
                        .insertBefore(n), e.attr("id") && n.attr("for", e.attr("id")), "rtl" === e.attr("dir") && n.addClass("rtl")), !0 === t.disabled || e.is(":disabled") ? this.disable() : this.enable()
            },
            _createEvents: function() {
                var a = this,
                    o = this.element,
                ...
                t.on(i.events.click, function(e) {
                    c(".focused")
                        .removeClass("focused"), t.addClass("focused"), e.preventDefault(), e.stopPropagation()
            ...
            changeAttribute: function(e) {
                ...
                switch (e) {
                    ...
                    case "value":
                        t = i.attr("value")
                            .trim(), o.isValue(t) && n._setValue(Number(t), !1)
                }
            },
            destroy: function() {
                var e = this.element,
...
function(t, p) {
    ...
    t.splitterSetup = function(e) {
        ...
        _createStructure: function() {
            var e, t, n = this.element,
                i = this.options,
                s = n.children(i.children)
                .addClass("split-block"),
                a = "horizontal" === i.splitMode ? "width" : "height";
            for (n.addClass("splitter"), "vertical" === i.splitMode.toLowerCase() && n.addClass("vertical"), e = 0; e < s.length - 1; e++) p("<div>")
                .addClass("gutter")
                .css(a, i.gutterSize)
                .insertAfter(p(s[e]));
            if (this._setSize(), f.isValue(i.minSizes))
                if (String(i.minSizes)
                    .contains(","))
                    for (t = i.minSizes.toArray(), e = 0; e < t.length; e++) p(s[e])
                        .data("min-size", t[e]), s[e].style.setProperty("min-" + a, String(t[e])
                            .contains("%") ? t[e] : String(t[e])
                            .replace("px", "") + "px", "important");
                else p.each(s, function() {
                    this.style.setProperty("min-" + a, String(i.minSizes)
                        .contains("%") ? i.minSizes : String(i.minSizes)
                        .replace("px", "") + "px", "important")
                });
        ...
        _setSize: function() {
            ...
            if (f.isValue(i.splitSizes))
                for (e = i.splitSizes.toArray(), t = 0; t < e.length; t++) p(s[t])
                    .css({
        ...
        _createEvents: function() {
            ...
            h.on(t.events.startAll, function(e) {
                    ...
                    i.addClass("active"), s.addClass("stop-pointer"), a.addClass("stop-pointer"), c._fireEvent("resize-start", {
                        ...
                        .on(t.events.stopAll, function(e) {
                            s.removeClass("stop-pointer"), a.removeClass("stop-pointer"), c._saveSize(), i.removeClass("active"), p(window)
                                .off(t.events.moveAll, {
                                    ns: c.id
                                }), p(window)
                                .off(t.events.stopAll, {
        ...
        destroy: function() {
            var e = this.element;
            return e.children(".gutter")
                .off(t.events.start), e
        }
    })
}(Metro, m4q),
function(i, a) {
    ...
    i.stepperSetup = function(e) {
        ...
        _create: function() {
            var e = this.element,
                t = this.options;
            t.step <= 0 && (t.step="1)," this._createstepper(), this._createevents(), this._fireevent("stepper-create", { element: e }) }, _createstepper: function() var e, t="this.element," n="this.options;" for (t.addclass("stepper") .addclass(n.view) .addclass(n.clsstepper), <="n.steps;" e++) a("<span>")
                .addClass("step")
                .addClass(n.clsStep)
                .data("step", e)
                .html("<span>" + e + "</span>")
        ...
        toStep: function(e) {
            var t = this.element,
                ...
                i = a(t.find(".step")
                    .get(e - 1)),
                s = this.current;
            0 !== i.length && (this.current = e, t.find(".step")
                .removeClass("complete current")
                .removeClass(n.clsCurrent)
                .removeClass(n.clsComplete), i.addClass("current")
                .addClass(n.clsCurrent), i.prevAll()
                .addClass("complete")
                .addClass(n.clsComplete), this._fireEvent("step", {
                    step: this.current,
                    prev: s
                }))
        },
    ...
    x.streamerSetup = function(e) {
        ...
        _create: function() {
            ...
            E("<div>")
                ...
                .appendTo(e), null !== n.source ? (this._fireEvent("data-load", {
                        source: n.source
                    }), E.json(n.source)
                    .then(function(e) {
                        t._fireEvent("data-loaded", {
                    ...
                    })) : (this.data = n.data, this.build()), !0 === n.chromeNotice && !0 === I.detectChrome() && !1 === E.touchable && E("<p>")
                .addClass("text-small text-muted")
                .html("*) In Chrome browser please press and hold Shift and turn the mouse wheel.")
                .insertAfter(e)
        },
        build: function() {
            var e, m = this,
            ...
            var r, w = o ? o.split("|")[0] : null,
                b = o ? o.split("|")[1].split(",") : [];
            void 0 !== t.actions && (r = E("<div>")
                .addClass("streamer-actions")
                .appendTo(n), E.each(t.actions, function() {
                    var e = this,
                        t = E("<button>")
            ...
            var l, c, d, u, h, p, f, y, _, S = new Date,
                T = new Date,
            ...
            for (S.setHours(i[0]), S.setMinutes(i[1]), S.setSeconds(0), T.setHours(o[0]), T.setMinutes(o[1]), T.setSeconds(0), l = S.getTime() / 1e3; l <= 10 t.gettime() 1e3; l +="k)" for (d="((c" = (f="new" date(1e3 * l)) .gethours()) < ? "0" c : c) ":" ((u="f.getMinutes())" u u), y="(f" e("<li>")
                        .data("time", d)
                        .addClass("js-time-point-" + d.replace(":", "-"))
                        .html("<em>" + d + "</em>")
                        .appendTo(C))
                    .width() / parseInt(t.timeline.step), e = E("<ul>")
                    .addClass("streamer-fake-timeline")
                    .html("")
                    .appendTo(f), h = 0; h < parseInt(t.timeline.step); h++) d = (c < 10 ? "0" + c : c) + ":" + ((p = u + h) < 10 ? "0" + p : p), E("<li>")
                    .data("time", d)
                    .addClass("js-fake-time-point-" + d.replace(":", "-"))
                    .html("|")
                    .appendTo(e)
                    .css({
                        width: y
            ...
            void 0 !== t.streams && E.each(t.streams, function(d) {
                    ...
                    e.addClass(this.cls)
                        .data("one", !1)
                        .data("data", this.data), E("<div>")
                        .addClass("stream-title")
                        .html(this.title)
                        .appendTo(e), E("<div>")
                        .addClass("stream-secondary")
                        .html(this.secondary)
                        .appendTo(e), E(this.icon)
                    ...
                    void 0 !== this.events && (E.each(this.events, function(e) {
                                ...
                                void 0 !== s.skip && I.bool(s.skip) || (n = E("<div>")
                                    .data("origin", s)
                                    .data("sid", o)
                                    .data("data", s.data)
                                    .data("time", s.time)
                                    ...
                                    .addClass("size-" + s.size + (["half", "one-third"].contains(s.size) ? "" : "x"))
                                    .addClass(s.cls)
                                    .appendTo(f), i = C.find(".js-fake-time-point-" + this.time.replace(":", "-"))
                                    .offset()
                                    .left - f.offset()
                                    .left, e = 75 * (a - 1), u < a && (u = a), n.css({
                                        position: "absolute",
                                        left: i,
                                        top: e
                                    }), I.isNull(s.html) ? (a = E("<div>")
                                        .addClass("stream-event-slide")
                                        .appendTo(n), i = E("<div>")
                                        .addClass("slide-logo")
                                        .appendTo(a), e = E("<div>")
                                        .addClass("slide-data")
                                        .appendTo(a), void 0 !== s.icon && (I.isTag(s.icon) ? E(s.icon)
                                            .addClass("icon") : E("<img>")
                                            .addClass("icon")
                                            .attr("src", s.icon))
                                        .appendTo(i), E("<span>")
                                        ...
                                        .addClass("desc")
                                        .html(s.desc)
                                        .appendTo(e), (!1 === g.closed && v.attr("id") === w && -1 !== b.indexOf(o) || !0 === s.selected || 1 === parseInt(s.selected)) && n.addClass("selected"), !0 === g.closed || !0 === s.closed || 1 === parseInt(s.closed) ? (t = void 0 !== s.closedIcon ? I.isTag(s.closedIcon) ? s.closedIcon : "<span>" + s.closedIcon + "</span>" : I.isTag(g.defaultClosedIcon) ? g.defaultClosedIcon : "<span>" + g.defaultClosedIcon + "</span>", E(t)
                                            .addClass("state-icon")
                                            .addClass(s.clsClosedIcon)
                                            .appendTo(a), n.data("closed", !0)
                                            .data("target", s.target), n.append(l)) : (t = void 0 !== s.openIcon ? I.isTag(s.openIcon) ? s.openIcon : "<span>" + s.openIcon + "</span>" : I.isTag(g.defaultOpenIcon) ? g.defaultOpenIcon : "<span>" + g.defaultOpenIcon + "</span>", E(t)
                                            .addClass("state-icon")
                                            .addClass(s.clsOpenIcon)
                                            .appendTo(a), n.data("closed", !1), n.append(c)), n.append(r)) : n.html(s.html), m._fireEvent("draw-event", {
                                        event: n[0]
                                    }))
                            }), 0 < (t = f.find(".stream-event")
                                .last())
                            .length && f.outerWidth(t[0].offsetLeft + t.outerWidth())), f.css({
                            height: 75 * u
                        }), v.find(".stream")
                        .eq(f.index())
                        .css({
                ...
                }), void 0 !== t.global && (_ = s.offset()
                    .left, E.each(["before", "after"], function() {
                        void 0 !== t.global[this] && E.each(t.global[this], function() {
                            var e = E("<div>")
                                .addClass("event-group")
                                .addClass("size-" + this.size + (["half", "one-third"].contains(this.size) ? "" : "x")),
                                t = E("<div>")
                    ...
                    })), v.data("stream", -1), v.find(".events-area")
                .scrollLeft(0), this.events = v.find(".stream-event"), this._createEvents(), null !== g.startFrom && !0 === g.slideToStart && setTimeout(function() {
        ...
        _createEvents: function() {
            var n = this,
                i = this.element,
                s = this.options;
            i.off(x.events.click, ".stream-event")
                .on(x.events.click, ".stream-event", function(e) {
                    var t = E(this);
                    "" !== s.excludeClass && t.hasClass(s.excludeClass) || null !== s.excludeElement && E(e.target)
                        .is(s.excludeElement) || (!1 === s.closed && !0 !== t.data("closed") && "select" === s.eventClick ? "" !== s.excludeSelectClass && t.hasClass(s.excludeSelectClass) || null !== s.excludeSelectElement && E(e.target)
                            .is(s.excludeSelectElement) || (t.hasClass("global-event") && !0 !== s.selectGlobal || t.toggleClass("selected"), !0 === s.changeUri && n._changeURI(), n._fireEvent("event-select", {
                                event: t[0],
                                selected: t.hasClass("selected")
                            })) : "" !== s.excludeClickClass && t.hasClass(s.excludeClickClass) || null !== s.excludeClickElement && E(e.target)
                            .is(s.excludeClickElement) || (n._fireEvent("event-click", {
                                event: t[0]
                            }), !0 !== s.closed && !0 !== t.data("closed") || (t = t.data("target")) && (window.location.href = t)))
                }), i.off(x.events.click, ".stream")
                .on(x.events.click, ".stream", function() {
                    var e = E(this),
                        t = e.index();
                    !1 !== s.streamSelect && (i.data("stream") === t ? (i.find(".stream-event")
                        .removeClass("disabled"), i.data("stream", -1)) : (i.data("stream", t), i.find(".stream-event")
                        .addClass("disabled"), n.enableStream(e), n._fireEvent("stream-select", {
                            stream: e
                        })), n._fireEvent("stream-click", {
                        stream: e
                    }))
                }), !0 === s.wheel && (i.find(".events-area")
                    .off(x.events.mousewheel)
                    .on(x.events.mousewheel, function(e) {
                        var t, n;
                ...
                .on("scroll", function() {
                    n._fireScroll()
                }), !0 === E.touchable && i.off(x.events.click, ".stream")
                .on(x.events.click, ".stream", function() {
                    var e = E(this);
        ...
        slideTo: function(e) {
            ...
            t.find(".events-area")
                .animate({
                    draw: {
                        scrollLeft: e[0].offsetLeft - t.find(".streams .stream")
                            .outerWidth()
                    },
                    dur: n.duration
                })
        ...
        enableStream: function(e) {
            ...
            e.removeClass("disabled")
                .data("streamDisabled", !1), t.find(".stream-events")
                .eq(n)
                .find(".stream-event")
                .removeClass("disabled")
        },
        disableStream: function(e) {
            var t = this.element,
                n = e.index() - 1;
            e.addClass("disabled")
                .data("streamDisabled", !0), t.find(".stream-events")
                .eq(n)
                .find(".stream-event")
                .addClass("disabled")
        },
        ...
        getEvents: function(e, t) {
            ...
            return E.each(n, function() {
                var e = E(this);
                !0 !== t && e.parent()
                    .hasClass("global-stream") || (e = e.data("origin"), s.push(e))
            }), s
        },
        source: function(e) {
            var t = this.element;
        ...
        toggleEvent: function(e) {
            var t = this.options;
            (e = E(e))
            .hasClass("global-event") && !0 !== t.selectGlobal || (e.hasClass("selected") ? this.selectEvent(e, !1) : this.selectEvent(e, !0))
        },
        selectEvent: function(e, t) {
            var n = this.options;
            void 0 === t && (t = !0), (e = E(e))
                .hasClass("global-event") && !0 !== n.selectGlobal || (!0 === t ? e.addClass("selected") : e.removeClass("selected"), !0 === n.changeUri && this._changeURI(), this._fireEvent("event-select", {
                    event: e[0],
                    selected: t
                }))
        },
        changeSource: function() {
            ...
            "" !== String(e)
                .trim() && (n.source = e, this._fireEvent("data-load", {
                        source: n.source
                    }), E.json(n.source)
                    .then(function(e) {
                        t._fireEvent("data-loaded", {
        ...
        changeStreamSelectOption: function() {
            var e = this.element;
            this.options.streamSelect = "true" === e.attr("data-stream-select")
                .toLowerCase()
        },
        changeAttribute: function(e) {
            switch (e) {
        ...
        destroy: function() {
            var e = this.element;
            return e.off(x.events.click, ".stream-event"), e.off(x.events.click, ".stream"), e.find(".events-area")
                .off(x.events.mousewheel), e.find(".events-area")
                .last()
                .off("scroll"), e
        }
    })
    ...
    e.switchSetup = function(e) {
        ...
        _create: function() {
            ...
            t.attr("type", "checkbox"), void 0 !== t.attr("readonly") && t.on("click", function(e) {
                ...
                .addClass((!0 === n.material ? " switch-material " : " switch ") + t[0].className)), i.appendTo(e), s.appendTo(e), t.attr("data-on") && i.attr("data-on", t.attr("data-on")), t.attr("data-off") && i.attr("data-off", t.attr("data-off")), !0 === n.transition && e.addClass("transition-on"), "left" === n.captionPosition && e.addClass("caption-left"), t[0].className = "", e.addClass(n.clsSwitch), s.addClass(n.clsCaption), i.addClass(n.clsCheck), t.is(":disabled") ? this.disable() : this.enable(), this._fireEvent("switch-create")
        },
        disable: function() {
            this.element.data("disabled", !0), this.element.parent()
                .addClass("disabled")
...
function(w, b) {
    ...
    var y = w.utils,
        n = {
            ...
            onSortStart: w.noop,
            onSortStop: w.noop,
            onSortItemSwitch: w.noop,
            onSearch: w.noop,
            onRowsCountChange: w.noop,
            onDataLoad: w.noop,
            onDataLoadError: w.noop,
            onDataLoaded: w.noop,
            onDataSaveError: w.noop,
            onFilterRowAccepted: w.noop,
            onFilterRowDeclined: w.noop,
            onCheckClick: w.noop,
            onCheckClickAll: w.noop,
            onCheckDraw: w.noop,
            onViewSave: w.noop,
            onViewGet: w.noop,
            onViewCreated: w.noop,
            onTableCreate: w.noop,
            onSkip: w.noop
        };
    w.tableSetup = function(e) {
        n = b.extend({}, n, e)
    }, window.metroTableSetup, w.tableSetup(window.metroTableSetup), w.Component("table", {
        init: function(e, t) {
            return this._super(t, e, n, {
                currentPage: 1,
                pagesCount: 1,
        ...
        _create: function() {
            var e, t, n = this,
                ...
                s = this.options,
                a = y.elementId("table");
            y.isValue(i.attr("id")) || i.attr("id", a), y.isValue(w.locales[s.locale]) && (this.locale = w.locales[s.locale]), y.isValue(s.searchFields) && (this.searchFields = s.searchFields.toArray()), y.isValue(s.head) && (t = s.head, s.head = y.isObject(s.head), s.head || (console.warn("Head " + t + " defined but not exists!"), s.head = null)), y.isValue(s.body) && (e = s.body, s.body = y.isObject(s.body), s.body || (console.warn("Body " + e + " defined but not exists!"), s.body = null)), !0 === s.static && (s.showPagination = !1, s.showRowsSteps = !1, s.showSearch = !1, s.showTableInfo = !1, s.showSkip = !1, s.rows = -1), (t = b("<div>")
                    .addClass("table-component"))
                .insertBefore(i), e = b("<div>")
                .addClass("table-container")
                .addClass(s.clsTableContainer)
                .appendTo(t), i.appendTo(e), !0 === s.horizontalScroll && e.addClass("horizontal-scroll"), !y.isNull(s.horizontalScrollStop) && y.mediaExist(s.horizontalScrollStop) && e.removeClass("horizontal-scroll"), t.addClass(s.clsComponent), this.activity = b("<div>")
                .addClass("table-progress")
                .appendTo(t), e = b("<div>")
                .appendTo(this.activity), w.makePlugin(e, "activity", {
                    type: s.activityType,
                    style: s.activityStyle
                    ...
                    source: s.source
                }), !1 !== (t = y.isObject(s.source)) && b.isPlainObject(t) ? n._build(t) : this.activity.show(function() {
                    b.json(s.source)
                        .then(function(e) {
        ...
        _build: function(e) {
            var t, n = this,
                ...
                s = this.options,
                a = i.attr("id");
            s.rows = parseInt(s.rows), this.items = [], this.heads = [], this.foots = [], Array.isArray(s.head) && (this.heads = s.head), Array.isArray(s.body) && (this.items = s.body), y.isValue(e) ? this._createItemsFromJSON(e) : this._createItemsFromHTML(), this._createIndex(), this.view = this._createView(), this.viewDefault = y.objectClone(this.view), t = s.viewSavePath.replace("$1", a), "client" === s.viewSaveMode.toLowerCase() ? (e = w.storage.getItem(t), y.isValue(e) && y.objectLength(e) === y.objectLength(this.view) && (this.view = e, this._fireEvent("view-get", {
                    source: "client",
                    view: e
                })), this._final()) : b.json(t, t !== s.viewSavePath ? null : {
                    id: a
                })
                .then(function(e) {
        ...
        _final: function() {
            var e = this.element,
                t = this.options,
                n = e.attr("id");
            w.storage.delItem(t.checkStoreKey.replace("$1", n)), this._service(), this._createStructure(), this._createInspector(), this._createEvents(), this._fireEvent("table-create", {
                element: e
            })
        },
        _service: function() {
        ...
        _createView: function() {
            var t = {};
            return b.each(this.heads, function(e) {
        ...
        _createInspectorItems: function(e) {
            ...
            for (b.each(o, function(e) {
                (n = b("<tr>"))
                .data("index", e), n.data("index-view", e), b("<td>")
                    .html("<input type="checkbox" data-style + s.checkstyle "" data-role="checkbox" name="column_show_check[]" value e " (y.bool(i.view[e].show) ? "checked" : "")>")
                    .appendTo(n), b("</td><td>")
                    .html(this.title)
                    .appendTo(n), b("</td><td>")
                    .html("<input type="number" data-role="spinner" name="column_size" value + i.view[e].size "" data-index e>")
                    .appendTo(n), b("</td><td>")
                    .html("<button class="button square js-table-inspector-field-up" type="button"><span class="mif-arrow-up"></span></button><button class="button square js-table-inspector-field-down" type="button"><span class="mif-arrow-down"></span></button>")
                    .appendTo(n), a[i.view[e]["index-view"]] = n
            }), t = 0; t < o.length; t++) a[t].appendTo(e)
        },
        _createInspector: function() {
            var e, t, n = this.options,
                i = b("<div data-role="draggable" data-drag-element=".table-inspector-header" data-drag-area="body">")
                .addClass("table-inspector");
            i.attr("for", this.element.attr("id")), b("<div class="table-inspector-header">" + n.inspectorTitle + "</div>")
                .appendTo(i), e = b("<div>")
                .addClass("table-wrap")
                .appendTo(i), t = b("<table>")
                .addClass("table subcompact"), n = b("<tbody>")
                .appendTo(t), t.appendTo(e), this._createInspectorItems(n), n = b("<div class="table-inspector-actions">")
                .appendTo(i), b("<button class="button primary js-table-inspector-save" type="button">")
                .html(this.locale.buttons.save)
                .appendTo(n), b("</button><button class="button secondary js-table-inspector-reset ml-2 mr-2" type="button">")
                .html(this.locale.buttons.reset)
                .appendTo(n), b("</button><button class="button link js-table-inspector-cancel place-right" type="button">")
                .html(this.locale.buttons.cancel)
                .appendTo(n), i.data("open", !1), this.inspector = i, b("body")
                .append(i), this._createInspectorEvents()
        },
        ...
        _createHeadsFromHTML: function() {
            ...
            0 < e.length && b.each(e.find("tr > *"), function() {
                var e = b(this),
                ...
                n = (n = (n = n.replace("sort-asc", ""))
                        .replace("sort-desc", ""))
                    .replace("hidden", ""), e = {
                        type: "data",
                        title: e.html(),
                        name: y.isValue(e.data("name")) ? e.data("name") : e.text()
                            .replace(" ", "_"),
        ...
        _createItemsFromJSON: function(e) {
            var t = this;
            "string" == typeof e && (e = JSON.parse(e)), void 0 !== e.header ? t.heads = e.header : this._createHeadsFromHTML(), void 0 !== e.data && b.each(e.data, function() {
                var e = [];
        ...
        _createTableHeader: function() {
            ...
            if (s.find("thead")
                .remove(), o.addClass(a.clsHead), 0 === this.heads.length) return o;
            for (t = b("<tr>")
                .addClass(a.clsHeadRow)
                .appendTo(o), b.each(this.service, function() {
                    var e = [];
                    i = b("<th>")
                        .appendTo(t), y.isValue(this.title) && i.html(this.title), y.isValue(this.size) && i.css({
                            width: this.size
                        }), y.isValue(this.cls) && e.push(this.cls), e.push(a.clsHeadCell), i.addClass(e.join(" "))
                }), n = this.heads, e = 0; e < n.length; e++) r[e] = null;
            for (b.each(n, function(e) {
                var t = this,
                    n = [];
                (i = b("</th><th>"))
                .data("index", e), y.isValue(t.title) && i.html(t.title), y.isValue(t.format) && i.attr("data-format", t.format), y.isValue(t.name) && i.attr("data-name", t.name), y.isValue(t.colspan) && i.attr("colspan", t.colspan), y.isValue(l[e].size) && i.css({
                    width: l[e].size
                }), !0 === t.sortable && (n.push("sortable-column"), y.isValue(t.sortDir) && n.push("sort-" + t.sortDir)), y.isValue(t.cls) && b.each(t.cls.toArray(), function() {
                    n.push(this)
        ...
        _createTableFooter: function() {
            var e, t, n = this.element,
                i = this.options,
                s = b("<tfoot>")
                .addClass(i.clsFooter);
            n.find("tfoot")
                .remove(), 0 !== this.foots.length && (e = b("<tr>")
                    .addClass(i.clsHeadRow)
                    .appendTo(s), b.each(this.foots, function() {
                        t = b("<th>")
                            .appendTo(e), void 0 !== this.title && t.html(this.title), void 0 !== this.name && t.addClass("foot-column-name-" + this.name), void 0 !== this.cls && t.addClass(this.cls), y.isValue(this.colspan) && t.attr("colspan", this.colspan), t.appendTo(e)
                    })), n.append(s)
        },
        _createTopBlock: function() {
            var n, t = this,
                ...
                s = b("<div>")
                .addClass("table-top")
                .addClass(i.clsTableTop)
                .insertBefore(e.parent()),
                a = y.isValue(this.wrapperSearch) ? this.wrapperSearch : b("<div>")
                .addClass("table-search-block")
                .addClass(i.clsSearch)
                .appendTo(s);
            return a.addClass(i.clsSearch), e = b("<input>")
                .attr("type", "text")
                .appendTo(a), w.makePlugin(e, "input", {
                    prepend: i.tableSearchTitle
                }), !0 !== i.showSearch && a.hide(), (a = y.isValue(this.wrapperRows) ? this.wrapperRows : b("<div>")
                    .addClass("table-rows-block")
                    .appendTo(s))
                .addClass(i.clsRowsCount), n = b("<select>")
                .appendTo(a), b.each(i.rowsSteps.toArray(), function() {
                    var e = parseInt(this),
                        t = b("<option>")
                        .attr("value", e)
                        .text(-1 === e ? i.allRecordsTitle : e)
                        .appendTo(n);
                    e === parseInt(i.rows) && t.attr("selected", "selected")
                }), w.makePlugin(n, "select", {
                    filter: !1,
                    prepend: i.tableRowsCountTitle,
                    onChange: function(e) {
                        (e = parseInt(e)) !== parseInt(i.rows) && (i.rows = e, t.currentPage = 1, t._draw(), t._fireEvent("rows-count-change", {
                            val: e
                        }))
                    }
        ...
        _createBottomBlock: function() {
            var e = this.element,
                ...
                .addClass(t.clsTableBottom)
                .insertAfter(e.parent()),
                e = y.isValue(this.wrapperInfo) ? this.wrapperInfo : b("<div>")
                .addClass("table-info")
                .appendTo(n);
            return e.addClass(t.clsTableInfo), !0 !== t.showTableInfo && e.hide(), (e = y.isValue(this.wrapperPagination) ? this.wrapperPagination : b("<div>")
                    .addClass("table-pagination")
                    .appendTo(n))
                .addClass(t.clsTablePagination), !0 !== t.showPagination && e.hide(), (e = y.isValue(this.wrapperSkip) ? this.wrapperSkip : b("<div>")
                    .addClass("table-skip")
                    .appendTo(n))
                .addClass(t.clsTableSkip), b("<input type="text">")
                .addClass("input table-skip-input")
                .addClass(t.clsTableSkipInput)
                .appendTo(e), b("<button>")
                .addClass("button table-skip-button")
                .addClass(t.clsTableSkipButton)
                .html(t.tableSkipTitle)
                .appendTo(e), !0 !== t.showSkip && e.hide(), n
        },
        _createStructure: function() {
            var t = this,
                e = this.element,
                ...
                s = b(n.infoWrapper),
                a = b(n.rowsWrapper),
                o = b(n.paginationWrapper),
                r = b(n.skipWrapper);
            0 < i.length && (this.wrapperSearch = i), 0 < s.length && (this.wrapperInfo = s), 0 < a.length && (this.wrapperRows = a), 0 < o.length && (this.wrapperPagination = o), 0 < r.length && (this.wrapperSkip = r), e.html("")
                .addClass(n.clsTable), this._createTableHeader(), this._createTableBody(), this._createTableFooter(), this._createTopBlock(), this._createBottomBlock();
            var l, c = !1;
            0 < this.heads.length && b.each(this.heads, function(e) {
                !c && -1 < ["asc", "desc"].indexOf(this.sortDir) && (c = !0, t.sort.colIndex = e, t.sort.dir = this.sortDir)
            }), c && (e = e.find("thead th"), this._resetSortClass(e), b(e.get(this.sort.colIndex + t.service.length))
                .addClass("sort-" + this.sort.dir), this.sorting()), y.isValue(n.filters) && "string" == typeof n.filters && b.each(n.filters.toArray(), function() {
        ...
        _createEvents: function() {
            var e, o = this,
                ...
                a = (r.skipWrapper ? b(r.skipWrapper) : n)
                .find(".table-skip-button"),
                l = (r.skipWrapper ? b(r.skipWrapper) : n)
                .find(".table-skip-input"),
                c = t.attr("id");
            a.on(w.events.click, function() {
                ...
                .on(w.events.resize, function() {
                    ...
                    ns: this.id
                }), t.on(w.events.click, ".sortable-column", function() {
                ...
                }), t.on(w.events.click, ".table-service-check input", function() {
                    var e = b(this),
                        t = e.is(":checked"),
                        n = "" + e.val(),
                        ...
                        s = w.storage,
                        a = s.getItem(i);
                    "radio" === e.attr("type") && (a = []), t ? y.isValue(a) ? -1 === Array(a)
                        .indexOf(n) && a.push(n) : a = [n] : y.isValue(a) ? y.arrayDelete(a, n) : a = [], s.setItem(i, a), o._fireEvent("check-click", {
                            check: this,
                            status: t,
                            data: a
                        })
                }), t.on(w.events.click, ".table-service-check-all input", function() {
                    var e = b(this)
                        .is(":checked"),
                        t = r.checkStoreKey.replace("$1", c),
                        n = [],
                        i = w.storage;
                    e ? b.each(o.filteredItems, function() {
            ...
            a = function() {
                o.searchString = this.value.trim()
                    .toLowerCase(), clearInterval(o.input_interval), o.input_interval = !1, o.input_interval || (o.input_interval = setTimeout(function() {
            ...
            s.on(w.events.inputchange, a), y.isValue(this.wrapperSearch) && 0 < (e = this.wrapperSearch.find("input"))
                .length && e.on(w.events.inputchange, a), n.on(w.events.click, ".pagination .page-link", function() {
                    d(this)
                }), y.isValue(this.wrapperPagination) && this.wrapperPagination.on(w.events.click, ".pagination .page-link", function() {
                    d(this)
                }), this._createInspectorEvents(), t.on(w.events.click, ".js-table-crud-button", function() {})
        },
        _createInspectorEvents: function() {
            var s = this,
                e = this.inspector;
            this._removeInspectorEvents(), e.on(w.events.click, ".js-table-inspector-field-up", function() {
                    var t, e = b(this)
                        .closest("tr"),
                        n = e.prev("tr"),
                        i = e.data("index");
                    0 !== n.length && (e.insertBefore(n), e.addClass("flash"), setTimeout(function() {
                        e.removeClass("flash")
                    }, 1e3), t = e.index(), e.data("index-view", t), s.view[i]["index-view"] = t, b.each(e.nextAll(), function() {
                        var e = b(this);
                        t++, e.data("index-view", t), s.view[e.data("index")]["index-view"] = t
                    }), s._createTableHeader(), s._draw())
                }), e.on(w.events.click, ".js-table-inspector-field-down", function() {
                    var t, e = b(this)
                        .closest("tr"),
                        n = e.next("tr"),
                        i = e.data("index");
                    0 !== n.length && (e.insertAfter(n), e.addClass("flash"), setTimeout(function() {
                        e.removeClass("flash")
                    }, 1e3), t = e.index(), e.data("index-view", t), s.view[i]["index-view"] = t, b.each(e.prevAll(), function() {
                        var e = b(this);
                        t--, e.data("index-view", t), s.view[e.data("index")]["index-view"] = t
                    }), s._createTableHeader(), s._draw())
                }), e.on(w.events.click, "input[type=checkbox]", function() {
                    var e = b(this),
                        t = e.is(":checked"),
                        n = e.val(),
                        e = ["cls", "clsColumn"];
                ...
                }), e.find("input[type=number]")
                .on(w.events.inputchange, function() {
                    var e = b(this),
                        t = e.attr("data-index"),
                        e = parseInt(e.val());
                    s.view[t].size = 0 === e ? "" : e, s._createTableHeader()
                }), e.on(w.events.click, ".js-table-inspector-save", function() {
                    s._saveTableView(), s.openInspector(!1)
                }), e.on(w.events.click, ".js-table-inspector-cancel", function() {
                    s.openInspector(!1)
                }), e.on(w.events.click, ".js-table-inspector-reset", function() {
                    s.resetView()
                })
        },
        _removeInspectorEvents: function() {
            var e = this.inspector;
            e.off(w.events.click, ".js-table-inspector-field-up"), e.off(w.events.click, ".js-table-inspector-field-down"), e.off(w.events.click, "input[type=checkbox]"), e.off(w.events.click, ".js-table-inspector-save"), e.off(w.events.click, ".js-table-inspector-cancel"), e.off(w.events.click, ".js-table-inspector-reset"), e.find("input[type=number]")
                .off(w.events.inputchange)
        },
        ...
        _info: function(e, t, n) {
            ...
            0 !== i.length && (n < t && (t = n), 0 === this.items.length && (e = t = n = 0), s = (s = (s = (s = s.tableInfoTitle)
                        .replace("$1", e))
                    .replace("$2", t))
                .replace("$3", n), i.html(s))
        },
        _paging: function(e) {
            ...
            this.pagesCount = Math.ceil(e / n.rows), w.pagination({
                length: e,
                rows: n.rows,
                current: this.currentPage,
        ...
        _filter: function() {
            var o = this,
                ...
                e = y.isValue(this.searchString) && o.searchString.length >= r.searchMinLength || 0 < this.filters.length ? this.items.filter(function(n) {
                    ...
                    return 0 < o.searchFields.length ? b.each(o.heads, function(e, t) {
                            -1 < o.searchFields.indexOf(t.name) && (s += "•" + n[e])
                        }) : s = n.join("•"), s = s.replace(/[\n\r]+|[\s]{2,}/g, " ")
                        .trim()
                        .toLowerCase(), t = !(y.isValue(o.searchString) && o.searchString.length >= r.searchMinLength) || ~s.indexOf(o.searchString), (e = e && t) ? o._fireEvent("filter-row-accepted", {
                            row: n
                    ...
                    for (t = f; t <= m; t++) if (o="c[t]," r="[]," y.isvalue(o)) { for ((i="b(" <tr">")
                            ...
                            for (b.each(o, function(e) {
                                ...
                                y.isValue(d.heads[e].template) && (t = d.heads[e].template.replace(/%VAL%/g, t)), n.html(t), n.addClass(h.clsBodyCell), y.isValue(d.heads[e].clsColumn) && n.addClass(d.heads[e].clsColumn), !1 === y.bool(g[e].show) && n.addClass("hidden"), y.bool(g[e].show) && n.removeClass("hidden"), n.data("original", this), r[g[e]["index-view"]] = n, d._fireEvent("draw-cell", {
                                    ...
                                    head: d.heads[e],
                                    items: o
                                }), !0 === h.cellWrapper && (t = b("<div>")
                                    .addClass("data-wrapper")
                                    .addClass(h.clsCellWrapper)
                                    .html(n.html()), n.html("")
                                    .append(t))
                            ...
                            d._fireEvent("draw-row", {
                                ...
                                .addClass(l ? h.clsEvenRow : h.clsOddRow)
                                .appendTo(p), d._fireEvent("append-row", {
                                    tr: i
                                })
                        }
                } else n = 0, b.each(g, function() {
                        this.show && n++
                    }), !0 === h.check && n++, !0 === h.rownum && n++, i = b("<tr>")
                    .addClass(h.clsBodyRow)
                    .appendTo(p), (s = b("<td>")
                        .attr("colspan", n)
                        .addClass("text-center")
                        .html(b("<span>")
                            .addClass(h.clsEmptyTableTitle)
                            .html(h.emptyTableTitle)))
                    .appendTo(i);
        ...
        _getItemContent: function(e) {
            var t = this.options,
                ...
                e = (this.heads && this.heads[this.sort.colIndex] && this.heads[this.sort.colIndex].thousandSeparator ? this.heads[this.sort.colIndex] : t)
                .thousandSeparator,
                t = (this.heads && this.heads[this.sort.colIndex] && this.heads[this.sort.colIndex].decimalSeparator ? this.heads[this.sort.colIndex] : t)
                .decimalSeparator,
                a = ("" + n)
                .toLowerCase()
                .replace(/[\n\r]+|[\s]{2,}/g, " ")
        ...
        search: function(e) {
            return this.searchString = e.trim()
                .toLowerCase(), this.currentPage = 1, this._draw(), this
        },
        _rebuild: function(e) {
            var t = this,
                n = this.element,
                i = !1;
            this._createIndex(), !0 === e && (this.view = this._createView()), this._createTableHeader(), this._createTableBody(), this._createTableFooter(), 0 < this.heads.length && b.each(this.heads, function(e) {
                !i && -1 < ["asc", "desc"].indexOf(this.sortDir) && (i = !0, t.sort.colIndex = e, t.sort.dir = this.sortDir)
            }), i && (n = n.find(".sortable-column"), this._resetSortClass(n), b(n.get(t.sort.colIndex))
                .addClass("sort-" + t.sort.dir), this.sorting()), t.currentPage = 1, t._draw()
        },
        setHeads: function(e) {
        ...
        getSelectedItems: function() {
            var e = this.element,
                t = this.options,
                n = w.storage.getItem(t.checkStoreKey.replace("$1", e.attr("id"))),
                i = [];
            return y.isValue(n) ? (b.each(this.items, function() {
        ...
        getStoredKeys: function() {
            var e = this.element,
                t = this.options;
            return w.storage.getItem(t.checkStoreKey.replace("$1", e.attr("id")), [])
        },
        clearSelected: function(e) {
            var t = this.element,
                n = this.options;
            w.storage.setItem(n.checkStoreKey.replace("$1", t.attr("id")), []), t.find("table-service-check-all input")
                .prop("checked", !1), !0 === e && this._draw()
        },
        getFilters: function() {
            return this.filters
        },
        ...
        openInspector: function(e) {
            ...
            e ? t.show(0, function() {
                    t.css({
                            top: (b(window)
                                .height() - t.outerHeight(!0)) / 2 + pageYOffset,
                            left: (b(window)
                                .width() - t.outerWidth(!0)) / 2 + pageXOffset
                        })
                        .data("open", !0)
                }) : t.hide()
                .data("open", !1)
        ...
        export: function(e, t, n, i) {
            var s, a, o, r, l, c, d, u, h = w.export,
                p = this,
                f = this.options,
            ...
            if ("function" == typeof h.tableToCSV) {
                for (t = y.isValue(t) ? t.toLowerCase() : "all-filtered", n = y.isValue(n) ? n : y.elementId("table") + "-export.csv", l = b("<tr>"), o = this.heads, a = 0; a < o.length; a++) C[a] = null;
                for (b.each(o, function(e) {
                    !1 !== y.bool(p.view[e].show) && (c = b("<th>"), y.isValue(this.title) && c.html(this.title), C[p.view[e]["index-view"]] = c)
                }), a = 0; a < o.length; a++) y.isValue(C[a]) && C[a].appendTo(l);
                for (l.appendTo(v), u = "checked" === t ? (d = 0, (r = this.getSelectedItems())
                    .length - 1) : "view" === t ? (r = this._filter(), d = -1 === parseInt(f.rows) ? 0 : f.rows * (this.currentPage - 1), -1 === parseInt(f.rows) ? r.length - 1 : d + f.rows - 1) : "all" === t ? (d = 0, (r = this.items)
                    .length - 1) : (d = 0, (r = this._filter())
                    .length - 1), s = d; s <= u; s++) if (y.isvalue(r[s])) { for (l="b(" <tr">"), o = r[s], a = 0; a < o.length; a++) C[a] = null;
                        for (b.each(o, function(e) {
                            !1 !== y.bool(p.view[e].show) && (c = b("<td>")
                                .html(this), C[p.view[e]["index-view"]] = c)
                        }), a = 0; a < o.length; a++) y.isValue(C[a]) && C[a].appendTo(l);
                        l.appendTo(g)
        ...
        destroy: function() {
            var e = this.element,
                ...
                i = t.find("select");
            return n.data("input")
                .destroy(), i.data("select")
                .destroy(), b(window)
                .off(w.events.resize, {
                    ns: this.id
                }), e.off(w.events.click, ".sortable-column"), e.off(w.events.click, ".table-service-check input"), e.off(w.events.click, ".table-service-check-all input"), n.off(w.events.inputchange), !y.isValue(this.wrapperSearch) || 0 < (n = this.wrapperSearch.find("input"))
                .length && n.off(w.events.inputchange), t.off(w.events.click, ".pagination .page-link"), y.isValue(this.wrapperPagination) && this.wrapperPagination.off(w.events.click, ".pagination .page-link"), e.off(w.events.click, ".js-table-crud-button"), this._removeInspectorEvents(), e
        }
    })
}(Metro, m4q),
function(t, d) {
    ...
    t.materialTabsSetup = function(e) {
        ...
        _createStructure: function() {
            var e = this.element,
                ...
                i = e.find("li.active"),
                s = d("<div>")
                .addClass("tabs-material-wrapper")
                .addClass(t.clsComponent)
                .insertBefore(e);
            !0 === t.appBar && s.addClass("app-bar-present"), "more" === t.appBar && s.addClass("app-bar-present-more"), e.appendTo(s), e.addClass("tabs-material")
                .addClass(t.clsTabs), n.addClass(t.clsTab), !0 === t.deep && e.addClass("deep"), !0 === t.fixedTabs && e.addClass("fixed-tabs"), this.marker = e.find(".tab-marker"), 0 === this.marker.length && (this.marker = d("<span>")
                    .addClass("tab-marker")
                    .addClass(t.clsMarker)
                    .appendTo(e)), this.openTab((0 === i.length ? n : i)[0])
        },
        _createEvents: function() {
            var s = this,
                a = this.element,
        ...
        openTab: function(e, t) {
            ...
            e = d(e), d.each(c, function() {
                    var e = d(this)
                        .find("a")
                        .attr("href");
                    u.isValue(e) && "#" === e[0] && 1 < e.length && d(e)
                        .hide()
                }), i = r.width(), o = r.scrollLeft(), n = (a = e.position()
                    .left) + (s = e.width()), c.removeClass("active")
                .removeClass(l.clsTabActive), e.addClass("active")
                .addClass(l.clsTabActive), o = i + o < n + 52 ? o + 104 : a < o ? a - 104 : o, r.animate({
                    draw: {
                        scrollLeft: o
                    },
                    dur: l.duration
                ...
                .attr("href"), u.isValue(l) && "#" === l[0] && 1 < l.length && d(l)
                .show(), this._fireEvent("tab-open", {
                    tab: e[0],
                    target: l,
                    tab_next: t
                })
...
function(r, l) {
    ...
    r.tabsSetup = function(e) {
        ...
        _create: function() {
            var e = this.element,
                t = 0 < e.find(".active")
                .length ? l(e.find(".active")[0]) : void 0;
        ...
        _createStructure: function() {
            var e, t = this.element,
                ...
                s = i.hasClass("tabs"),
                i = s ? i : l("<div>")
                .addClass("tabs tabs-wrapper");
            if (i.addClass(n.tabsPosition.replace(["-", "_", "+"], " ")), t.addClass("tabs-list"), "default" !== n.tabsType && t.addClass("tabs-" + n.tabsType), s || (i.insertBefore(t), t.appendTo(i)), t.data("expanded", !1), s = l("<div>")
                .addClass("expand-title"), i.prepend(s), 0 === (e = i.find(".hamburger"))
                .length) {
                e = l("<button>")
                    .attr("type", "button")
                    .addClass("hamburger menu-down")
                    .appendTo(i);
                for (var a = 0; a < 3; a++) l("<span>")
                    .addClass("line")
                    .appendTo(e);
                !0 === r.colors.isLight(c.getStyleOne(i, "background-color")) && e.addClass("dark")
            }
            i.addClass(n.clsTabs), t.addClass(n.clsTabsList), t.children("li")
                .addClass(n.clsTabsListItem), (!0 === n.expand && !n.tabsPosition.contains("vertical") || c.isValue(n.expandPoint) && c.mediaExist(n.expandPoint) && !n.tabsPosition.contains("vertical")) && i.addClass("tabs-expand"), n.tabsPosition.contains("vertical") && i.addClass("tabs-expand")
        },
        _createEvents: function() {
            var i = this,
                s = this.element,
            ...
            l(window)
                .on(r.events.resize, function() {
                    ...
                    !1 === s.data("expanded") ? (s.addClass("expand"), s.data("expanded", !0), o.find(".hamburger")
                        .addClass("active")) : (s.removeClass("expand"), s.data("expanded", !1), o.find(".hamburger")
                        .removeClass("active"))
                    ...
                    var t = l(this),
                        ...
                        .trim(),
                        t = t.parent("li");
                    if (t.hasClass("active") && e.preventDefault(), !0 === s.data("expanded") && (s.removeClass("expand"), s.data("expanded", !1), o.find(".hamburger")
                        .removeClass("active")), !0 !== c.exec(a.onBeforeTab, [t, s], t[0])) return !1;
        ...
        _open: function(e) {
            ...
            0 !== i.length && (this._collectTargets(), void 0 === e && (e = l(i[0])), void 0 !== (t = e.find("a")
                .attr("href")) && (i.removeClass("active")
                .removeClass(n.clsTabsListItemActive), (e.parent()
                    .hasClass("d-menu") ? e.parent()
                    .parent() : e)
                .addClass("active"), l.each(this._targets, function() {
                    var e = l(this);
                    0 < e.length && e.hide()
                }), "#" !== t && "#" === t[0] && l(t)
                .show(), s.html(e.find("a")
                    .html()), e.addClass(n.clsTabsListItemActive), this._fireEvent("tab", {
                    tab: e[0]
                })))
        },
        next: function() {
            var e = this.element.find("li.active")
                .next("li");
...
function(l, c) {
    ...
    l.tagInputSetup = function(e) {
        ...
        _create: function() {
            this.triggers = ("" + this.options.tagTrigger)
                .toArray(","), (this.triggers.contains("Space") || this.triggers.contains("Spacebar")) && (this.triggers.push(" "), this.triggers.push("Spacebar")), this.triggers.contains("Comma") && this.triggers.push(","), this._createStructure(), this._createEvents(), this._fireEvent("tag-input-create", {
                    element: this.element
                })
        },
        _createStructure: function() {
            var e = this,
                ...
                .trim(),
                s = c("<div>")
                .addClass("tag-input " + t[0].className)
                .addClass(n.clsComponent)
                .insertBefore(t);
            t.appendTo(s), s.addClass("input-" + n.size), t[0].className = "", t.addClass("original-input"), c("<input type="text">")
                .addClass("input-wrapper")
                .addClass(n.clsInput)
                .attr("size", 1)
                .appendTo(s), !1 === n.clearButton || t[0].readOnly || (s.addClass("padding-for-clear"), c("<button>")
                    .addClass("button input-clear-button")
                    .attr("tabindex", -1)
                    .attr("type", "button")
                    ...
                    .addClass(n.clsLabel)
                    .html(n.label)
                    .insertBefore(s), t.attr("id") && i.attr("for", t.attr("id")), "rtl" === t.attr("dir") && i.addClass("rtl")), t.is(":disabled") ? this.disable() : this.enable(), !0 !== n.static && void 0 === t.attr("readonly") || s.addClass("static-mode")
        },
        _createEvents: function() {
            var i = this,
                s = this.element,
            ...
            o.on(l.events.focus, function() {
                ...
                o.attr("size", Math.ceil(o.val()
                    .length / 2) + 2)
            }), o.on(l.events.keydown, function(e) {
                var t = o.val()
                    .trim(),
                    n = e.key;
                "Enter" === n && e.preventDefault(), !0 !== a.backspace || "Backspace" !== n || 0 !== t.length ? "" !== t && i.triggers.contains(n) && (i._fireEvent("tag-trigger", {
                    key: n
                }), o.val(""), i._addTag(t), o.attr("size", 1)) : 0 < i.values.length && (i.values.splice(-1, 1), s.siblings(".tag")
                    .last()
                    .remove(), s.val(i.values.join(a.tagSeparator)))
        ...
        _addTag: function(e) {
            ...
            o.hasClass("input-large") ? t = "large" : o.hasClass("input-small") && (t = "small"), 0 < a.maxTags && this.values.length === a.maxTags || "" !== ("" + e)
                .trim() && d.exec(a.onBeforeTagAdd, [e, this.values], s[0]) && ((i = c("<span>")
                        .addClass("tag")
                        .addClass(t)
                        .addClass(a.clsTag)
                        .insertBefore(r))
                    .data("value", e), (a.static || o.hasClass("static-mode") || s.readonly || s.disabled || o.hasClass("disabled")) && i.addClass("static"), n = c("<span>")
                    .addClass("title")
                    .addClass(a.clsTagTitle)
                    .html(e), t = c("<span>")
                    .addClass("remover")
                    .addClass(a.clsTagRemover)
                    .html("&times;"), n.appendTo(i), t.appendTo(i), !0 === a.randomColor && (o = (r = l.colors.colors(l.colors.PALETTES.ALL))[c.random(0, r.length - 1)], n = l.colors.darken(o, 15), r = l.colors.isDark(o) ? "#ffffff" : "#000000", i.css({
                        backgroundColor: o,
                        color: r
                    }), t.css({
                        backgroundColor: n,
        ...
        val: function(e) {
            var t = this,
                ...
                n = [];
            return d.isValue(e) ? (this.values = [], s.find(".tag")
                .remove(), "string" == typeof e ? n = ("" + e)
                .toArray(i.tagSeparator) : Array.isArray(e) && (n = e), c.each(n, function() {
                    t._addTag(this)
                }), this) : this.tags()
        },
        append: function(e) {
            ...
            return "string" == typeof e ? i = ("" + e)
                .toArray(n.tagSeparator) : Array.isArray(e) && (i = e), c.each(i, function() {
                    t._addTag(this)
                }), this
        },
        clear: function() {
            ...
            return this.values = [], e.val("")
                .trigger("change"), t.find(".tag")
                .remove(), this
        },
        disable: function() {
            this.element.data("disabled", !0), this.element.parent()
        ...
        changeAttribute: function(e) {
            ...
            switch (e) {
                case "value":
                    t = i.attr("value")
                        .trim(), n.clear(), d.isValue(t) && n.val(t.toArray(s.tagSeparator));
                    break;
                case "disabled":
                    this.toggleState();
                    break;
...
function(e, u) {
    ...
    function i(e, t, n) {
        ...
        for (h.isValue(n) && (u.hasProp(n, "beginToken") && (o = o.replace("<%", n.begintoken)), u.hasprop(n, "endtoken") && (o="o.replace(" %">", n.endToken))), a = (i = new RegExp(o, "g"))
            .exec(e); a;) d(e.slice(c, a.index))(a[1], !0), c = a.index + a[0].length, a = i.exec(e);
        d(e.substr(c, e.length - c)), l = (l + 'return r.join(""); }')
            .replace(/[\r\t\n]/g, " ");
        try {
            s = new Function("obj", l)
                .apply(t, [t])
        } catch (e) {
    ...
    e.templateSetup = function(e) {
        ...
        _compile: function() {
            var e = this.element,
                t = this.template.replace(/(&lt;%)/gm, "<%") .replace( (%&gt;) gm, "%>")
    ...
    o.textareaSetup = function(e) {
        ...
        _createStructure: function() {
            var e, t, n = this,
                ...
                a = this.options,
                o = d("<div>")
                .addClass("textarea " + i[0].className),
                r = d("<textarea>")
                .addClass("fake-textarea");
            if (o.insertBefore(i), i.appendTo(o), r.appendTo(o), !1 === a.clearButton || i[0].readOnly || (e = d("</textarea><button>")
                    .addClass("button input-clear-button")
                    .attr("tabindex", -1)
                    .attr("type", "button")
                    .html(a.clearButtonIcon))
                .appendTo(o), "rtl" === i.attr("dir") && o.addClass("rtl")
                .attr("dir", "rtl"), "" !== a.prepend && d("<div>")
                .html(a.prepend)
                .addClass("prepend")
                .addClass(a.clsPrepend)
                .appendTo(o), "" !== a.append && ((t = d("<div>")
                        .html(a.append))
                    .addClass("append")
                    .addClass(a.clsAppend)
                    .appendTo(o), e.css({
                        right: t.outerWidth() + 4
                    })), !(s.className = "") === a.copyInlineStyles)
                for (var l = 0, c = s.style.length; l < c; l++) o.css(s.style[l], i.css(s.style[l]));
            u.isValue(a.defaultValue) && "" === i.val()
                .trim() && i.val(a.defaultValue), o.addClass(a.clsComponent), i.addClass(a.clsTextarea), a.label && (t = d("<label>")
                    .addClass("label-for-input")
                    .addClass(a.clsLabel)
                    .html(a.label)
                    .insertBefore(o), i.attr("id") && t.attr("for", i.attr("id")), "rtl" === i.attr("dir") && t.addClass("rtl")), i.is(":disabled") ? this.disable() : this.enable(), r.val(i.val()), !0 === a.autoSize && (o.addClass("autosize no-scroll-vertical"), setTimeout(function() {
                    n.resize()
                }, 100))
        },
        _createEvents: function() {
            ...
            i.on(o.events.click, ".input-clear-button", function() {
                t.val(u.isValue(n.defaultValue) ? n.defaultValue : "")
                    .trigger("change")
                    .trigger("keyup")
                    .focus()
        ...
        toDefault: function() {
            this.element.val(u.isValue(this.options.defaultValue) ? this.options.defaultValue : "")
                .trigger("change")
                .trigger("keyup")
                .focus()
        },
        ...
        destroy: function() {
            var e = this.element,
                t = this.options;
            return e.closest(".textarea")
                .off(o.events.click, ".input-clear-button"), t.autoSize && e.off(o.events.inputchange + " " + o.events.keyup), e.off(o.events.blur), e.off(o.events.focus), e.off(o.events.keyup), e
        }
    })
}(Metro, m4q),
function(d, u) {
    ...
    d.tileSetup = function(e) {
        ...
        _createTile: function() {
            ...
            if (a.addClass("tile-" + n.size), -1 < n.effect.indexOf("hover-") && (a.addClass("effect-" + n.effect), u.each(t, function() {
                ...
                a.addClass("image-set"), u.each(a.children("img"), function() {
                    s.images.push(this), u(this)
                        .remove()
                });
                for (var i = this.images.slice(), o = 0; o < 5; o++) {
                    var r = u.random(0, i.length - 1),
                        l = u("<div>")
                        .addClass("img -js-img-" + o)
                        .css("background-image", "url(" + i[r].src + ")");
        ...
        _runEffects: function() {
            ...
            !1 === this.effectInterval && (this.effectInterval = u.setInterval(function() {
                ...
                n.currentSlide++, n.currentSlide === n.slides.length && (n.currentSlide = 0), e = n.slides[n.currentSlide], h.includes(i.effect) && d.animations[i.effect.camelCase()](u(t), u(e), {
...
function(i, c) {
    ...
    i.timePickerSetup = function(e) {
            ...
            _create: function() {
                var e, t = this.element,
                    n = this.options;
                for (n.distance < 1 && (n.distance = 1), n.hoursStep < 1 && (n.hoursStep = 1), 23 < n.hoursStep && (n.hoursStep = 23), n.minutesStep < 1 && (n.minutesStep = 1), 59 < n.minutesStep && (n.minutesStep = 59), n.secondsStep < 1 && (n.secondsStep = 1), 59 < n.secondsStep && (n.secondsStep = 59), "" !== t.val() || d.isValue(n.value) || (n.value = (new Date)
                        .format("%H:%M:%S")), this.value = ("" !== t.val() ? t.val() : "" + n.value)
                    .toArray(":"), e = 0; e < 3; e++) void 0 === this.value[e] || null === this.value[e] ? this.value[e] = 0 : this.value[e] = parseInt(this.value[e]);
            ...
            _createStructure: function() {
                var e, t, n, i, s, a = this.element,
                    o = this.options,
                    r = d.elementId("time-picker"),
                    l = c("<div>")
                    .attr("id", r)
                    .addClass("wheel-picker time-picker " + a[0].className)
                    .addClass(o.clsPicker);
                if (l.insertBefore(a), a.attr("readonly", !0)
                    .appendTo(l), o.label && (s = c("<label>")
                        .addClass("label-for-input")
                        .addClass(o.clsLabel)
                        .html(o.label)
                        .insertBefore(l), a.attr("id") && s.attr("for", a.attr("id")), "rtl" === a.attr("dir") && s.addClass("rtl")), r = c("<div>")
                    .addClass("time-wrapper")
                    .appendTo(l), !0 === o.hours && (e = c("<div>")
                        .attr("data-title", this.locale.time.hours)
                        .addClass("hours")
                        .addClass(o.clsPart)
                        .addClass(o.clsHours)
                        .appendTo(r)), !0 === o.minutes && (t = c("<div>")
                        .attr("data-title", this.locale.time.minutes)
                        .addClass("minutes")
                        .addClass(o.clsPart)
                        .addClass(o.clsMinutes)
                        .appendTo(r)), !0 === o.seconds && (n = c("<div>")
                    ...
                    .appendTo(l), r = c("<div>")
                    .addClass("select-block")
                    .appendTo(s), !0 === o.hours) {
                    for (e = c("<ul>")
                        .addClass("sel-hours")
                        .appendTo(r), i = 0; i < o.distance; i++) c("<li>")
                        .html("&nbsp;")
                        .data("value", -1)
                        .appendTo(e);
                    for (i = 0; i < 24; i += o.hoursStep) c("</li><li>")
                        .addClass("js-hours-" + i)
                        .html(i < 10 ? "0" + i : i)
                        .data("value", i)
                        .appendTo(e);
                    for (i = 0; i < o.distance; i++) c("</li><li>")
                        .html("&nbsp;")
                        .data("value", -1)
                        .appendTo(e)
                }
                if (!0 === o.minutes) {
                    for (t = c("<ul>")
                        ...
                        .data("value", -1)
                        .appendTo(t);
                    for (i = 0; i < 60; i += o.minutesStep) c("</li><li>")
                ...
                if (!0 === o.seconds) {
                    for (n = c("<ul>")
                        ...
                        .data("value", -1)
                        .appendTo(n);
                    for (i = 0; i < 60; i += o.secondsStep) c("</li><li>")
                ...
                if (r.height(40 * (2 * o.distance + 1)), s = c("<div>")
                    .addClass("action-block")
                    .appendTo(s), c("<button>")
                    .attr("type", "button")
                    .addClass("button action-ok")
                    ...
                    .html(o.okButtonIcon)
                    .appendTo(s), c("</button><button>")
                    .attr("type", "button")
                    .addClass("button action-cancel")
                    .addClass(o.clsButton)
                    .addClass(o.clsCancelButton)
                    .html(o.cancelButtonIcon)
                    .appendTo(s), !(a[0].className = "") === o.copyInlineStyles)
                    for (i = 0; i < a[0].style.length; i++) l.css(a[0].style[i], a.css(a[0].style[i]));
            ...
            _createEvents: function() {
                ...
                o.on(i.events.start, ".select-block ul", function(e) {
                    var t, n;
                    e.changedTouches || (t = this, n = d.pageXY(e)
                        .y, c(document)
                        .on(i.events.move, function(e) {
                            t.scrollTop -= a.scrollSpeed * (n > d.pageXY(e)
                                    .y ? -1 : 1), n = d.pageXY(e)
                                .y
                        }, {
                            ns: o.attr("id")
                        }), c(document)
                        .on(i.events.stop, function() {
                            c(document)
                                .off(i.events.move, {
                                    ns: o.attr("id")
                                }), c(document)
                    ...
                    i.on("scroll", function() {
                        s.isOpen && (s.listTimer[n] && (clearTimeout(s.listTimer[n]), s.listTimer[n] = null), s.listTimer[n] || (s.listTimer[n] = setTimeout(function() {
                            ...
                            s.listTimer[n] = null, t = Math.round(Math.ceil(i.scrollTop()) / 40), t = (e = i.find(".js-" + n + "-" + t))
                                .position()
                                .top - 40 * a.distance, i.find(".active")
                                .removeClass("active"), i[0].scrollTop = t, e.addClass("active"), d.exec(a.onScroll, [e, i, o], i[0])
                        }, 150)))
                    })
                })
            },
            _set: function() {
                var e = this.element,
                    ...
                    s = "00",
                    a = "00";
                !0 === t.hours && ((i = parseInt(this.value[0])) < 10 && (i = "0" + i), n.find(".hours")
                        .html(i)), !0 === t.minutes && ((s = parseInt(this.value[1])) < 10 && (s = "0" + s), n.find(".minutes")
                        .html(s)), !0 === t.seconds && ((a = parseInt(this.value[2])) < 10 && (a = "0" + a), n.find(".seconds")
                        .html(a)), e.val([i, s, a].join(":"))
                    .trigger("change"), this._fireEvent("set", {
                        val: this.value,
                        elementVal: e.val()
                    })
            ...
            open: function() {
                ...
                o.parent()
                    .removeClass("for-top for-bottom"), o.show(0), a.removeClass("active"), e = d.inViewport(o[0]), a = d.rect(o[0]), !e && 0 < a.top && o.parent()
                    .addClass("for-bottom"), !e && a.top < 0 && o.parent()
                    .addClass("for-top");
                a = function(e, t) {
                    e.scrollTop(0)
                        .animate({
                            draw: {
                                scrollTop: t.position()
                                    .top - 40 * i.distance + e.scrollTop()
                            },
                            dur: 100
                        })
                };
                !0 === i.hours && (t = parseInt(this.value[0]), t = (o = s.find(".sel-hours"))
                    .find("li.js-hours-" + t)
                    .addClass("active"), a(o, t)), !0 === i.minutes && (n = parseInt(this.value[1]), n = (t = s.find(".sel-minutes"))
                    .find("li.js-minutes-" + n)
                    .addClass("active"), a(t, n)), !0 === i.seconds && (n = parseInt(this.value[2]), n = (s = s.find(".sel-seconds"))
                    .find("li.js-seconds-" + n)
                    .addClass("active"), a(s, n)), this.isOpen = !0, this._fireEvent("open", {
                    val: this.value
                })
            },
            close: function() {
                this.picker.find(".select-wrapper")
                    .hide(0), this.isOpen = !1, this._fireEvent("close", {
                        val: this.value
                    })
            },
...
function(e, r) {
    ...
    var c = {
        create: function(e, t) {
            ...
            r.isPlainObject(t) || (t = o[4], s = o[1], i = o[2], a = o[3]), t = r.extend({}, l, t), e = (n = r("<div>")
                    .addClass("toast")
                    .html(e)
                    .appendTo(r("body")))
                .outerWidth(), n.hide(), i = i || t.timeout, s = s || t.callback, a = a || t.clsToast, !0 === t.showTop ? n.addClass("show-top")
                .css({
                    top: t.distance
                }) : n.css({
                    bottom: t.distance
...
function(e, r) {
    ...
    e.tokenizerSetup = function(e) {
        ...
        _create: function() {
            var e = this.element,
                t = this.options;
            this.originalText = t.textToTokenize ? t.textToTokenize.trim() : e.text()
                .trim()
                .replace(/[\r\n\t]/gi, "")
                .replace(/\s\s+/g, " "), this._createStructure(), this._fireEvent("tokenizer-create")
        },
        _tokenize: function() {
            var n, i = this,
                s = this.element,
                ...
                o = 0;
            s.clear()
                .attr("aria-label", this.originalText), r.each(this.originalText.split(a.splitter), function(e) {
                    var t = " " === this,
                        e = r("<" + a.tokenelement ">")
                        .html(t ? a.spaceSymbol : this)
                        .attr("aria-hidden", !0)
                        .addClass(t ? a.spaceClass : "")
                        .addClass(t && a.useTokenSymbol ? "" : "ts-" + this.replace(" ", "_"))
                        .addClass(t && a.useTokenIndex ? "" : "ti-" + (e + 1))
                        .addClass(a.tokenClass || "")
                        .addClass(t ? "" : a.clsToken);
                    t || (o++, e.addClass(o % 2 == 0 ? "te-even" : "te-odd"), e.addClass(o % 2 == 0 ? a.clsTokenEven : a.clsTokenOdd)), a.prepend && (n = r.isSelector(a.prepend) ? r(a.prepend) : r("<span>")
                        .html(a.prepend), e.prepend(n)), a.append && (n = r.isSelector(a.append) ? r(a.append) : r("<span>")
                        .html(a.append), e.append(n)), s.append(e), i._fireEvent("token-create", {
                        token: e[0]
                    })
...
function(r, l) {
    ...
    r.touchSetup = function(e) {
        ...
        touchStart: function(e) {
            var t = this.element,
                n = this.options;
            if (!(this.getTouchInProgress() || 0 < l(e.target)
                .closest(n.excludedElements)
                .length)) {
                var i, s = e,
                    a = s.touches,
                    o = a ? a[0] : s;
        ...
        validateDoubleTap: function() {
            ...
            return this.hasDoubleTap() && e - this.doubleTapStartTime <= this.options.doubletapthreshold }, indoubletap: function() { return this.validatedoubletap() validatetap: (1="==" this.fingercount || !d.supports_touch) && (isnan(this.distance) this.distance < this.options.threshold) validatelongtap: var e="this.options;" this.duration> e.longTapThreshold && this.distance < d.DOUBLE_TAP_THRESHOLD
        },
        didTap: function() {
        ...
        inMultiFingerRelease: function() {
            var e = !1;
            return this.previousTouchEndTime && this.getTimeStamp() - this.previousTouchEndTime <= 0 1 45 135 315 this.options.fingerreleasethreshold && (e="!0)," e }, gettouchinprogress: function() { return !0="==" this.element.data("intouch") settouchinprogress: function(e) var t="this.element;" (!0="==" ? (t.on(this.move_ev, l.proxy(this.touchmove, this)), t.on(this.end_ev, l.proxy(this.touchend, this.leave_ev t.on(this.leave_ev, l.proxy(this.touchleave, this))) : (t.off(this.move_ev), t.off(this.end_ev), t.off(this.leave_ev)), t.data("intouch", e)) createfingerdata: function(e, t) n="{" start: x: 0, y: last: end: } }; n.start.x="n.last.x" = n.end.x="t.pageX" || t.clientx, n.start.y="n.last.y" n.end.y="t.pageY" t.clienty, this.fingerdata[e]="n" updatefingerdata: !="=" e.identifier null="==" (n="this.createFingerData(t," e)), n.last.x="n.end.x," n.last.y="n.end.y," e.clientx, e.clienty, getfingerdata: setmaxdistance: d.none (t="Math.max(t," this.getmaxdistance(e)), this.maximumsmap[e].distance="t)" getmaxdistance: this.maximumsmap[e] void createmaximumsdata: e[d.left]="this.createMaximumVO(d.LEFT)," e[d.right]="this.createMaximumVO(d.RIGHT)," e[d.up]="this.createMaximumVO(d.UP)," e[d.down]="this.createMaximumVO(d.DOWN)," createmaximumvo: direction: e, distance: calculateduration: this.endtime - this.starttime calculatetouchesdistance: t.x), t.y); math.round(math.sqrt(n * + t)) calculatepinchzoom: 100) .tofixed(2) calculatepinchdirection: this.pinchzoom < d.out d.in calculatedistance: math.round(math.sqrt(math.pow(t.x e.x, 2) math.pow(t.y e.y, 2))) calculateangle: t.x, n), math.pi); math.abs(n)), calculatedirection: if (this.comparepoints(e, d.none; t); d.left d.right d.down d.up gettimestamp: (new date) .gettime() getbounds: l(e)) .offset(); left: t.left, right: t.left e.outerwidth(), top: t.top, bottom: t.top e.outerheight() isinbounds: e.x> t.left && e.x < t.right && e.y > t.top && e.y < t.bottom
        },
    ...
    t.treeViewSetup = function(e) {
        ...
        _create: function() {
            ...
            this._createTree(), this._createEvents(), a.each(t.find("input"), function() {
                a(this)
                    .is(":checked") && e._recheck(this)
            }), this._fireEvent("tree-view-create", {
                element: t
            })
        },
        _createIcon: function(e) {
            var t = o.isTag(e) ? a(e) : a("<img src alt>")
                .attr("src", e),
                e = a("<span>")
                .addClass("icon");
            return e.html(t.outerHTML()), e
        ...
        _createTree: function() {
            ...
            e.addClass("treeview"), a.each(t, function() {
                var e = a(this),
                    t = e.data("caption"),
                    n = e.data("icon");
                void 0 !== t && (0 < e.children("ul")
                        .length && !0 === s.showChildCount && (t += " (" + e.children("ul")
                            .children("li")
                            .length + ")"), e.prepend(i._createCaption(t))), void 0 !== n && e.prepend(i._createIcon(n)), 0 < e.children("ul")
                    .length && (e.addClass("tree-node"), e.append(i._createToggle()), !0 !== o.bool(e.attr("data-collapsed")) ? e.addClass("expanded") : e.children("ul")
                        .hide())
            })
        },
        _createEvents: function() {
        ...
        _recheck: function(e) {
            var t, n = this.element,
                ...
                .is(":checked"),
                s = e.closest("li");
            this.current(s), (e = e.closest("li")
                    .find("ul input[type=checkbox]"))
                .attr("data-indeterminate", !1), e.prop("checked", i), e.trigger("change"), t = [], a.each(n.find("input[type=checkbox]"), function() {
                    t.push(this)
        ...
        current: function(e) {
            ...
            t.find("li")
                .removeClass("current"), e.addClass("current")
        },
        toggleNode: function(e) {
            var t = a(e),
                n = this.options,
        ...
        addTo: function(e, t) {
            var n, i = this.element;
            return null === e ? n = i : 0 === (n = (e = a(e))
                    .children("ul"))
                .length && (n = a("<ul>")
                    .appendTo(e), this._createToggle()
                    .appendTo(e), e.addClass("expanded")), (t = this._createNode(t))
                .appendTo(n), this._fireEvent("node-insert", {
                    node: t[0],
                    parent: e ? e[0] : null
                }), t
        },
        ...
        del: function(e) {
            ...
            this._fireEvent("node-delete", {
                    node: e[0]
                }), e.remove(), 0 !== n.children()
                .length || n.is(t) || (n.remove(), i.removeClass("expanded"), i.children(".node-toggle")
                    .remove())
        },
        clean: function(e) {
            (e = a(e))
...
function(s, d) {
    ...
    var u = s.utils,
        h = {
            ...
            length: function(e, t) {
                return Array.isArray(e) ? e.length === parseInt(t) : !(!u.isValue(t) || isNaN(t) || t <= 0) && e.trim() .length="==" parseint(t) }, minlength: function(e, t) { return array.isarray(e) ? e.length>= parseInt(t) : !(!u.isValue(t) || isNaN(t) || t <= 0) && e.trim() .length>= parseInt(t)
            },
            maxlength: function(e, t) {
                return Array.isArray(e) ? e.length <= parseint(t) : !(!u.isvalue(t) || isnan(t) t <="0)" && e.trim() .length }, min: function(e, t) { return isnan(t)) (!!this.number(e) (!isnan(e) number(e)>= Number(t)))
            },
            max: function(e, t) {
                return !(!u.isValue(t) || isNaN(t)) && (!!this.number(e) && (!isNaN(e) && Number(e) <= 0 1 number(t))) }, email: function(e) { return ^[a-z0-9\u007f-\uffff!#$%&'*+\="?^_`{|}~-]+(?:\.[a-z0-9\u007f-\uffff!#$%&'*+\" =?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z]{2,}$ i.test(e) domain: ^((xn--)?[a-z0-9]+(-[a-z0-9]+)*\.)+[a-z]{2,}$ .test(e) url: ^(?:(?:https?|ftp):\ \ )(?:\s+(?::\s*)?@)?(?:(?!(?:10|127)(?:\.\d{1,3}){3})(?!(?:169\.254|192\.168)(?:\.\d{1,3}){2})(?!172\.(?:1[6-9]|2\d|3[0-1])(?:\.\d{1,3}){2})(?:[1-9]\d?|1\d\d|2[01]\d|22[0-3])(?:\.(?:1?\d{1,2}|2[0-4]\d|25[0-5])){2}(?:\.(?:[1-9]\d?|1\d\d|2[0-4]\d|25[0-4]))|(?:(?:[a-z\u00a1-\uffff0-9]-*)*[a-z\u00a1-\uffff0-9]+)(?:\.(?:[a-z\u00a1-\uffff0-9]-*)*[a-z\u00a1-\uffff0-9]+)*(?:\.(?:[a-z\u00a1-\uffff]{2,}))\.?)(?::\d{2,5})?(?:[ ?#]\s*)?$ date: function(e, t, n) u.isnull(t) ? "invalid date" !="=" string(new date(e)) .tolowercase() : string(e.todate(t, n)) number: !isnan(e) integer: u.isint(e) float: u.isfloat(e) digits: ^\d+$ hexcolor: (^#[0-9a-f]{6}$)|(^#[0-9a-f]{3}$) color: !!u.isvalue(e) && (!1 s.colors.color(e, s.colors.palettes.standard) || s.colors.iscolor(s.colors.parse(e))) pattern: t) (!!u.isvalue(t) new regexp(t) .test(e)) compare: e="==" t not: notequals: !u.isnull(e) (!u.isnull(t) e.trim() t.trim()) equals: custom: !1 u.isfunc(t) u.exec(t, [e]) is_control: e.parent() .hasclass("input") .hasclass("select") .hasclass("textarea") .hasclass("checkbox") .hasclass("switch") .hasclass("radio") .hasclass("spinner") reset_state: (h.is_control(e) e) .removeclass("invalid valid") set_valid_state: .addclass("valid") set_invalid_state: .addclass("invalid") reset: var d.each(d(e) .find("[data-validate]"), function() t.reset_state(this) }), this validate: i, n, s) a="!0," o="d(e)," r="void" o.data("validate") string(o.data("validate")) .split(" ") .map(function(e) }) [], l="[]," c="0" < o.closest("form") .length; r.length (this.reset_state(o), o.attr("type") "checkbox"="==" (a="-1" =="=" r.indexof("required") o.is(":checked")) l.push("required"), void i (i.val +="a" 1)) "radio"="==" (e="o.attr(" name")," e.replace("[", "\\[") .replace("]", "\\]") "]:checked"), e.length, d.each(r, e, n; (n="(e" this.split("="))[0], e.shift(), e = e.join(" ="), -1 ["compare", "equals", "notequals"].indexof(n) o[0].form.elements[e].value d("[name=" + e + " ]") .val()), "date"="==" n u.isfunc(h[n]) (!0 s "required" ""="==" o.val() .trim() h[n](o.val(), t))) l.push(n), (this.set_invalid_state(o), i.log.push({ input: o[0], name: o.attr("name"), value: o.val(), funcs: r, errors: u.exec(n, [o, o.val()], o[0])) (this.set_valid_state(o), o[0])), a) } }; s.validator="h;" validatordeferred: 0, submittimeout: 200, interactivecheck: !1, clearinvalid: requiredmode: !0, userequiredclass: onbeforesubmit: s.noop_true, onsubmit: s.noop, onerror: onvalidate: onerrorform: onvalidateform: onvalidatorcreate: s.noop s.validatorsetup="function(e)" window.metrovalidatorsetup, s.validatorsetup(window.metrovalidatorsetup), s.component("validator", "validator", init: this._super(t, _onsubmit: null, _onreset: result: [] _create: t.attr("novalidate", "novalidate"), d.each(i, - e.data("validate") .indexof("required") !0="==" n.userequiredclass .addclass("required"), n.interactivecheck e.on(s.events.inputchange, h.validate(this, n.requiredmode) this._onsubmit="null," (this._onreset="null)" t[0].onsubmit (this._onsubmit="t[0].onsubmit," null t[0].onreset e._submit() e._reset() this._fireevent("validator-create", element: _reset: h.reset(this.element), u.exec(this._onsubmit, this.element[0]) _submit: button[type="submit]" )," val: log: a.length a.attr("disabled", "disabled") .addclass("disabled"), d.each(s, o, n.onvalidate, n.onerror, a.removeattr("disabled") .removeclass("disabled"), o.val u.exec(n.onbeforesubmit, [r], this.elem) (this._fireevent("validate-form", data: settimeout(function() u.exec(n.onsubmit, i), t.fire("formsubmit", e._onsubmit u.exec(e._onsubmit, i) n.submittimeout)) (this._fireevent("error-form", o.log, n.clearinvalid .removeclass("invalid") n.clearinvalid)), changeattribute: {} }(metro, m4q), m) "use strict"; duration: 4e3, animationduration: transitionduration: transition: "fade", animation: slides: shuffle: align: "center", valign: loop: autoplay: mute: cover: preload: timer: overlay: 2, volume: 1, onplay: e.noop, onpause: onend: onwalk: onnext: onprev: onjump: onvegascreate: e.noop e.vegassetup="function(e)" s, window.metrovegassetup, e.vegassetup(window.metrovegassetup), e.component("vegas", videocache: {}, this.transitions="[" fade"," "fade2", "slideleft", "slideleft2", "slideright", "slideright2", "slideup", "slideup2", "slidedown", "slidedown2", "zoomin", "zoomin2", "zoomout", "zoomout2", "swirlleft", "swirlleft2", "swirlright", "swirlright2"], this.animations="[" kenburns"," "kenburnsup", "kenburnsdown", "kenburnsright", "kenburnsleft", "kenburnsupleft", "kenburnsupright", "kenburnsdownleft", "kenburnsdownright"], this.support="{" objectfit: "objectfit" in document.body.style, video: (android|webos|phone|ipad|ipod|blackberry|windows phone) i.test(navigator.useragent) slide: total: noshow: paused: ended: first: timeout: this.slides="a.isObject(this.options.slides)" this.total="this.slides.length," this.noshow="this.total" this.paused="!this.options.autoplay" this.noshow, this.options.shuffle this.slides.shuffle(), this.options.preload this._preload(), this._createstructure(), this._createevents(), this._fireevent("vegas-create", _createstructure: n[0].tagname; (n.css("height", n.css("height")), class="vegas-wrapper">')
                .css("overflow", n.css("overflow"))
                .css("padding", n.css("padding")), n.css("padding") || e.css("padding-top", n.css("padding-top"))
                .css("padding-bottom", n.css("padding-bottom"))
                .css("padding-left", n.css("padding-left"))
                .css("padding-right", n.css("padding-right")), n.children()
                .appendTo(e), n.clear()), n.addClass("vegas-container"), s || n.append(e), i.timer && (this.timer = m('<div class="vegas-timer"><div class="vegas-timer-progress">'), n.append(this.timer)), i.overlay && (this.overlay = m('<div class="vegas-overlay">')
                .addClass("overlay" + ("boolean" == typeof i.overlay || isNaN(i.overlay) ? 2 : +i.overlay)), n.append(this.overlay)), setTimeout(function() {
        ...
        _preload: function() {
            for (var e = 0; e < this.slides.length; e++) {
                var t = this.slides[e];
                t.src && ((new Image)
                    .src = this.slides[e].src), t.video && (t.video instanceof Array ? this._video(t.video) : this._video(t.video.src))
            }
        },
        _slideShow: function() {
            var e = this,
        ...
        _timer: function(e) {
            var t = this,
                n = this.options;
            clearTimeout(this.timeout), this.timer && (this.timer.removeClass("vegas-timer-running")
                .find("div")
                .css("transition-duration", "0ms"), this.ended || this.paused || this.noshow || e && setTimeout(function() {
                    t.timer.addClass("vegas-timer-running")
                        .find("div")
                        .css("transition-duration", +n.duration - 100 + "ms")
                }, 100))
        },
        ...
        _video: function(e) {
            ...
            return this.videoCache[i] || (Array.isArray(e) || (e = [e]), (t = document.createElement("video"))
                .preload = !0, e.forEach(function(e) {
                    (n = document.createElement("source"))
                    .src = e, t.appendChild(n)
                }), this.videoCache[i] = t)
        },
        _goto: function(e) {
            var t, n, i, s = this,
            ...
            function f() {
                s._timer(!0), setTimeout(function() {
                    u.css("transition", "all " + c + "ms")
                        .addClass("vegas-transition-" + r + "-out"), u.each(function() {
                            var e = u.find("video")
                                .get(0);
                            e && (e.volume = 1, s._fadeSoundOut(e, c))
                        }), t.css("transition", "all " + c + "ms")
                        .addClass("vegas-transition-" + r + "-in");
                    for (var e = 0; e < u.length - 1; e++) u.eq(e)
                        .remove();
                    s._fireEvent("walk", {
                        slide: s.current(!0)
                    }), s._slideShow()
            ...
            this.first && (this.first = !1), "repeat" !== p && (!0 === p ? p = "cover" : !1 === p && (p = "contain")), r = "random" === o.transition ? m.random(this.transitions) : o.transition || this.transitions[0], l = "random" === o.animation ? m.random(this.animations) : o.animation || this.animations[0], c = !o.transitionDuration || "auto" === o.transitionDuration || +o.transitionDuration > +o.duration ? +o.duration : +o.transitionDuration, d = !o.animationDuration || "auto" === o.animationDuration || +o.animationDuration > +o.duration ? +o.duration : +o.animationDuration, t = m("<div>")
                .addClass("vegas-slide")
                .addClass("vegas-transition-" + r), this.support.video && h.video ? ((n = h.video instanceof Array ? this._video(h.video) : this._video(h.video.src))
                    .loop = h.video.loop || o.loop, n.muted = h.video.mute || o.mute, n.muted ? n.pause() : this._fadeSoundIn(n, c), e = m(n)
                    .addClass("vegas-video")
                    .css("background-color", o.color || "#000000"), this.support.objectFit ? e.css("object-position", o.align + " " + o.valign)
                    .css("object-fit", p)
                    .css("width", "100%")
                    .css("height", "100%") : "contain" === p && e.css("width", "100%")
                    .css("height", "100%"), t.append(e)) : (i = new Image, o = m("<div>")
                    .addClass("vegas-slide-inner")
                    .css({
                        backgroundImage: 'url("' + h.src + '")',
                        backgroundColor: o.color || "#000000",
                        backgroundPosition: o.align + " " + o.valign
                    }), "repeat" === p ? o.css("background-repeat", "repeat") : o.css("background-size", p), l && o.addClass("vegas-animation-" + l)
                    .css("animation-duration", d + "ms"), t.append(o)), u.length ? u.eq(u.length - 1)
                .after(t) : a.prepend(t), u.css("transition", "all 0ms")
                .each(function() {
        ...
        destroy: function() {
            var e = this.element,
                t = this.options;
            return clearTimeout(this.timeout), e.removeClass("vegas-container"), e.find("> .vegas-slide")
                .remove(), e.find("> .vegas-wrapper")
                .children()
                .appendTo(e), e.find("> .vegas-wrapper")
                .remove(), t.timer && this.timer.remove(), t.overlay && this.overlay.remove(), e[0]
        }
    })
}(Metro, m4q),
function(u, h) {
    ...
    u.videoPlayerSetup = function(e) {
        ...
        _createPlayer: function() {
            var e = this.element,
                ...
                n = this.video,
                i = h("<div>")
                .addClass("media-player video-player " + e[0].className),
                s = h("<div>")
                .addClass("preloader")
                .appendTo(i),
                a = h("<a>")
            ...
            i.insertBefore(e), e.appendTo(i), h.each(["muted", "autoplay", "controls", "height", "width", "loop", "poster", "preload"], function() {
                    ...
                    type: "cycle",
                    style: "color"
                }), s.hide(), this.preloader = s, "" !== t.logo && h("<img>")
                .css({
                    height: t.logoHeight,
                    width: t.logoWidth
                })
                .attr("src", t.logo)
                .appendTo(a), null !== t.src && this._setSource(t.src), e[0].className = "", this.player = i
        },
        _setSource: function(e) {
            var t = this.element;
            t.find("source")
                .remove(), t.removeAttr("src"), Array.isArray(e) ? h.each(e, function() {
                    void 0 !== this.src && h("<source>")
                        .attr("src", this.src)
                        .attr("type", void 0 !== this.type ? this.type : "")
                        .appendTo(t)
                }) : t.attr("src", e)
        ...
        _createControls: function() {
            ...
            !0 !== i.showInfo && d.hide(), u.makePlugin(r, "slider", {
                ...
                }), this.volume = c, !0 !== i.showVolume && l.hide(), !0 === i.showLoop && (e = h("<button>")
                    .attr("type", "button")
                    .addClass("button square loop")
                    .html(i.loopIcon)
                    .appendTo(a)), !0 === i.showPlay && h("</button><button>")
                .attr("type", "button")
                .addClass("button square play")
                .html(i.playIcon)
                .appendTo(a), !0 === i.showStop && h("</button><button>")
                .attr("type", "button")
                .addClass("button square stop")
                .html(i.stopIcon)
                .appendTo(a), !0 === i.showMute && h("</button><button>")
                .attr("type", "button")
                .addClass("button square mute")
                .html(i.muteIcon)
                .appendTo(a), !0 === i.showFull && h("</button><button>")
                .attr("type", "button")
                .addClass("button square full")
                .html(i.screenMoreIcon)
                .appendTo(a), !0 === i.loop && (e.addClass("active"), n.attr("loop", "loop")), this._setVolume(), i.muted && (t.volumeBackup = s.volume, u.getPlugin(t.volume, "slider")
                    .val(0), s.volume = 0), d.html("00:00 / 00:00")
        },
        _createEvents: function() {
            var t = this,
                n = this.element,
            ...
            n.on("loadstart", function() {
                    ...
                    var e = Math.round(100 * s.currentTime / t.duration);
                    t._setInfo(s.currentTime, t.duration), u.getPlugin(t.stream, "slider")
                        .val(e), o.exec(i.onTime, [s.currentTime, t.duration, s, a], n[0])
                }), n.on("waiting", function() {
                    t.preloader.show()
                }), n.on("loadeddata", function() {}), n.on("play", function() {
                    a.find(".play")
                        .html(i.pauseIcon), o.exec(i.onPlay, [s, a], n[0]), t._onMouse()
                }), n.on("pause", function() {
                    a.find(".play")
                        .html(i.playIcon), o.exec(i.onPause, [s, a], n[0]), t._offMouse()
                }), n.on("stop", function() {
                    u.getPlugin(t.stream, "slider")
                    ...
                    t.fullscreen = !t.fullscreen, a.find(".full")
                        .html(!0 === t.fullscreen ? i.screenLessIcon : i.screenMoreIcon), i.fullScreenMode === u.fullScreenMode.WINDOW ? !0 === t.fullscreen ? a.addClass("full-screen") : a.removeClass("full-screen") : !0 === t.fullscreen ? (u.requestFullScreen(s), !1 === t.fullScreenInterval && (t.fullScreenInterval = setInterval(function() {
                            !1 === u.inFullScreen() && (t.fullscreen = !1, clearInterval(t.fullScreenInterval), t.fullScreenInterval = !1, a.find(".full")
                                .html(i.screenMoreIcon))
                        }, 1e3))) : u.exitFullScreen()
                }), h(window)
                .on(u.events.keyup, function(e) {
                    t.fullscreen && 27 === e.keyCode && a.find(".full")
                        .click()
                }, {
                    ns: this.id
                }), h(window)
        ...
        _onMouse: function() {
            ...
            n.on(u.events.enter, function() {
                ...
                0 < t.controlsHide && "none" === e.style("display") && e.stop(!0)
                    .fadeIn(500, function() {
                        e.css("display", "flex")
                    })
        ...
        _offMouse: function() {
            var e = this.player,
                t = this.options,
                n = e.find(".controls");
            e.off(u.events.enter), e.off(u.events.leave), 0 < t.controlsHide && "none" === n.style("display") && n.stop(!0)
                .fadeIn(500, function() {
                    n.css("display", "flex")
                })
        },
        ...
        _toggleMute: function() {
            this.muted = !this.muted, !1 === this.muted ? this.video.volume = this.volumeBackup : (this.volumeBackup = this.video.volume, this.video.volume = 0), u.getPlugin(this.volume, "slider")
                .val(!1 === this.muted ? 100 * this.volumeBackup : 0)
        },
        _setInfo: function(e, t) {
            this.player.find(".info-box")
        ...
        _setBuffer: function() {
            ...
            u.getPlugin(this.stream, "slider")
                .buff(e)
        },
        _setVolume: function() {
            var e = this.video,
                ...
                t = t.find(".mute"),
                e = 100 * e.volume;
            1 < e && e < 30 ? t.html(n.volumeLowIcon) : 30 <= 0 1 2 60 e && < ? t.html(n.volumemediumicon) : t.html(n.volumehighicon) t.html(n.muteicon) }, _setaspectratio: function() { var e, t="this.player," n="this.options," i="t.outerWidth();" switch (n.aspectratio) case u.aspectratio.sd: "4 3"); break; u.aspectratio.cinema: "21 9"); default: "16 9") } t.outerheight(e) aspectratio: function(e) this.options.aspectratio="e," this._setaspectratio() play: void !="=" this._setsource(e), this.element.attr("src") this.element.find("source") .length || (this.isplaying="!0," this.video.play()) pause: this.isplaying="!1," this.video.pause() resume: this.video.paused this.play() stop: this.video.pause(), this.video.currenttime="0," u.getplugin(this.stream, "slider") .val(0), this._offmouse() setvolume: if (void e) return this.video.volume; (e="100)," this.video.volume="e," u.getplugin(this.volume[0], .val(100 * loop: this._toggleloop() mute: this._togglemute() changeaspectratio: changesource: this.play(e) changevolume: this.setvolume(e) changeattribute: (e) "data-aspect-ratio": this.changeaspectratio(); "data-src": this.changesource(); "data-volume": this.changevolume() destroy: .destroy(), u.getplugin(this.volume, e.off("loadstart"), e.off("loadedmetadata"), e.off("canplay"), e.off("progress"), e.off("timeupdate"), e.off("waiting"), e.off("loadeddata"), e.off("play"), e.off("pause"), e.off("stop"), e.off("ended"), e.off("volumechange"), t.off(u.events.click, ".play"), ".stop"), ".mute"), ".loop"), ".full"), h(window) .off(u.events.keyup, ns: this.id }), .off(u.events.resize, }) }(metro, m4q), function(e, i) "use strict"; s="e.utils," onviewport: e.noop, onviewportenter: onviewportleave: onviewportcheckcreate: e.noop }; e.viewportchecksetup="function(e)" n, window.metroviewportchecksetup, e.viewportchecksetup(window.metroviewportchecksetup), e.component("viewport-check", init: t) this._super(t, inviewport: !1, id: s.elementid("viewport-check") this _create: this.inviewport="s.inViewport(this.elem)," this._createevents(), this._fireevent("viewport-check-create") _createevents: i(window) .on(e.events.scroll, t.inviewport="s.inViewport(n)," (t.inviewport t._fireevent("viewport-enter") t._fireevent("viewport-leave")), t._fireevent("viewport", state: t.id .off(e.events.scroll, this.element function(c, d) u="c.utils," windowdeferred: 0, hidden: width: "auto", height: btnclose: !0, btnmin: btnmax: draggable: dragelement: ".window-caption .icon, .window-caption .title", dragarea: "parent", shadow: icon: "", title: "window", content: null, resizable: overlay: overlaycolor: "transparent", overlayalpha: .5, modal: position: "absolute", checkembed: top: left: place: closeaction: c.actions.remove, custombuttons: clscustombutton: clscaption: clscontent: clswindow: _runtime: minwidth: minheight: maxwidth: maxheight: ondragstart: c.noop, ondragstop: ondragmove: oncaptiondblclick: oncloseclick: onmaxclick: onminclick: onresizestart: onresizestop: onresize: onwindowcreate: onshow: onwindowdestroy: oncanclose: c.noop_true, onclose: c.noop c.windowsetup="function(e)" window.metrowindowsetup, c.windowsetup(window.metrowindowsetup), c.component("window", win: null i.dragarea n.parent() d(i.dragarea); !0="==" i.modal (i.btnmax="!1," i.btnmin="!1," i.resizable="!1)," u.isnull(i.content) (u.isurl(i.content) u.isvideourl(i.content) (i.content="u.embedUrl(i.content)," n.css({ "100%" })) !u.isq(i.content) u.isfunc(i.content) n.appendtext(i.content) n.append(e)), i.content="n," i._runtime this._runtime(n, "window"), .addclass("no-visible"), s.append(e), i.overlay ((s="this._overlay())" .appendto(e.parent()), this.overlay="s)," this.win="e," this._fireevent("window-create", this.win[0], element: settimeout(function() t._setposition(), i.hidden t.win.removeclass("no-visible"), t._fireevent("show", t.win[0], 100) _setposition: t, i, a="this.win," o="parent" s.dragarea a.parent() d(s.dragarea), r="o.height()" - a[0].offsetheight 2, l="o.width()" a[0].offsetwidth 2; ("auto" s.place) (s.place.tolowercase()) "top-left": "auto"; "top-center": "top-right": "right-center": "bottom-right": "bottom-center": "bottom-left": "left-center": "auto" a.css({ bottom: right: _window: s,>")
                .addClass("window");
            return !0 === e.modal && l.addClass("modal"), t = d("<div>")
                .addClass("window-caption"), n = d("<div>")
                .addClass("window-content"), l.append(t), l.append(n), !0 === e.status && (s = d("<div>")
                    .addClass("window-status"), l.append(s)), !0 === e.shadow && l.addClass("win-shadow"), u.isValue(e.icon) && d("<span>")
                .addClass("icon")
                .html(e.icon)
                .appendTo(t), d("<span>")
                .addClass("title")
                .html(u.isValue(e.title) ? e.title : "&nbsp;")
                .appendTo(t), u.isNull(e.content) || (u.isQ(e.content) ? e.content.appendTo(n) : n.html(e.content)), (i = d("<div>")
                    .addClass("buttons"))
                .appendTo(t), !0 === e.btnMax && d("<span>")
                .addClass("button btn-max sys-button")
                .appendTo(i), !0 === e.btnMin && d("<span>")
                .addClass("button btn-min sys-button")
                .appendTo(i), !0 === e.btnClose && d("<span>")
                .addClass("button btn-close sys-button")
                .appendTo(i), u.isValue(e.customButtons) && (!(s = []) !== u.isObject(e.customButtons) && (e.customButtons = u.isObject(e.customButtons)), "string" == typeof e.customButtons && -1 < e.customButtons.indexOf("{") ? s = JSON.parse(e.customButtons) : "object" == typeof e.customButtons && 0 < u.objectLength(e.customButtons) ? s = e.customButtons : console.warn("Unknown format for custom buttons"), d.each(s, function() {
                    var n = d("<span>");
                    n.addClass("button btn-custom")
                        .addClass(e.clsCustomButton)
                        .addClass(this.cls)
                        .attr("tabindex", -1)
                        .html(this.html), this.attr && "object" == typeof this.attr && d.each(this.attr, function(e, t) {
                            n.attr(d.dashedName(e), t)
                        }), n.data("action", this.onclick), i.prepend(n)
                })), t.on(c.events.stop, ".btn-custom", function(e) {
                    var t;
                    u.isRightMouse(e) || (e = (t = d(this))
                        .data("action"), u.exec(e, [t], this))
                    ...
                    var t;
                    u.isRightMouse(e) || ((t = d(e.target))
                        .hasClass("btn-max") && a.maximized(e), t.hasClass("btn-min") && a.minimized(e), t.hasClass("btn-close") && a.close(e))
                    ...
                    e.minWidth += u.hiddenElementSize(this)
                        .width
                }), e.btnMax && (e.minWidth += 34), e.btnMin && (e.minWidth += 34), e.btnClose && (e.minWidth += 34)), 0 < e.minWidth && !isNaN(e.width) && e.width < e.minWidth && (o = e.minWidth), 0 < e.minHeight && !isNaN(e.height) && e.height > e.minHeight && (r = e.minHeight), !0 === e.resizable && (d("<span>")
                    .addClass("resize-element")
                    .appendTo(l), l.addClass("resizable"), c.makePlugin(l, "resizable", {
                        minWidth: e.minWidth,
        ...
        maximized: function(e) {
            var t = this.win,
                n = this.options,
                e = d(e.currentTarget);
            n.btnMax && (t.removeClass("minimized"), t.toggleClass("maximized")), e.hasClass && e.hasClass("window-caption") ? this._fireEvent("caption-dbl-click", {
                win: t[0]
        ...
        close: function() {
            ...
            n.onClose !== c.noop && (i = 500), this._fireEvent("close", {
                ...
                !0 === n.modal && t.siblings(".overlay")
                    .remove(), e._fireEvent("close-click", {
                        win: t[0]
        ...
        setIcon: function(e) {
            ...
            n.find(".window-caption .icon")
                .html(t)
        },
        getIcon: function() {
            return this.win.find(".window-caption .icon")
                .html()
        },
        getTitle: function() {
            return this.win.find(".window-caption .title")
                .html()
        },
        ...
        toggleResizable: function(e) {
            ...
            !0 === n ? (e.on(), t.find(".resize-element")
                .removeClass("resize-element-disabled")) : (e.off(), t.find(".resize-element")
                .addClass("resize-element-disabled"))
        },
        ...
        isOpen: function(e) {
            return !!this.isWindow(e) && c.getPlugin(e, "window")
                .isOpen()
        },
        close: function(e) {
            if (!this.isWindow(e)) return !1;
...
function(i, c) {
    ...
    i.wizardSetup = function(e) {
        ...
        _createWizard: function() {
            ...
            t.addClass("wizard")
                .addClass(n.view)
                .addClass(n.clsWizard), e = c("<div>")
                .addClass("action-bar")
                .addClass(n.clsActions)
                .appendTo(t);
            t = "button" === n.buttonMode ? "" : n.buttonMode;
            !0 === n.buttonOutline && (t += " outline"), !1 !== n.iconHelp && c("<button>")
                .attr("type", "button")
                .addClass("button wizard-btn-help")
                .addClass(t)
                .addClass(n.clsHelp)
                .html(d.isTag(n.iconHelp) ? n.iconHelp : c("<img>")
                    .attr("src", n.iconHelp))
                .appendTo(e), !1 !== n.iconPrev && c("</button><button>")
                .attr("type", "button")
                .addClass("button wizard-btn-prev")
                .addClass(t)
                .addClass(n.clsPrev)
                .html(d.isTag(n.iconPrev) ? n.iconPrev : c("<img>")
                    .attr("src", n.iconPrev))
                .appendTo(e), !1 !== n.iconNext && c("</button><button>")
                .attr("type", "button")
                .addClass("button wizard-btn-next")
                .addClass(t)
                .addClass(n.clsNext)
                .html(d.isTag(n.iconNext) ? n.iconNext : c("<img>")
                    .attr("src", n.iconNext))
                .appendTo(e), !1 !== n.iconFinish && c("</button><button>")
                .attr("type", "button")
                .addClass("button wizard-btn-finish")
                .addClass(t)
                .addClass(n.clsFinish)
                .html(d.isTag(n.iconFinish) ? n.iconFinish : c("<img>")
                    .attr("src", n.iconFinish))
                .appendTo(e), this.toPage(n.start), this._setHeight()
        },
        _setHeight: function() {
            var e = this.element,
                t = e.children("section"),
                n = 0;
            t.children(".page-content")
                .css("max-height", "none"), c.each(t, function() {
                    var e = c(this)
                        .height();
                    n < parseInt(e) && (n = e)
                }), e.height(n)
        ...
        next: function() {
            var e = this.element,
                ...
                i = c(e.children("section")
                    .get(this.current - 1));
            this.current + 1 > n.length || !1 === d.exec(t.onBeforeNext, [this.current, i, e]) || (this.current++, this.toPage(this.current), i = c(e.children("section")
                .get(this.current - 1)), this._fireEvent("next-page", {
                index: this.current,
                page: i[0]
            }))
        },
        prev: function() {
            var e = this.element,
                t = this.options,
                n = c(e.children("section")
                    .get(this.current - 1));
            this.current - 1 != 0 && !1 !== d.exec(t.onBeforePrev, [this.current, n, e]) && (this.current--, this.toPage(this.current), n = c(e.children("section")
                .get(this.current - 1)), this._fireEvent("prev-page", {
                index: this.current,
                page: n[0]
            }))
        },
        last: function() {
            var e = this.element;
            this.toPage(e.children("section")
                .length), e = c(e.children("section")
                .get(this.current - 1)), this._fireEvent("last-page", {
                index: this.current,
                page: e[0]
            })
        },
        first: function() {
            var e = this.element;
            this.toPage(1), e = c(e.children("section")
                .get(0)), this._fireEvent("first-page", {
                index: this.current,
                page: e[0]
            })
        },
        toPage: function(e) {
            var t, n, i, s = this.element,
                a = this.options,
                o = c(s.children("section")
                    .get(e - 1)),
                r = s.children("section"),
                l = s.find(".action-bar");
            0 !== o.length && (t = s.find(".wizard-btn-finish")
                .addClass("disabled"), n = s.find(".wizard-btn-next")
                .addClass("disabled"), i = s.find(".wizard-btn-prev")
                .addClass("disabled"), this.current = e, s.children("section")
                .removeClass("complete current")
                .removeClass(a.clsCurrent)
                .removeClass(a.clsComplete), o.addClass("current")
                .addClass(a.clsCurrent), o.prevAll()
                .addClass("complete")
                .addClass(a.clsComplete), e = 0 === s.children("section.complete")
                .length ? 0 : parseInt(d.getStyleOne(s.children("section.complete")[0], "border-left-width")), l.animate({
                    draw: {
                        left: s.children("section.complete")
                            .length * e + 41
                    },
                    dur: a.duration
        ...
        destroy: function() {
            var e = this.element;
            return e.off(i.events.click, ".wizard-btn-help"), e.off(i.events.click, ".wizard-btn-prev"), e.off(i.events.click, ".wizard-btn-next"), e.off(i.events.click, ".wizard-btn-finish"), e.off(i.events.click, ".complete"), c(window)
                .off(i.events.resize, {
                    ns: this.id
                }), e
        }
...
//# sourceMappingURL=metro.min.js.map</button></div></div></div></span></span></span></span></span></div></span></span></div></div></div></=></button></div></div></div></div></a></div></div></=></div></div></div></div></div></=></=></=></=></ul></li></span></span></span></=></=></span></span></"></div></button></div></li></ul></li></ul></li></ul></div></div></div></div></div></div></label></div></div></label></div></div></button></div></")></%")></%",></%(.+?)%></span></span></span></label></button></div></span></button></div></div></span></div></td></=></th></tr></tbody></thead></=></span></td></tr></div></td></=></=></button></div></div></div></div></option></select></div></div></div></th></tr></tfoot></tbody></th></tr></thead></button></div></tbody></table></div></div></td></tr></div></div></div></div></%",></label></span></span></div></div></div></div></div></div></div></div></div></span></div></div></div></div></div></div></div></div></li></ul></=></button></div></div></div></ul></p></div></div></=></div></label></button></div></div></div></span></span></div></div></button></div></div></div></div></option></optgroup></label></div></div></button></ul></div></div></div></span></span></div></label></li></a></li></span></div></=></=></span></=></=></ul></=></span></span></label></span></span></div></div></div></div></div></div></div></button></div></=></span></span></div></div></span></div></=></=></a></li></ul></div></div></div></div></=></=></div></div></=></div></span></span></span></div></ul></ul></div></div></div></div></li></span></div></div></span></=></=></div></div></div></div></div></div></option></select></div></div></div></%",></div></div></div></span></span></span></div></div></span></span></span></span></span></label></div></div></=></label></div></button></div></div></button></div></div></span></span></span></=></=></div></div></span></div></div></div></div></div></div></div></div></div></div></",></":></div></div></label></div></span></span></span></span></label></div></span></span></span></div></div></div></button></div></div></div></div></div></div></div></div></span></button></div></li></button></div></li></=></li></ul></li></ul></li></ul></div></div></div></div></div></div></label></div></span></=></div></div></div></div></button></div></=></=></button></div></div></div></div></div></div></div></div></div></div></canvas></button></div></canvas></button></div></div></button></div></div></div></label></span></span></div></div></div></div></div></div></div></div></span></"),></span></=></div></div></label></div></button></div></div></div></div></div></div></div></div></div></div></div></span></span></div></span></span></span></span></span></span></div></div></=></ul></div></li></ul></div></button></div></div></div></div></button></a></div></div></div></span></span></div></div></=></=></\></=>