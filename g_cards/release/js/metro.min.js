...
! function(e, u) {
    ...
    X.extend({
        ...
        serialize: function(e) {
            return X.serializeToArray(e)
                .join("&")
        }
    }), X.fn.extend({
        items: function() {
            return X.toArray(this)
        }
    }), "function" != typeof window.CustomEvent && (te.prototype = window.Event.prototype, window.CustomEvent = te);
    var ne = Event.prototype.stopPropagation,
        ie = Event.prototype.preventDefault;
    Event.prototype.stopPropagation = function() {
            ...
            off: function() {
                return X.each(this.events, function() {
            ...
            addEventHook: function(e, t, n) {
                return x(n) && (n = "before"), X.each(S(e), function() {
                    this.eventHooks[w(n + "-" + this)] = t
                }), this
            },
            removeEventHook: function(e, t) {
                return x(t) && (t = "before"), X.each(S(e), function() {
                    delete this.eventHooks[w(t + "-" + this)]
                }), this
            },
            removeEventHooks: function(e) {
                var t = this;
                return x(e) ? this.eventHooks = {} : X.each(S(e), function() {
                    delete t.eventHooks[w("before-" + this)], delete t.eventHooks[w("after-" + this)]
                }), this
            }
        }), X.fn.extend({
            on: function(e, l, c, d) {
                if (0 !== this.length) return "function" == typeof l && (d = c, c = l, l = u), b(d) || (d = {}), this.each(function() {
                    ...
                    X.each(S(e), function() {
                        var e, s, t = this.split("."),
                            a = M(t[0]),
                            o = d.ns || t[1];
                        X.eventUID++, e = function(e) {
                                var t = e.target,
                                    n = X.eventHooks[w("before-" + a)],
                                    i = X.eventHooks[w("after-" + a)];
                                ...
                                "function" == typeof i && i.call(t, e), d.once && (s = +X(r)
                                    .origin("event-" + e.type + (l ? ":" + l : "") + (o ? ":" + o : "")), isNaN(s) || X.events.splice(s, 1))
                            }, Object.defineProperty(e, "name", {
                                value: c.name && "" !== c.name ? c.name : "func_event_" + a + "_" + X.eventUID
                            }), t = a + (l ? ":" + l : "") + (o ? ":" + o : ""), r.addEventListener(a, e, !y(d) && d), s = X.setEventHandler({
                                el: r,
                                event: a,
                                handler: e,
                                selector: l,
            ...
            off: function(e, s, a) {
                return b(s) && (a = s, s = null), b(a) || (a = {}), x(e) || "all" === e.toLowerCase() ? this.each(function() {
                    var t = this;
                    X.each(X.events, function() {
                        var e = this;
                        e.element === t && (t.removeEventListener(e.event, e.handler, e.options), e.handler = null, X(t)
                            .origin("event-" + name + (e.selector ? ":" + e.selector : "") + (e.ns ? ":" + e.ns : ""), null))
                    })
                }) : this.each(function() {
                    var i = this;
                    X.each(S(e), function() {
                        var e = this.split("."),
                            ...
                            n = X(i)
                            .origin(e);
                        n !== u && X.events[n].handler && (i.removeEventListener(t, X.events[n].handler, X.events[n].options), X.events[n].handler = null), X(i)
                            .origin(e, null)
                    })
                })
            },
            ...
            fire: function(e, t) {
                ...
                if (0 !== this.length) return e = M(e), -1 < ["focus", "blur"].indexOf(e) ? (this[0][e](), this) : ("undefined" != typeof CustomEvent ? n = new CustomEvent(e, {
                    ...
                    .detail = t, n.initEvent(e, !0, !0)), this.each(function() {
                    this.dispatchEvent(n)
                }))
            }
        }), "blur focus resize scroll click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup contextmenu touchstart touchend touchmove touchcancel".split(" ")
        .forEach(function(i) {
            ...
            unload: function(e) {
                return 0 === this.length || this[0].self !== window ? u : X.unload(e)
            }
        }), X.beforeunload = function(t) {
            return "string" == typeof t ? X(window)
            ...
            beforeunload: function(e) {
                return 0 === this.length || this[0].self !== window ? u : X.beforeunload(e)
            }
        }), X.fn.extend({
            ready: function(e) {
                if (this.length && this[0] === document && "function" == typeof e) return X.ready(e)
            }
        }), X.ajax = function(v) {
            return new Promise(function(n, i) {
                ...
                var t, a, o, r, l = new XMLHttpRequest,
                    ...
                    u = !!x(v.async) || v.async,
                    h = v.url;
                if (v.data instanceof HTMLFormElement && (t = v.data.getAttribute("action"), a = v.data.getAttribute("method"), x(h) && t && "" !== t.trim() && (h = t), a && "" !== a.trim() && (c = a.toUpperCase())), v.timeout && (l.timeout = v.timeout), v.withCredentials && (l.withCredentials = v.withCredentials), v.data instanceof HTMLFormElement) f = X.serialize(v.data);
                else if (v.data instanceof HTMLElement && v.data.getAttribute("type") && "file" === v.data.getAttribute("type")
                    .toLowerCase())
                    for (var p = v.data.getAttribute("name"), f = new FormData, m = 0; m < v.data.files.length; m++) f.append(p, v.data.files[m]);
                else b(v.data) ? (o = v.data, r = [], X.each(o, function(e, t) {
                        var n, t = "string" == typeof(n = t) || "boolean" == typeof n || "number" == typeof n ? t : JSON.stringify(t);
                        r.push(e + "=" + t)
                    }), f = r.join("&")) : v.data instanceof FormData || "string" == typeof v.data ? f = v.data : (f = new FormData)
                    .append("_data", JSON.stringify(v.data));
                e(c) && (h += "string" == typeof f ? "?" + f : y(f) ? "" : "?" + JSON.stringify(f)), l.open(c, h, u, v.user, v.password), v.headers && X.each(v.headers, function(e, t) {
                    ...
                    s(v.onLoad, [e, l])
                }), X.each(["readystatechange", "error", "timeout", "progress", "loadstart", "loadend", "abort"], function() {
                    var t = w("on-" + ("readystatechange" === this ? "state" : this));
            ...
            X[s] = function(e, t, n) {
                ...
                return X.ajax(X.extend({}, i, n))
            }
        }), X.fn.extend({
            load: function(e, t, n) {
                var i = this;
                return this.length && this[0].self === window ? X.load(e) : X.get(e, t, n)
                    .then(function(e) {
                        i.each(function() {
                            this.innerHTML = e
                        })
            ...
            style: function(e, t) {
                ...
                function i(e, t, n) {
                    return -1 < ["scrollLeft", "scrollTop"].indexOf(t) ? X(e)[t]() : getComputedStyle(e, n)[t]
                }
                ...
                return 1 === e.length ? i(n, e[0], t) : (X.each(e, function() {
                    s[this] = i(n, this, t)
                }), s)
            },
            ...
            css: function(e, t) {
                return "string" == typeof(e = e || "all") && x(t) ? this.style(e) : this.each(function() {
                    var n = this;
                    "object" == typeof e ? X.each(e, function(e, t) {
                        E(n, e, t)
            ...
            X.fn[i + "Class"] = function(n) {
                return x(n) || "" === ("" + n)
                    .trim() ? this : this.each(function() {
                        var e = this,
        ...
        }), X.parseHTML = function(e) {
            var t, n, i, s = [];
            if ("string" != typeof e) return [];
            if (e = e.trim(), (t = (n = document.implementation.createHTMLDocument(""))
                    .createElement("base"))
                .href = document.location.href, n.head.appendChild(t), i = n.body, n = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i.exec(e)) s.push(document.createElement(n[1]));
            else {
                i.innerHTML = e;
...
function(p) {
    ...
    Date.prototype.getWeek = function(e) {
        var t, n, i;
        return e = Utils.isValue(e) ? "number" == typeof e ? parseInt(e) : 0 : METRO_WEEK_START, t = 0 <= (t = (n = new Date(this.getFullYear(), 0, 1))
            .getDay() - e) ? t : t + 7, n = Math.floor((this.getTime() - n.getTime() - 6e4 * (this.getTimezoneOffset() - n.getTimezoneOffset())) / 864e5) + 1, t < 4 ? 52 < (i = Math.floor((n + t - 1) / 7) + 1) && (i = (e = 0 <= (e = new Date(this.getFullYear() + 1, 0, 1)
            .getDay() - e) ? e : e + 7) < 4 ? 1 : 53) : i = Math.floor((n + t - 1) / 7), i
        ...
        function s(e, t) {
            return ("" + (Math.pow(10, t) + e))
                .slice(1)
        }
        var t = (void 0 !== p.locales && void 0 !== p.locales[t] ? p.locales[t] : p.locales["en-US"])
            .calendar,
            n = this,
            a = n.getDay(),
            o = n.getDate(),
...
function() {
    ...
    Number.prototype.format = function(e, t, n, i) {
        ...
        return (i ? e.replace(".", i) : e)
            .replace(new RegExp(t, "g"), "$&" + (n || ","))
    }
}(),
function() {
    "use strict";
...
function(c, e) {
    ...
    String.prototype.camelCase = function() {
        ...
        if (r = this.replace(/[\/,.:\s]/g, "-"), l = e.toLowerCase()
            .replace(/[^a-zA-Z0-9%]/g, "-")
            .split("-"), t = r.split("-"), "" === r.replace(/-/g, "")
            .trim()) return "Invalid Date";
        ...
        if (isNaN(parseInt(t[i]))) {
            if (t[i] = function(e) {
                ...
                if (e = e.substr(0, 3), void 0 !== a && "en-US" !== a && void 0 !== s && void 0 !== s[a] && void 0 !== s[a].calendar && void 0 !== s[a].calendar.months) {
                    for (t = s[a].calendar.months, i = 12; i < t.length; i++)
                        if (t[i].toLowerCase() === e.toLowerCase()) {
                            n = i - 12;
                            break
                        } e = s["en-US"].calendar.months[n]
                }
                return s = Date.parse(e + " 1, 1972"), isNaN(s) ? -1 : new Date(s)
                    .getMonth() + 1
        ...
        return n = n || "string", i = null != i && i, ("" + this)
            .split(e = e || ",")
            .map(function(e) {
                var t;
                switch (n) {
...
function(s, o) {
    ...
    s.utils = {
        ...
        isDate: function(e, t) {
            return !!this.isDateObject(e) || "Invalid Date" !== (this.isValue(t) ? String(e)
                .toDate(t) : String(new Date(e)))
        },
        ...
        isType: function(e, t) {
            ...
            if ("tag" === ("" + t)
                .toLowerCase() && this.isTag(e)) return e;
            if ("url" === ("" + t)
                .toLowerCase() && this.isUrl(e)) return e;
            if ("array" === ("" + t)
                .toLowerCase() && Array.isArray(e)) return e;
        ...
        embedUrl: function(e) {
            return -1 !== e.indexOf("youtu.be") && (e = "https://www.youtube.com/embed/" + e.split("/")
                .pop()), "<div class='embed-container'><iframe src='" + e + "'></iframe></div>"
        },
        ...
        getCursorPositionX: function(e, t) {
            return this.getCursorPosition(e, t)
                .x
        },
        ...
        github: function(e, t) {
            var n = this;
            o.json("https://api.github.com/repos/" + e)
                .then(function(e) {
                    n.exec(t, [e])
                })
        },
            ...
            Array.prototype.slice.call(document.querySelectorAll(e), 0)
                .forEach(function(e) {
                    ...
                    if (/^\S/gm.test(t)) e.textContent = t;
                        ...
                        1e3 !== o && (e.textContent = t.replace(new RegExp("^" + i, "gm"), "")
                            .trim())
                    }
                })
        },
        ...
        clientXY: function(e) {
            return {
                x: (e.changedTouches ? e.changedTouches[0] : e)
                    .clientX,
                y: (e.changedTouches ? e.changedTouches[0] : e)
                    .clientY
            }
        },
        screenXY: function(e) {
        ...
        hiddenElementSize: function(e, t) {
            var n = o(e)
                .clone(!0);
            return n.removeAttr("data-role")
                .css({
                    visibility: "hidden",
                    position: "absolute",
                    display: "block"
                }), o("body")
                .append(n), this.isValue(t) || (t = !1), e = n.outerWidth(t), t = n.outerHeight(t), n.remove(), {
                    width: e,
                    height: t
                }
        },
        ...
        valueInObject: function(e, t) {
            return -1 < Object.values(e)
                .indexOf(t)
        },
        keyInObject: function(e, t) {
            return -1 < Object.keys(e)
                .indexOf(t)
        },
        ...
        copy: function(e) {
            ...
            } else i.createTextRange && ((t = i.createTextRange())
                .moveToElementText(s), t.select());
            document.execCommand("Copy"), window.getSelection ? window.getSelection()
                .empty ? window.getSelection()
                .empty() : window.getSelection()
                .removeAllRanges && window.getSelection()
                .removeAllRanges() : document.selection && document.selection.empty()
        },
        decCount: function(e) {
            return e % 1 == 0 ? 0 : e.toString()
                .split(".")[1].length
        }
...
function(t, o) {
    ...
    t.accordionSetup = function(e) {
        ...
        _openFrame: function(e) {
            ...
            !0 === n.oneFrame && this._closeAll(e[0]), e.addClass("active " + n.activeFrameClass), e.children(".heading")
                .addClass(n.activeHeadingClass), e.children(".content")
        ...
        _closeFrame: function(e) {
            var t = this.element,
                n = this.options,
                e = o(e);
            e.hasClass("active") && !1 !== i.exec(n.onFrameBeforeClose, [e[0]], t[0]) && (e.removeClass("active " + n.activeFrameClass), e.children(".heading")
                .removeClass(n.activeHeadingClass), e.children(".content")
    ...
    i.activitySetup = function(e) {
        ...
        _create: function() {
            ...
            switch (n.html("")
                ...
                .addClass("activity-" + i.type), i.type) {
                case "metro":
                    ! function() {
                        for (e = 0; e < 5; e++) s("<div/>")
                            .addClass("circle")
    ...
    h.audioPlayerSetup = function(e) {
        ...
        _createControls: function() {
            ...
            !0 !== i.showInfo && u.hide(), l.activity({
                    ...
                    .html(i.loopIcon)
                    .appendTo(a)), !0 === i.showPlay && p("<button>")
                .attr("type", "button")
                .addClass("button square play")
                .html(i.playIcon)
                .appendTo(a), !0 === i.showStop && p("<button>")
                .attr("type", "button")
                .addClass("button square stop")
                .html(i.stopIcon)
                .appendTo(a), !0 === i.showMute && p("<button>")
                .attr("type", "button")
        ...
        play: function(e) {
            void 0 !== e && this._setSource(e), void 0 === this.element.attr("src") && 0 === this.element.find("source")
                .length || this.audio.play()
        },
        pause: function() {
            this.audio.pause()
        },
        ...
        stop: function() {
            this.audio.pause(), this.audio.currentTime = 0, h.getPlugin(this.stream, "slider")
                .val(0)
        },
        setVolume: function(e) {
            if (void 0 === e) return this.audio.volume;
            1 < e && (e /= 100), this.audio.volume = e, h.getPlugin(this.volume, "slider")
                .val(100 * e)
        },
        loop: function() {
            this._toggleLoop()
        ...
        destroy: function() {
            var e = this.element,
                t = this.player;
            return e.off("all"), t.off("all"), h.getPlugin(this.stream, "slider")
                .destroy(), h.getPlugin(this.volume, "slider")
                .destroy(), e
        }
    })
}(Metro, m4q),
function(n, i) {
    ...
    n.bottomSheetSetup = function(e) {
        ...
        _createStructure: function() {
            var e = this.element,
                t = this.options;
            e.addClass("bottom-sheet")
                .addClass(t.mode + "-list"), s.isValue(t.toggle) && 0 < i(t.toggle)
                .length && (this.toggle = i(t.toggle))
        },
        _createEvents: function() {
            var e = this,
                t = this.element;
        ...
        open: function(e) {
            var t = this.element;
            s.isValue(e) && t.removeClass("list-style grid-style")
                .addClass(e + "-style"), this.element.addClass("opened"), this._fireEvent("open", {
                    element: t
                })
        },
        close: function() {
        ...
        isOpen: function(e) {
            return !!this.isBottomSheet(e) && n.getPlugin(e, "bottom-sheet")
                .isOpen()
        }
    }
}(Metro, m4q),
function(s, a) {
    ...
    s.buttonGroupSetup = function(e) {
        ...
        _createGroup: function() {
            var e, t, n = this.element,
                i = this.options;
            n.addClass("button-group"), e = n.find(i.targets), t = n.find(".active"), i.mode === s.groupMode.ONE && 0 === t.length && !0 === i.requiredButton && a(e[0])
                .addClass("active"), i.mode === s.groupMode.ONE && 1 < t.length && (e.removeClass("active")
                    .removeClass(i.clsActive), a(e[0])
                    .addClass("active")), n.find(".active")
                .addClass("js-active")
                .addClass(i.clsActive)
        },
        _createEvents: function() {
            var t = this,
                n = this.element,
            ...
            n.on(s.events.click, i.targets, function() {
                ...
                t._fireEvent("button-click", {
                    button: this
                }), i.mode === s.groupMode.ONE && e.hasClass("active") || (i.mode === s.groupMode.ONE ? (n.find(i.targets)
                        .removeClass(i.clsActive)
                        .removeClass("active js-active"), e.addClass("active")
                        .addClass(i.clsActive)
                        .addClass("js-active")) : e.toggleClass("active")
                    .toggleClass(i.clsActive)
    ...
    f.carouselSetup = function(e) {
        ...
        _resize: function() {
            var t, e, n = this.element,
                i = this.options,
                s = n.outerWidth(); - 1 < ["16/9", "21/9", "4/3"].indexOf(i.height) ? t = o.aspectRatioH(s, i.height) : -1 < String(i.height)
                .indexOf("@") ? (e = i.height.substr(1)
                    .toArray("|"), a.each(e, function() {
                        var e = this.toArray(",");
                        window.matchMedia(e[0])
                            .matches && (t = -1 < ["16/9", "21/9", "4/3"].indexOf(e[1]) ? o.aspectRatioH(s, e[1]) : parseInt(e[1]))
        ...
        _createControls: function() {
            ...
            !1 !== i.controls && (e = a("<span/>")
                ...
                .html("<"), i.controlNext && e.html(i.controlNext), i.controlPrev && t.html(i.controlPrev), e.appendTo(n), t.appendTo(n))
        },
...
function(e, v) {
    ...
    var m = {
        ...
        hsl2hsv: function(e) {
            var t, n, i;
            return this.check(e, "hsl"), t = e.h, e = ((i = 2 * e.l) + (n = e.s * (i <= 1 ? i : 2 - i))) / 2, new C(t, n = i + n === 0 ? 0 : 2 * n / (i + n), e)
        },
        ...
        grayscale: function(e) {
            var t = this.toRGB(e),
                e = this.colorType(e)
                .toLowerCase(),
                t = Math.round(.2125 * t.r + .7154 * t.g + .0721 * t.b),
                t = new h(t, t, t);
        ...
        lighten: function(e, t) {
            var n, i, s, a, o, r, l = "string" == typeof e ? this.parse(e) : e,
                c = 0 < (t = t || 10),
                e = this.colorType(l)
                .toLowerCase();
            for (e !== d && e !== u || (i = l.a); s = this.toHEX(l), a = t, r = o = void 0, o = s.slice(1), r = parseInt(o, 16), 255 < (s = (r >> 16) + a) ? s = 255 : s < 0 && (s = 0), 255 < (o = (r >> 8 & 255) + a) ? o = 255 : o < 0 && (o = 0), 255 < (a = (255 & r) + a) ? a = 255 : a < 0 && (a = 0), n = "#" + (a | o << 8 | s << 16)
        ...
        createScheme: function(e, t, n, i) {
            ...
            switch (t) {
                case "monochromatic":
                case "mono":
                    if (1 === o.algorithm)(a = this.hsv2rgb(c))
                        .r = f(Math.round(a.r + (255 - a.r) * o.tint1), 0, 255), a.g = f(Math.round(a.g + (255 - a.g) * o.tint1), 0, 255), a.b = f(Math.round(a.b + (255 - a.b) * o.tint1), 0, 255), r.push(this.rgb2hsv(a)), (a = this.hsv2rgb(c))
                        .r = f(Math.round(a.r + (255 - a.r) * o.tint2), 0, 255), a.g = f(Math.round(a.g + (255 - a.g) * o.tint2), 0, 255), a.b = f(Math.round(a.b + (255 - a.b) * o.tint2), 0, 255), r.push(this.rgb2hsv(a)), r.push(c), (a = this.hsv2rgb(c))
                        .r = f(Math.round(a.r * o.shade1), 0, 255), a.g = f(Math.round(a.g * o.shade1), 0, 255), a.b = f(Math.round(a.b * o.shade1), 0, 255), r.push(this.rgb2hsv(a)), (a = this.hsv2rgb(c))
                        .r = f(Math.round(a.r * o.shade2), 0, 255), a.g = f(Math.round(a.g * o.shade2), 0, 255), a.b = f(Math.round(a.b * o.shade2), 0, 255), r.push(this.rgb2hsv(a));
                    else if (2 === o.algorithm)
                        for (r.push(c), s = 1; s <= o.distance; s++) h = p(h - o.step, 0, 1), u = p(u - o.step, 0, 1), r.push(new C(d, u, h));
                    else if (3 === o.algorithm)
                        for (r.push(c), s = 1; s <= o.distance; s++) h = p(h - o.step, 0, 1), r.push(new C(d, u, h));
                    else h = p(c.v + 2 * o.step, 0, 1), r.push(new C(d, u, h)), h = p(c.v + o.step, 0, 1), r.push(new C(d, u, h)), r.push(c), u = c.s, h = c.v, h = p(c.v - o.step, 0, 1), r.push(new C(d, u, h)), h = p(c.v - 2 * o.step, 0, 1), r.push(new C(d, u, h));
                    break;
                case "complementary":
                case "complement":
                case "comp":
                    r.push(c), d = m(c.h, 180), r.push(new C(d, u, h));
                    break;
                case "double-complementary":
                case "double-complement":
                case "double":
                    r.push(c), d = m(d, 180), r.push(new C(d, u, h)), d = m(d, o.angle), r.push(new C(d, u, h)), d = m(d, 180), r.push(new C(d, u, h));
                    break;
                case "analogous":
                case "analog":
                    d = m(d, o.angle), r.push(new C(d, u, h)), r.push(c), d = m(c.h, 0 - o.angle), r.push(new C(d, u, h));
                    break;
                case "triadic":
                case "triad":
                    for (r.push(c), s = 1; s < 3; s++) d = m(d, 120), r.push(new C(d, u, h));
                    break;
                case "tetradic":
                case "tetra":
                    r.push(c), d = m(c.h, 180), r.push(new C(d, u, h)), d = m(c.h, -1 * o.angle), r.push(new C(d, u, h)), d = m(d, 180), r.push(new C(d, u, h));
                    break;
                case "square":
                    for (r.push(c), s = 1; s < 4; s++) d = m(d, 90), r.push(new C(d, u, h));
                    break;
                case "split-complementary":
                case "split-complement":
                case "split":
                    d = m(d, 180 - o.angle), r.push(new C(d, u, h)), r.push(c), d = m(c.h, 180 + o.angle), r.push(new C(d, u, h));
                    break;
                default:
...
function(a, o) {
    ...
    a.cookieDisclaimer = {
        init: function(e) {
            var t = this,
                n = a.cookie;
            this.options = o.extend({}, i, e), this.disclaimer = o("<div>"), n.getCookie(this.options.name) || (this.options.template ? o.get(this.options.template)
                .then(function(e) {
                    t.create(e)
...
function(s, _) {
    ...
    s.countdownSetup = function(e) {
            ...
            s.attr("id") || s.attr("id", o.elementId("countdown")), o.isValue(s.attr("id")) || s.attr("id", o.elementId("countdown")), s.addClass("countdown")
                .addClass(a.clsCountdown), this._setBreakpoint(), n = Math.round((i.breakpoint - e) / 864e5), _.each(["days", "hours", "minutes", "seconds"], function() {
                    ...
                    if ("days" === this && e.addClass(a.clsDays), "hours" === this && e.addClass(a.clsHours), "minutes" === this && e.addClass(a.clsMinutes), "seconds" === this && e.addClass(a.clsSeconds), _("<div>")
                        ...
                        .appendTo(e), _("<div>")
                        .addClass("digit")
                        .appendTo(e), "days" === this && 100 <= n)
                        for (var t = 0; t < String(Math.round(n / 100))
                            .length; t++) _("<div>")
                            .addClass("digit")
                            .appendTo(e)
                }), (e = s.find(".digit"))
        ...
        draw: function(e, t) {
            var n, i, s, a, o, r, l, c, d, u, h, p, f, m, v, g, C, w, b = this.element,
                y = this.options;
            for (1 === (t = "" + t)
                .length && (t = "0" + t), o = t.length, i = (n = b.find("." + e + " .digit:not(-old-digit)"))
                .length, r = 0; r < o; r++)
                if (a = n.eq(i - 1)
                    .find(".digit-value"), s = Math.floor(parseInt(t) / Math.pow(10, r)) % 10, i--, parseInt(a.text()) !== s) switch (("" + y.animate)
                    .toLowerCase()) {
                    case "slide":
                        g = s, w = C = void 0, w = (v = a)
                            .height(), v.siblings("-old-digit")
                            .remove(), (C = v.clone()
                                .appendTo(v.parent()))
                            .css({
                                top: -1 * w + "px"
                            }), v.addClass("-old-digit")
                            .animate({
                                draw: {
                                    top: w,
                                    opacity: 0
                    ...
                    case "fade":
                        ...
                        break;
                    case "zoom":
                        c = s, h = u = d = void 0, u = (l = a)
                            .height(), h = parseInt(l.style("font-size")), l.siblings("-old-digit")
                            .remove(), (d = l.clone()
                                .appendTo(l.parent()))
                            .css({
                                top: 0,
        ...
        stop: function() {
            var e = this.element;
            clearInterval(this.blinkInterval), clearInterval(this.tickInterval), e.data("paused", !0), e.find(".digit")
                .html("0"), this.current = {
                    d: 0,
                    h: 0,
                    m: 0,
        ...
        reset: function() {
            var e = this,
                t = this.element,
                n = this.options;
            clearInterval(this.blinkInterval), clearInterval(this.tickInterval), t.find(".part")
                .removeClass(n.clsZero), t.find(".digit")
                .html("0"), this._setBreakpoint(), t.data("paused", !1), this.tick(), this.blinkInterval = setInterval(function() {
                    e.blink()
                }, 500), this.tickInterval = setInterval(function() {
                    e.tick()
                }, 1e3)
        ...
        i18n: function(e) {
            ...
            return void 0 === e ? i.locale : void 0 !== s.locales[e] && (i.locale = e, this.locale = s.locales[i.locale], void _.each(["days", "hours", "minutes", "seconds"], function() {
                var e = ".part." + this;
                n.find(e)
                    .attr("data-label", t.locale.calendar.time[this])
            }))
        },
        changeAttrLocale: function() {
        ...
        destroy: function() {
            return clearInterval(this.blinkInterval), clearInterval(this.tickInterval), _(document)
            ...
            a.isValue(t) && (s.from = +t), a.isValue(e) && (s.value = +e), this.started = !0, this._fireEvent("start"), i.animate({
                ...
                onFrame: function() {
                    n._fireEvent("tick", {
                        ...
                        }), this.innerHTML = s.prefix + Number(this.innerHTML)
                        .format(0, 0, s.delimiter) + s.suffix
                },
                onDone: function() {
                    n._fireEvent("stop")
                }
...
function(l, c) {
    ...
    l.cubeSetup = function(e) {
        ...
        _createCube: function() {
            ...
            i.addClass("cube")
                .addClass(s.clsCube), i.attr("id") || i.attr("id", e), this.id = i.attr("id"), this._createCssForFlashColor(), this._createCssForCellSize(), c.each(["left", "right", "top"], function() {
                    var e, t, n = c("<div>")
        ...
        rule: function(e) {
            ...
            !0 === this._parseRules(e) && (this.options.rules = e, this.stop(), this.element.find(".cube-cell")
                .removeClass("light"), this._run())
        },
        axis: function(e) {
            e = !0 === e ? "show" : "hide";
        ...
        changeRules: function() {
            var e = this.element,
                t = this.options,
                n = e.attr("data-rules");
            !0 === this._parseRules(n) && (this.stop(), e.find(".cube-cell")
                .removeClass("light"), t.rules = n, this._run())
        },
        ...
        destroy: function() {
            var e = this.element;
            return clearInterval(this.interval), this.interval = null, c(window)
                .off(l.events.blur, {
                    ns: e.attr("id")
                }), c(window)
                .off(l.events.focus, {
    ...
    o.inputSetup = function(e) {
            ...
            _createStructure: function() {
                ...
                if (c.isValue(i.historyPreset) && (l.each(i.historyPreset.toArray(i.historyDivider), function() {
                    ...
                    .appendTo(a), "password" === n.attr("type") && !0 === i.revealButton && l("<button>")
                    .addClass("button input-reveal-button")
                    .addClass(i.clsRevealButton)
                    .attr("tabindex", -1)
                    .attr("type", "button")
                    .html(i.revealButtonIcon)
                    .appendTo(a), !0 === i.searchButton && l("<button>")
            ...
            _createEvents: function() {
                ...
                e.on(o.events.click, ".input-clear-button", function() {
                    ...
                    e.keyCode === o.keyCode.ENTER && n._fireEvent("enter-click", {
                        val: i.val()
                    })
    ...
    s.listSetup = function(e) {
        ...
        _draw: function(e) {
            ...
            for (n.children(i.sortTarget)
                .remove(), t = s; t <= a; t++) d.isValue(o[t]) && c(o[t])
                .addClass(i.clsListItem)
                .appendTo(n), this._fireEvent("draw-item", {
                    item: o[t]
                });
        ...
        _getItemContent: function(e) {
            ...
            if (i = ("" + i)
                .toLowerCase()
                .replace(/[\n\r]+|[\s]{2,}/g, " ")
                .trim(), d.isValue(s)) switch (-1 === ["number", "int", "integer", "float", "money"].indexOf(s) || "," === a.thousandSeparator && "." === a.decimalSeparator || (i = d.parseNumber(i, a.thousandSeparator, a.decimalSeparator)), s) {
                case "date":
        ...
        filter: function(e) {
            this.filterString = e.trim()
                .toLowerCase(), this.currentPage = 1, this._draw()
        },
        loadData: function(e) {
            var n = this,
                i = this.element,
    ...
    l.navViewSetup = function(e) {
        ...
        _createEvents: function() {
            ...
            e.on("mousewheel", function(e) {
                    ...
                    !0 === s.activeState && (o.find(".navview-menu li")
                        .removeClass("active"), c(this)
                        .toggleClass("active"))
                ...
                .on(l.events.resize, function() {
                    ...
                    a.pane.hasClass("open") || (o.removeClass("expanded"), a.pane.removeClass("open"), c(this)
                        .width() <= l.media_sizes[("" + s.compact)
                            .toUpperCase()] && o.removeClass("compacted"), i.length && (n = i.children(".navview-menu"), setTimeout(function() {
        ...
        pullClick: function(e) {
            var t, e = c(e);
            return e && e.hasClass("holder") && (t = e.parent()
                .find("input"), setTimeout(function() {
                    t.focus()
        ...
        destroy: function() {
            var e = this.element;
            return e.off(l.events.click, ".pull-button, .holder"), e.off(l.events.click, ".navview-menu li"), e.off(l.events.click, ".navview-menu li > a"), null !== this.paneToggle && this.paneToggle.off(l.events.click), c(window)
                .off(l.events.resize, {
                    ns: this.id
                }), e
        }
...
function(o, r) {
    ...
    o.panelSetup = function(e) {
        ...
        collapse: function() {
            var e = this.element;
            !1 !== l.isMetroObject(e, "collapse") && o.getPlugin(e, "collapse")
                .collapse()
        },
        open: function() {
            this.expand()
        ...
        destroy: function() {
            var e = this.element,
                t = this.options;
            return !0 === t.collapsible && o.getPlugin(e, "collapse")
                .destroy(), !0 === t.draggable && o.getPlugin(e, "draggable")
                .destroy(), e
        }
    })
}(Metro, m4q),
    ...
    r.popoverSetup = function(e) {
        ...
        setPosition: function() {
            ...
            n.popoverPosition === r.position.BOTTOM ? (e.addClass("bottom"), e.css({
                top: i.offset()
                    .top - l(window)
                    .scrollTop() + i.outerHeight() + n.popoverOffset,
                left: i.offset()
                    .left + i.outerWidth() / 2 - t.width / 2 - l(window)
                    .scrollLeft()
            })) : n.popoverPosition === r.position.RIGHT ? (e.addClass("right"), e.css({
                top: i.offset()
                    .top + i.outerHeight() / 2 - t.height / 2 - l(window)
                    .scrollTop(),
                left: i.offset()
                    .left + i.outerWidth() - l(window)
                    .scrollLeft() + n.popoverOffset
            })) : n.popoverPosition === r.position.LEFT ? (e.addClass("left"), e.css({
                top: i.offset()
                    .top + i.outerHeight() / 2 - t.height / 2 - l(window)
                    .scrollTop(),
                left: i.offset()
                    .left - t.width - l(window)
                    .scrollLeft() - n.popoverOffset
            })) : (e.addClass("top"), e.css({
                top: i.offset()
                    .top - l(window)
                    .scrollTop() - t.height - n.popoverOffset,
                left: i.offset()
                    .left + i.outerWidth() / 2 - t.width / 2 - l(window)
                    .scrollLeft()
            }))
...
function(d, u) {
    ...
    d.ratingSetup = function(e) {
        ...
        _createRating: function() {
            ...
            if (u("<span>")
                ...
                .html(a.message), null !== a.starColor && d.colors.isColor(a.starColor) && h.addCssRule(l, "#" + o + " .stars:hover li", "color: " + a.starColor + ";"), null !== a.staredColor && d.colors.isColor(a.staredColor) && (h.addCssRule(l, "#" + o + " .stars li.on", "color: " + a.staredColor + ";"), h.addCssRule(l, "#" + o + " .stars li.half::after", "color: " + a.staredColor + ";")), null !== a.title && (o = u("<span>")
                    .addClass("title")
                    .addClass(a.clsTitle)
                    .html(a.title), r.prepend(o)), !0 === a.static && (r.addClass("static"), !0 !== a.half || 0 < (i = Math.round(this.originValue % 1 * 10)) && i <= 9 && r.find(".stars li.on")
                    .last()
                    .next("li")
                    .addClass("half half-" + 10 * i)), !(s[0].className = "") === a.copyInlineStyles)
        ...
        msg: function(e) {
            var t = this.rating;
            if (void 0 !== e) return t.find(".result")
                .html(e), this
        },
        static: function(e) {
            var t = this.options,
...
function(l, c) {
    ...
    l.resizableSetup = function(e) {
        ...
        _createStructure: function() {
            var e = this.element,
                t = this.options;
            e.data("canResize", !0), e.addClass("resizable-element"), d.isValue(t.resizeElement) && 0 < e.find(t.resizeElement)
                .length ? this.resizer = e.find(t.resizeElement) : this.resizer = c("<span>")
...
function(i, a) {
    ...
    i.stepperSetup = function(e) {
        ...
        _createStepper: function() {
            var e, t = this.element,
                n = this.options;
            for (t.addClass("stepper")
                .addClass(n.view)
                .addClass(n.clsStepper), e = 1; e <= n.steps; e++) a("<span>")
                .addClass("step")
                .addClass(n.clsStep)
                .data("step", e)
                .html("<span>" + e + "</span>")
...
function(x, E) {
    ...
    x.streamerSetup = function(e) {
        ...
        build: function() {
            ...
            for (S.setHours(i[0]), S.setMinutes(i[1]), S.setSeconds(0), T.setHours(o[0]), T.setMinutes(o[1]), T.setSeconds(0), l = S.getTime() / 1e3; l <= T.getTime() / 1e3; l += k)
                for (d = ((c = (f = new Date(1e3 * l))
                        .getHours()) < 10 ? "0" + c : c) + ":" + ((u = f.getMinutes()) < 10 ? "0" + u : u), y = (f = E("<li>")
                        .data("time", d)
    ...
    w.tableSetup = function(e) {
        ...
        _createInspector: function() {
            ...
            i.attr("for", this.element.attr("id")), b("<div class='table-inspector-header'>" + n.inspectorTitle + "</div>")
                ...
                .appendTo(n), b("<button class='button secondary js-table-inspector-reset ml-2 mr-2' type='button'>")
                .html(this.locale.buttons.reset)
                .appendTo(n), b("<button class='button link js-table-inspector-cancel place-right' type='button'>")
        ...
        export: function(e, t, n, i) {
            ...
            if ("function" == typeof h.tableToCSV) {
                ...
                for (l.appendTo(v), u = "checked" === t ? (d = 0, (r = this.getSelectedItems())
                    ...
                    .length - 1), s = d; s <= u; s++)
                    if (y.isValue(r[s])) {
                        for (l = b("<tr>"), o = r[s], a = 0; a < o.length; a++) C[a] = null;
                        for (b.each(o, function(e) {
...
function(o, d) {
    ...
    o.textareaSetup = function(e) {
        ...
        _createStructure: function() {
            ...
            if (o.insertBefore(i), i.appendTo(o), r.appendTo(o), !1 === a.clearButton || i[0].readOnly || (e = d("<button>")
                    .addClass("button input-clear-button")
                    .attr("tabindex", -1)
                    .attr("type", "button")
            ...
            _createStructure: function() {
                ...
                if (l.insertBefore(a), a.attr("readonly", !0)
                    ...
                    for (e = c("<ul>")
                        ...
                        .data("value", -1)
                        .appendTo(e);
                    for (i = 0; i < 24; i += o.hoursStep) c("<li>")
                        .addClass("js-hours-" + i)
                        .html(i < 10 ? "0" + i : i)
                        .data("value", i)
                        .appendTo(e);
                    for (i = 0; i < o.distance; i++) c("<li>")
                        .html("&nbsp;")
                        .data("value", -1)
                        .appendTo(e)
                }
                if (!0 === o.minutes) {
                    for (t = c("<ul>")
                        ...
                        .data("value", -1)
                        .appendTo(t);
                    for (i = 0; i < 60; i += o.minutesStep) c("<li>")
                ...
                if (!0 === o.seconds) {
                    for (n = c("<ul>")
                        ...
                        .data("value", -1)
                        .appendTo(n);
                    for (i = 0; i < 60; i += o.secondsStep) c("<li>")
...
function(s, d) {
    ...
    var u = s.utils,
        h = {
            ...
            length: function(e, t) {
                return Array.isArray(e) ? e.length === parseInt(t) : !(!u.isValue(t) || isNaN(t) || t <= 0) && e.trim()
                    .length === parseInt(t)
            },
            ...
            date: function(e, t, n) {
                return u.isNull(t) ? "invalid date" !== String(new Date(e))
                    .toLowerCase() : "invalid date" !== String(e.toDate(t, n))
                    .toLowerCase()
            },
            number: function(e) {
                return !isNaN(e)
            ...
            pattern: function(e, t) {
                return !!u.isValue(e) && (!!u.isValue(t) && new RegExp(t)
                    .test(e))
            },
            ...
            validate: function(e, i, t, n, s) {
                var a = !0,
                    o = d(e),
                    r = void 0 !== o.data("validate") ? String(o.data("validate"))
                    .split(" ")
                    .map(function(e) {
                        return e.trim()
                    }) : [],
                    ...
                    c = 0 < o.closest("form")
                    .length;
                return 0 === r.length || (this.reset_state(o), o.attr("type") && "checkbox" === o.attr("type")
                    .toLowerCase() ? (!1 === (a = -1 === r.indexOf("required") || o.is(":checked")) && l.push("required"), void 0 !== i && (i.val += a ? 0 : 1)) : o.attr("type") && "radio" === o.attr("type")
                    .toLowerCase() ? (e = o.attr("name"), e = d("input[name=" + e.replace("[", "\\[")
                        .replace("]", "\\]") + "]:checked"), a = 0 < e.length, void 0 !== i && (i.val += a ? 0 : 1)) : d.each(r, function() {
                        var e, t, n;
                        !1 !== a && (n = (e = this.split("="))[0], e.shift(), e = e.join("="), -1 < ["compare", "equals", "notequals"].indexOf(n) && (e = c ? o[0].form.elements[e].value : d("[name=" + e + "]")
                            .val()), "date" === n && (e = o.attr("data-value-format"), t = o.attr("data-value-locale")), !1 === (a = !1 === u.isFunc(h[n]) || (!0 !== s && "required" !== n && "" === o.val()
                            .trim() || h[n](o.val(), e, t))) && l.push(n), void 0 !== i && (i.val += a ? 0 : 1))
    ...
    s.validatorSetup = function(e) {
        ...
        _create: function() {
            ...
            t.attr("novalidate", "novalidate"), d.each(i, function() {
                var e = d(this); - 1 < e.data("validate")
                    .indexOf("required") && !0 === n.useRequiredClass && (h.is_control(e) ? e.parent() : e)
                    .addClass("required"), !0 === n.interactiveCheck && e.on(s.events.inputchange, function() {
        ...
        _submit: function() {
            ...
            return 0 < a.length && a.attr("disabled", "disabled")
                .addClass("disabled"), d.each(s, function() {
                    h.validate(this, o, n.onValidate, n.onError, n.requiredMode)
                }), a.removeAttr("disabled")
                .removeClass("disabled"), o.val += !1 === u.exec(n.onBeforeSubmit, [r], this.elem) ? 1 : 0, 0 === o.val ? (this._fireEvent("validate-form", {
                    data: r
                }), setTimeout(function() {
...
function(e, m) {
    ...
    e.vegasSetup = function(e) {
        ...
        _create: function() {
            var e = this.element;
            this.slides = a.isObject(this.options.slides) || [], this.total = this.slides.length, this.noshow = this.total < 2, this.paused = !this.options.autoplay || this.noshow, this.options.shuffle && this.slides.shuffle(), this.options.preload && this._preload(), this._createStructure(), this._createEvents(), this._fireEvent("vegas-create", {
                element: e
            })
        },
        _createStructure: function() {
            var e, t = this,
                ...
                i = this.options,
                s = "BODY" === n[0].tagName;
            s || (n.css("height", n.css("height")), e = m('<div class="vegas-wrapper">')
    ...
    u.videoPlayerSetup = function(e) {
        ...
        _createControls: function() {
            ...
            !0 !== i.showInfo && d.hide(), u.makePlugin(r, "slider", {
                    ...
                    .addClass("button square loop")
                    .html(i.loopIcon)
                    .appendTo(a)), !0 === i.showPlay && h("<button>")
                .attr("type", "button")
                .addClass("button square play")
                .html(i.playIcon)
                .appendTo(a), !0 === i.showStop && h("<button>")
                .attr("type", "button")
                .addClass("button square stop")
                .html(i.stopIcon)
                .appendTo(a), !0 === i.showMute && h("<button>")
                .attr("type", "button")
                .addClass("button square mute")
                .html(i.muteIcon)
                .appendTo(a), !0 === i.showFull && h("<button>")
                .attr("type", "button")
        ...
        play: function(e) {
            void 0 !== e && this._setSource(e), void 0 === this.element.attr("src") && 0 === this.element.find("source")
                .length || (this.isPlaying = !0, this.video.play())
        },
        pause: function() {
        ...
        stop: function() {
            this.isPlaying = !1, this.video.pause(), this.video.currentTime = 0, u.getPlugin(this.stream, "slider")
                .val(0), this._offMouse()
        },
        setVolume: function(e) {
            if (void 0 === e) return this.video.volume;
            1 < e && (e /= 100), this.video.volume = e, u.getPlugin(this.volume[0], "slider")
                .val(100 * e)
        },
        loop: function() {
            this._toggleLoop()
    ...
    c.windowSetup = function(e) {
        ...
        _create: function() {
            ...
            !0 === i.modal && (i.btnMax = !1, i.btnMin = !1, i.resizable = !1), u.isNull(i.content) || (u.isUrl(i.content) && u.isVideoUrl(i.content) ? (i.content = u.embedUrl(i.content), n.css({
                        height: "100%"
                    })) : !u.isQ(i.content) && u.isFunc(i.content) && (i.content = u.exec(i.content)), 0 === (e = d(i.content))
                    .length ? n.appendText(i.content) : n.append(e)), i.content = n, !0 === i._runtime && this._runtime(n, "window"), (e = this._window(i))
                .addClass("no-visible"), s.append(e), !0 === i.overlay && ((s = this._overlay())
                    .appendTo(e.parent()), this.overlay = s), this.win = e, this._fireEvent("window-create", {
                    win: this.win[0],
                    element: n
                }), setTimeout(function() {
        ...
        _createWizard: function() {
            ...
            !0 === n.buttonOutline && (t += " outline"), !1 !== n.iconHelp && c("<button>")
                ...
                .html(d.isTag(n.iconHelp) ? n.iconHelp : c("<img>")
                    .attr("src", n.iconHelp))
                .appendTo(e), !1 !== n.iconPrev && c("<button>")
                .attr("type", "button")
                ...
                .html(d.isTag(n.iconPrev) ? n.iconPrev : c("<img>")
                    .attr("src", n.iconPrev))
                .appendTo(e), !1 !== n.iconNext && c("<button>")
                .attr("type", "button")
                ...
                .html(d.isTag(n.iconNext) ? n.iconNext : c("<img>")
                    .attr("src", n.iconNext))
                .appendTo(e), !1 !== n.iconFinish && c("<button>")
                .attr("type", "button")
